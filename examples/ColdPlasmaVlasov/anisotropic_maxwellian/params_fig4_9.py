...
name = "Thesis geometric benchmark - Run 1"

description = """
Full-duration reproduction of the anisotropy-driven instability
benchmark described in the thesis.

Geometric ColdPlasmaVlasov method using Lie-Trotter splitting.
No control variate. Same physical parameters as the thesis
benchmark, with Tend = 200 and dt = 0.0125.
"""
...
env = EnvironmentOptions(
    sim_folder="thesis_run1_correct",
    save_step=1,
)
