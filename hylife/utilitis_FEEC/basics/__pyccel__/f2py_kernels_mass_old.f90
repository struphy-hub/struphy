function fun_3d (xi1, xi2, xi3, kind_fun, kind_map, n0_params, params) &
  ...
  use kernels_mass_old, only: mod_fun_3d => fun_3d
  implicit none
...
subroutine kernel_eva_3d (n0_n, n, n0_xi1, xi1, n0_xi2, xi2, n0_xi3, xi3 &
  ...
  use kernels_mass_old, only: mod_kernel_eva_3d => kernel_eva_3d
  implicit none
...
subroutine kernel_mass_2d (Nel1, Nel2, p1, p2, nq1, nq2, ni1, ni2, nj1, &
  ...
  use kernels_mass_old, only: mod_kernel_mass_2d => kernel_mass_2d
  implicit none
...
subroutine kernel_mass_3d (Nel1, Nel2, Nel3, p1, p2, p3, nq1, nq2, nq3, &
  ...
  use kernels_mass_old, only: mod_kernel_mass_3d => kernel_mass_3d
  implicit none
  integer(kind=8), intent(in)  :: Nel1 
  integer(kind=8), intent(in)  :: Nel2 
...
subroutine kernel_inner_2d (Nel1, Nel2, p1, p2, nq1, nq2, ni1, ni2, &
  ...
  use kernels_mass_old, only: mod_kernel_inner_2d => kernel_inner_2d
  implicit none
  integer(kind=8), intent(in)  :: Nel1 
  integer(kind=8), intent(in)  :: Nel2 
  integer(kind=8), intent(in)  :: p1 
...
subroutine kernel_inner_3d (Nel1, Nel2, Nel3, p1, p2, p3, nq1, nq2, nq3, &
  ...
  use kernels_mass_old, only: mod_kernel_inner_3d => kernel_inner_3d
  implicit none
  integer(kind=8), intent(in)  :: Nel1 
  integer(kind=8), intent(in)  :: Nel2 
  integer(kind=8), intent(in)  :: Nel3 
...
subroutine kernel_l2error_2d (n0_nel, nel, n0_p, p, n0_nq, nq, n0_w1, &
      n1_w1, w1, n0_w2, n1_w2, w2, n0_ni, ni, n0_nj, nj, n0_bi1, n1_bi1 &
      , n2_bi1, n3_bi1, bi1, n0_bi2, n1_bi2, n2_bi2, n3_bi2, bi2, &
      n0_bj1, n1_bj1, n2_bj1, n3_bj1, bj1, n0_bj2, n1_bj2, n2_bj2, &
      n3_bj2, bj2, n0_nbi, nbi, n0_nbj, nbj, n0_error, n1_error, error, &
      n0_mat_f1, n1_mat_f1, mat_f1, n0_mat_f2, n1_mat_f2, mat_f2, &
      n0_mat_c1, n1_mat_c1, mat_c1, n0_mat_c2, n1_mat_c2, mat_c2, &
      n0_mat_g, n1_mat_g, mat_g)

  use kernels_mass_old, only: mod_kernel_l2error_2d => kernel_l2error_2d
  implicit none
  ...
  real(kind=8), intent(in)  :: mat_f1 (0:n0_mat_f1-1,0:n1_mat_f1-1)
  integer(kind=4), intent(in)  :: n0_mat_f2 
  integer(kind=4), intent(in)  :: n1_mat_f2 
  real(kind=8), intent(in)  :: mat_f2 (0:n0_mat_f2-1,0:n1_mat_f2-1)
  integer(kind=4), intent(in)  :: n0_mat_c1 
  integer(kind=4), intent(in)  :: n1_mat_c1 
  real(kind=8), intent(in)  :: mat_c1 (0:n0_mat_c1-1,0:n1_mat_c1-1)
  integer(kind=4), intent(in)  :: n0_mat_c2 
  integer(kind=4), intent(in)  :: n1_mat_c2 
  real(kind=8), intent(in)  :: mat_c2 (0:n0_mat_c2-1,0:n1_mat_c2-1)
  integer(kind=4), intent(in)  :: n0_mat_g 
  integer(kind=4), intent(in)  :: n1_mat_g 
  real(kind=8), intent(in)  :: mat_g (0:n0_mat_g-1,0:n1_mat_g-1)

  call mod_kernel_l2error_2d(nel,p,nq,w1,w2,ni,nj,bi1,bi2,bj1,bj2,nbi, &
      nbj,error,mat_f1,mat_f2,mat_c1,mat_c2,mat_g)
end subroutine

subroutine kernel_l2error_3d (n0_nel, nel, n0_p, p, n0_nq, nq, n0_w1, &
      n1_w1, w1, n0_w2, n1_w2, w2, n0_w3, n1_w3, w3, n0_ni, ni, n0_nj, &
      nj, n0_bi1, n1_bi1, n2_bi1, n3_bi1, bi1, n0_bi2, n1_bi2, n2_bi2, &
      ...
      mat_c2, n0_mat_g, n1_mat_g, n2_mat_g, mat_g)

  use kernels_mass_old, only: mod_kernel_l2error_3d => kernel_l2error_3d
  implicit none
  integer(kind=4), intent(in)  :: n0_nel 
  integer(kind=8), intent(in)  :: nel (0:n0_nel-1)
  integer(kind=4), intent(in)  :: n0_p 
  ...
  call mod_kernel_l2error_3d(nel,p,nq,w1,w2,w3,ni,nj,bi1,bi2,bi3,bj1,bj2 &
      ,bj3,nbi,nbj,error,mat_f1,mat_f2,mat_c1,mat_c2,mat_g)
end subroutine