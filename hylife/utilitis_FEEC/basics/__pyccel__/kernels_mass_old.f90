module kernels_mass_old

use mappings_analytical, only: mapping_x2c0n1_g_inv => g_inv
use mappings_analytical, only: mapping_x2c0n1_det_df => det_df
use mappings_analytical, only: mapping_x2c0n1_g => g
implicit none
...
function fun_3d(xi1, xi2, xi3, kind_fun, kind_map, params) result(value)
  ...
  if (kind_fun == 1_8 ) then
    value = mapping_x2c0n1_det_df(xi1, xi2, xi3, kind_map, params)
  else if (kind_fun == 11_8 ) then
    value = mapping_x2c0n1_det_df(xi1, xi2, xi3, kind_map, params)* &
      mapping_x2c0n1_g_inv(xi1, xi2, xi3, kind_map, params, 11_8)
  else if (kind_fun == 12_8 ) then
    value = mapping_x2c0n1_det_df(xi1, xi2, xi3, kind_map, params)* &
      mapping_x2c0n1_g_inv(xi1, xi2, xi3, kind_map, params, 21_8)
  else if (kind_fun == 13_8 ) then
    value = mapping_x2c0n1_det_df(xi1, xi2, xi3, kind_map, params)* &
      mapping_x2c0n1_g_inv(xi1, xi2, xi3, kind_map, params, 22_8)
  else if (kind_fun == 14_8 ) then
    value = mapping_x2c0n1_det_df(xi1, xi2, xi3, kind_map, params)* &
      mapping_x2c0n1_g_inv(xi1, xi2, xi3, kind_map, params, 31_8)
  else if (kind_fun == 15_8 ) then
    value = mapping_x2c0n1_det_df(xi1, xi2, xi3, kind_map, params)* &
      mapping_x2c0n1_g_inv(xi1, xi2, xi3, kind_map, params, 32_8)
  else if (kind_fun == 16_8 ) then
    value = mapping_x2c0n1_det_df(xi1, xi2, xi3, kind_map, params)* &
      mapping_x2c0n1_g_inv(xi1, xi2, xi3, kind_map, params, 33_8)
  else if (kind_fun == 21_8 ) then
    value = mapping_x2c0n1_g(xi1, xi2, xi3, kind_map, params, 11_8)/ &
      mapping_x2c0n1_det_df(xi1, xi2, xi3, kind_map, params)
  else if (kind_fun == 22_8 ) then
    value = mapping_x2c0n1_g(xi1, xi2, xi3, kind_map, params, 21_8)/ &
      mapping_x2c0n1_det_df(xi1, xi2, xi3, kind_map, params)
  else if (kind_fun == 23_8 ) then
    value = mapping_x2c0n1_g(xi1, xi2, xi3, kind_map, params, 22_8)/ &
      mapping_x2c0n1_det_df(xi1, xi2, xi3, kind_map, params)
  else if (kind_fun == 24_8 ) then
    value = mapping_x2c0n1_g(xi1, xi2, xi3, kind_map, params, 31_8)/ &
      mapping_x2c0n1_det_df(xi1, xi2, xi3, kind_map, params)
  else if (kind_fun == 25_8 ) then
    value = mapping_x2c0n1_g(xi1, xi2, xi3, kind_map, params, 32_8)/ &
      mapping_x2c0n1_det_df(xi1, xi2, xi3, kind_map, params)
  else if (kind_fun == 26_8 ) then
    value = mapping_x2c0n1_g(xi1, xi2, xi3, kind_map, params, 33_8)/ &
      mapping_x2c0n1_det_df(xi1, xi2, xi3, kind_map, params)
  else if (kind_fun == 2_8 ) then
    value = 1.0d0/mapping_x2c0n1_det_df(xi1, xi2, xi3, kind_map, params)
  end if
...
!........................................
subroutine kernel_l2error_2d(nel, p, nq, w1, w2, ni, nj, bi1, bi2, bj1, &
      bj2, nbi, nbj, error, mat_f1, mat_f2, mat_c1, mat_c2, mat_g)
  ...
  real(kind=8), intent(in)  :: mat_f1 (0:,0:)
  real(kind=8), intent(in)  :: mat_f2 (0:,0:)
  real(kind=8), intent(in)  :: mat_c1 (0:,0:)
  real(kind=8), intent(in)  :: mat_c2 (0:,0:)
    ...
    do ie2 = 0, nel(1_8) - 1_8, 1
      ...
      do q1 = 0, nq(0_8) - 1_8, 1
        do q2 = 0, nq(1_8) - 1_8, 1
          ...
          wvol = (mat_g(ie1*nq(0_8) + q1, ie2*nq(1_8) + q2)*w2(ie2, q2)) &
      *w1(ie1, q1)
      ...
      mat_c1(modulo(ie1 + il1,nbi(0_8)), modulo(ie2 + il2,nbi(1_8)))
          ...
          do jl1 = 0, -nj(0_8) + p(0_8), 1
            do jl2 = 0, -nj(1_8) + p(1_8), 1
              ...
              bj = bj + (bj1(ie1, jl1, 0_8, q1)*bj2(ie2, jl2, 0_8, q2))* &
      mat_c2(modulo(ie1 + jl1,nbj(0_8)), modulo(ie2 + jl2,nbj(1_8)))
          ...
          error(ie1, ie2) = wvol*((bi - mat_f1(ie1*nq(0_8) + q1, ie2*nq( &
      1_8) + q2))*(bj - mat_f2(ie1*nq(0_8) + q1, ie2*nq(1_8) + q2))) + &
      error(ie1, ie2)
...
!........................................
subroutine kernel_l2error_3d(nel, p, nq, w1, w2, w3, ni, nj, bi1, bi2, &
      bi3, bj1, bj2, bj3, nbi, nbj, error, mat_f1, mat_f2, mat_c1, &
      mat_c2, mat_g)
        ...
        do q1 = 0, nq(0_8) - 1_8, 1
          do q2 = 0, nq(1_8) - 1_8, 1
            do q3 = 0, nq(2_8) - 1_8, 1
              ...
              wvol = ((mat_g(ie1*nq(0_8) + q1, ie2*nq(1_8) + q2, ie3*nq( &
      2_8) + q3)*w3(ie3, q3))*w2(ie2, q2))*w1(ie1, q1)
