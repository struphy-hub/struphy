...
def kernel_int_3d_ext(w1,w2,w3, mat_f,f_int):
    #n1,n2,n3,nq1,nq2,nq3=np.shape(mat_f) #not yet working in pyccel
        ...
        for i2 in range(n2):
            for i3 in range(n3):
                ...
                for q1 in range(nq1):
                    for q2 in range(nq2):
                        for q3 in range(nq3):
                            f_int[i1,i2,i3] += w1[i1,q1]*w2[i2,q2]* w3[i3,q3]*mat_f[i1,i2,i3,q1,q2,q3]
#================================================================================================================================

#========= kernel for integration in 1d along xi1 direction, reducing to a 3d array  ============================================
@types('double[:,:]','double[:,:,:,:]','double[:,:,:]')
def kernel_int_1d_ext_xi1(w1,mat_f,f_int):
    #n1,n2,n3,nq1 = np.shape(mat_f) #not yet working in pyccel
    shape=np.shape(mat_f)
    n1  = shape[0] 
    n2  = shape[1] 
    n3  = shape[2] 
    ...
    for i1 in range(n1):
        for i2 in range(n2):
            for i3 in range(n3):
                f_int[i1,i2,i3] = 0.
                for q2 in range(nq2):
                    f_int[i1,i2,i3] += w2[i2,q2]*mat_f[i1,i2,i3,q2]
#================================================================================================================================
...
def kernel_int_1d_ext_xi3(w3,mat_f,f_int):
    #n1,n2,n3,nq3 = np.shape(mat_f) #not yet working in pyccel
    shape=np.shape(mat_f)
    n1  = shape[0] 
    n2  = shape[1] 
    n3  = shape[2] 
    ...
    for i1 in range(n1):
        for i2 in range(n2):
            for i3 in range(n3):
                f_int[i1,i2,i3] = 0.
                for q3 in range(nq3):
                    f_int[i1,i2,i3] += w3[i3,q3]*mat_f[i1,i2,i3,q3]
#================================================================================================================================
...
def kernel_int_2d_ext_xi2_xi3(w2,w3, mat_f,f_int):
    #n1,n2,n3,nq2,nq3 = np.shape(mat_f)
    shape=np.shape(mat_f)
    n1  = shape[0] 
    n2  = shape[1] 
    n3  = shape[2] 
    ...
    for i1 in range(n1):
        for i2 in range(n2):
            for i3 in range(n3):
                ...
                for q2 in range(nq2):
                    for q3 in range(nq3):
                        f_int[i1,i2,i3] += w2[i2,q2]* w3[i3,q3]*mat_f[i1,i2,i3,q2,q3]
#================================================================================================================================
    ...
    for i1 in range(n1):
        for i2 in range(n2):
            for i3 in range(n3):
                ...
                for q1 in range(nq1):
                    for q3 in range(nq3):
                        f_int[i1,i2,i3] += w1[i1,q1]* w3[i3,q3]*mat_f[i1,i2,i3,q1,q3]
#================================================================================================================================
    ...
    for i1 in range(n1):
        for i2 in range(n2):
            for i3 in range(n3):
                ...
                for q1 in range(nq1):
                    for q2 in range(nq2):
                        f_int[i1,i2,i3] += w1[i1,q1]* w2[i2,q2]*mat_f[i1,i2,i3,q1,q2]
#================================================================================================================================
