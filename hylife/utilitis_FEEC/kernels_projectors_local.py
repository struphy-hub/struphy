...
# ==========================================================================================
@types('int[:]','int[:]','double[:,:](order=F)','double[:,:](order=F)','double[:,:](order=F)','int[:]','int[:]','int[:]','int[:,:](order=F)','int[:,:](order=F)','int[:,:](order=F)','double[:,:,:](order=F)','double[:,:,:](order=F)')        
...
# ==========================================================================================
@types('int[:]','int[:]','double[:,:](order=F)','double[:,:](order=F)','double[:,:](order=F)','int[:]','int[:]','int[:]','int[:,:](order=F)','int[:,:](order=F)','int[:,:](order=F)','double[:,:](order=F)','double[:,:,:,:](order=F)','double[:,:,:](order=F)')
def kernel_pi11_3d(n, p, coeff_h1, coeff_i2, coeff_i3, coeffh_ind1, coeffi_ind2, coeffi_ind3, x_his_ind1, x_int_ind2, x_int_ind3, wts1, mat_f, lambdas):
...
# ==========================================================================================
@types('int[:]','int[:]','double[:,:](order=F)','double[:,:](order=F)','double[:,:](order=F)','int[:]','int[:]','int[:]','int[:,:](order=F)','int[:,:](order=F)','int[:,:](order=F)','double[:,:](order=F)','double[:,:,:,:](order=F)','double[:,:,:](order=F)')
def kernel_pi12_3d(n, p, coeff_i1, coeff_h2, coeff_i3, coeffi_ind1, coeffh_ind2, coeffi_ind3, x_int_ind1, x_his_ind2, x_int_ind3, wts2, mat_f, lambdas):
...
# ==========================================================================================
@types('int[:]','int[:]','double[:,:](order=F)','double[:,:](order=F)','double[:,:](order=F)','int[:]','int[:]','int[:]','int[:,:](order=F)','int[:,:](order=F)','int[:,:](order=F)','double[:,:](order=F)','double[:,:,:,:](order=F)','double[:,:,:](order=F)')
def kernel_pi13_3d(n, p, coeff_i1, coeff_i2, coeff_h3, coeffi_ind1, coeffi_ind2, coeffh_ind3, x_int_ind1, x_int_ind2, x_his_ind3, wts3, mat_f, lambdas):
...
# ==========================================================================================
@types('int[:]','int[:]','double[:,:](order=F)','double[:,:](order=F)','double[:,:](order=F)','int[:]','int[:]','int[:]','int[:,:](order=F)','int[:,:](order=F)','int[:,:](order=F)','double[:,:](order=F)','double[:,:](order=F)','double[:,:,:,:,:](order=F)','double[:,:,:](order=F)')
def kernel_pi21_3d(n, p, coeff_i1, coeff_h2, coeff_h3, coeffi_ind1, coeffh_ind2, coeffh_ind3, x_int_ind1, x_his_ind2, x_his_ind3, wts2, wts3, mat_f, lambdas):
...
# ==========================================================================================
@types('int[:]','int[:]','double[:,:](order=F)','double[:,:](order=F)','double[:,:](order=F)','int[:]','int[:]','int[:]','int[:,:](order=F)','int[:,:](order=F)','int[:,:](order=F)','double[:,:](order=F)','double[:,:](order=F)','double[:,:,:,:,:](order=F)','double[:,:,:](order=F)')
def kernel_pi22_3d(n, p, coeff_h1, coeff_i2, coeff_h3, coeffh_ind1, coeffi_ind2, coeffh_ind3, x_his_ind1, x_int_ind2, x_his_ind3, wts1, wts3, mat_f, lambdas):
...
# ==========================================================================================
@types('int[:]','int[:]','double[:,:](order=F)','double[:,:](order=F)','double[:,:](order=F)','int[:]','int[:]','int[:]','int[:,:](order=F)','int[:,:](order=F)','int[:,:](order=F)','double[:,:](order=F)','double[:,:](order=F)','double[:,:,:,:,:](order=F)','double[:,:,:](order=F)')
def kernel_pi23_3d(n, p, coeff_h1, coeff_h2, coeff_i3, coeffh_ind1, coeffh_ind2, coeffi_ind3, x_his_ind1, x_his_ind2, x_int_ind3, wts1, wts2, mat_f, lambdas):
...
# ==========================================================================================
@types('int[:]','int[:]','double[:,:](order=F)','double[:,:](order=F)','double[:,:](order=F)','int[:]','int[:]','int[:]','int[:,:](order=F)','int[:,:](order=F)','int[:,:](order=F)','double[:,:](order=F)','double[:,:](order=F)','double[:,:](order=F)','double[:,:,:,:,:,:](order=F)','double[:,:,:](order=F)')        
def kernel_pi3_3d(n, p, coeff_h1, coeff_h2, coeff_h3, coeffh_ind1, coeffh_ind2, coeffh_ind3, x_his_ind1, x_his_ind2, x_his_ind3, wts1, wts2, wts3, mat_f, lambdas):
