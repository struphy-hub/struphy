...
# ======================================
    ...
    def eval_for_PI(self,comp, fun):
        '''
        Evaluates the callable "fun" at the points corresponding to the projector, and returns the result as 3d nparray "mat_f".
