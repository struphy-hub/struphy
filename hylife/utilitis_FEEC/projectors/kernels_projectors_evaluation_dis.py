...
def fun(eta1, eta2, eta3, kind_fun, tf1, tf2, tf3, pf, nbasef, cx, cy, cz):
    ...
    # initial conditions
    if   kind_fun == 1:
        value = ini_mhd.p3_ini(eta1, eta2, eta3, tf1, tf2, tf3, pf, nbasef, cx, cy, cz)
    elif kind_fun == 2:
        value = ini_mhd.u_ini_1(eta1, eta2, eta3, tf1, tf2, tf3, pf, nbasef, cx, cy, cz)
    elif kind_fun == 3:
        value = ini_mhd.u_ini_2(eta1, eta2, eta3, tf1, tf2, tf3, pf, nbasef, cx, cy, cz)
    elif kind_fun == 4:
        value = ini_mhd.u_ini_3(eta1, eta2, eta3, tf1, tf2, tf3, pf, nbasef, cx, cy, cz)
    elif kind_fun == 5:
        value = ini_mhd.b2_ini_1(eta1, eta2, eta3, tf1, tf2, tf3, pf, nbasef, cx, cy, cz)
    elif kind_fun == 6:
        value = ini_mhd.b2_ini_2(eta1, eta2, eta3, tf1, tf2, tf3, pf, nbasef, cx, cy, cz)
    elif kind_fun == 7:
        value = ini_mhd.b2_ini_3(eta1, eta2, eta3, tf1, tf2, tf3, pf, nbasef, cx, cy, cz)
    elif kind_fun == 8:
        value = ini_mhd.rho3_ini(eta1, eta2, eta3, tf1, tf2, tf3, pf, nbasef, cx, cy, cz)
    
    # quantities for projection matrix Q
    elif kind_fun == 11:
        value = eq_mhd.rho3_eq(eta1, eta2, eta3, tf1, tf2, tf3, pf, nbasef, cx, cy, cz)
        
    # quantities for projection matrix W
    elif kind_fun == 12:
        value = eq_mhd.rho0_eq(eta1, eta2, eta3, tf1, tf2, tf3, pf, nbasef, cx, cy, cz)
    ...
    # quantities for projection matrix S
        ...
        value = eq_mhd.p3_eq(eta1, eta2, eta3, tf1, tf2, tf3, pf, nbasef, cx, cy, cz)
        
    # quantities for projection matrix K
    elif kind_fun == 41:
        value = eq_mhd.p0_eq(eta1, eta2, eta3, tf1, tf2, tf3, pf, nbasef, cx, cy, cz)
        
    # quantities for projection matrix N
    elif kind_fun == 51:
        value = abs(mapping.det_df(tf1, tf2, tf3, pf, nbasef, cx, cy, cz, eta1, eta2, eta3))
    
    # quantities for equilibrium current term r
    elif kind_fun == 61:
        value = eq_mhd.curlb_eq_1(eta1, eta2, eta3, tf1, tf2, tf3, pf, nbasef, cx, cy, cz)
    elif kind_fun == 62:
        value = eq_mhd.curlb_eq_2(eta1, eta2, eta3, tf1, tf2, tf3, pf, nbasef, cx, cy, cz)
    elif kind_fun == 63:
        value = eq_mhd.curlb_eq_3(eta1, eta2, eta3, tf1, tf2, tf3, pf, nbasef, cx, cy, cz)
...
def kernel_eva_quad(nel, nq, eta1, eta2, eta3, mat_f, kind_fun, tf1, tf2, tf3, pf, nbasef, cx, cy, cz):
