...
# ==========================================================================================
@types('int[:]','int[:]','int[:]','double[:,:](order=F)','double[:,:](order=F)','double[:,:](order=F)','int[:]','int[:]','int[:]','int[:,:](order=F)','int[:,:](order=F)','int[:,:](order=F)','double[:,:](order=F)','double[:,:,:,:](order=F)','double[:,:,:](order=F)')
...
# ==========================================================================================
@types('int[:]','int[:]','int[:]','double[:,:](order=F)','double[:,:](order=F)','double[:,:](order=F)','int[:]','int[:]','int[:]','int[:,:](order=F)','int[:,:](order=F)','int[:,:](order=F)','double[:,:](order=F)','double[:,:](order=F)','double[:,:,:,:,:](order=F)','double[:,:,:](order=F)')
...
# ==========================================================================================
@types('int[:]','int[:]','int[:]','double[:,:](order=F)','double[:,:](order=F)','double[:,:](order=F)','int[:]','int[:]','int[:]','int[:,:](order=F)','int[:,:](order=F)','int[:,:](order=F)','double[:,:](order=F)','double[:,:](order=F)','double[:,:](order=F)','double[:,:,:,:,:,:](order=F)','double[:,:,:](order=F)')        
