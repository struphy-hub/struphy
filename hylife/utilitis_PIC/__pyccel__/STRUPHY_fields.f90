...
use interface, only: inter_8kufpl_b3_eq => b3_eq
use interface, only: inter_8kufpl_b1_eq => b1_eq
use interface, only: inter_8kufpl_u3_eq => u3_eq
use interface, only: inter_8kufpl_u1_eq => u1_eq
use interface, only: inter_8kufpl_u2_eq => u2_eq
use interface, only: inter_8kufpl_b2_eq => b2_eq
implicit none
...
subroutine evaluate_1form(particles_pos, t0_1, t0_2, t0_3, t1_1, t1_2, &
  ...
  do ip = 0, np - 1_8, 1
    ...
    u_part(ip, 0_8) = inter_8kufpl_u1_eq(particles_pos(ip, 0_8), &
      particles_pos(ip, 1_8), particles_pos(ip, 2_8), kind_map, &
      params_map)
    u_part(ip, 1_8) = inter_8kufpl_u2_eq(particles_pos(ip, 0_8), &
      particles_pos(ip, 1_8), particles_pos(ip, 2_8), kind_map, &
      params_map)
    u_part(ip, 2_8) = inter_8kufpl_u3_eq(particles_pos(ip, 0_8), &
      particles_pos(ip, 1_8), particles_pos(ip, 2_8), kind_map, &
      params_map)
...
subroutine evaluate_2form(particles_pos, t0_1, t0_2, t0_3, t1_1, t1_2, &
  ...
  do ip = 0, np - 1_8, 1
    ...
    b_part(ip, 0_8) = inter_8kufpl_b1_eq(particles_pos(ip, 0_8), &
      particles_pos(ip, 1_8), particles_pos(ip, 2_8), kind_map, &
      params_map)
    b_part(ip, 1_8) = inter_8kufpl_b2_eq(particles_pos(ip, 0_8), &
      particles_pos(ip, 1_8), particles_pos(ip, 2_8), kind_map, &
      params_map)
    b_part(ip, 2_8) = inter_8kufpl_b3_eq(particles_pos(ip, 0_8), &
      particles_pos(ip, 1_8), particles_pos(ip, 2_8), kind_map, &
      params_map)
