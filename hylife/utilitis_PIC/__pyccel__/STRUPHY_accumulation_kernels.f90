...
use core, only: linalg_7xczkl_matrix_vector => matrix_vector
use core, only: linalg_7xczkl_matrix_matrix => matrix_matrix
use core, only: linalg_7xczkl_transpose => transpose

use mappings_analytical, only: mapping_t62u91_df_inv => df_inv
use mappings_analytical, only: mapping_t62u91_g_inv => g_inv
implicit none
...
subroutine kernel_step1(particles, p0, nel, nbase, t0_1, t0_2, t0_3, &
  ...
  do ip = 0, np - 1_8, 1
    ...
    do i = 0, 2_8, 1
      do j = 0, 2_8, 1
        ginv(i, j) = mapping_t62u91_g_inv(pos1, pos2, pos3, kind_map, &
    ...
    call linalg_7xczkl_matrix_matrix(ginv, b_prod, temp_mat1)
    call linalg_7xczkl_matrix_matrix(temp_mat1, ginv, temp_mat2)
...
subroutine kernel_step3(particles, p0, nel, nbase, t0_1, t0_2, t0_3, &
  ...
  do ip = 0, np - 1_8, 1
    ...
    do i = 0, 2_8, 1
      do j = 0, 2_8, 1
        dfinv(i, j) = mapping_t62u91_df_inv(pos1, pos2, pos3, kind_map, &
      params_map, components(i, j))
    ...
    call linalg_7xczkl_matrix_matrix(ginv, b_prod, temp_mat1)
    call linalg_7xczkl_matrix_matrix(temp_mat1, dfinv, temp_mat_vec)
    call linalg_7xczkl_matrix_vector(temp_mat_vec, v, temp_vec)


    call linalg_7xczkl_matrix_matrix(temp_mat1, ginv, temp_mat2)
    call linalg_7xczkl_transpose(b_prod, b_prod_t)
    call linalg_7xczkl_matrix_matrix(temp_mat2, b_prod_t, temp_mat1)
    call linalg_7xczkl_matrix_matrix(temp_mat1, ginv, temp_mat2)
