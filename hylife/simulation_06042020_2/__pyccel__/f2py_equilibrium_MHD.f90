...
function u1_eq (xi1, xi2, xi3, kind, n0_params, params) result( &
  ...
  Dummy_8519 = mod_u1_eq(xi1,xi2,xi3,kind,params)
end function
...
function u2_eq (xi1, xi2, xi3, kind, n0_params, params) result( &
  ...
  Dummy_9151 = mod_u2_eq(xi1,xi2,xi3,kind,params)
end function
...
function u3_eq (xi1, xi2, xi3, kind, n0_params, params) result( &
  ...
  Dummy_3898 = mod_u3_eq(xi1,xi2,xi3,kind,params)
end function
...
function b1_eq (xi1, xi2, xi3, kind, n0_params, params) result( &
  ...
  Dummy_9373 = mod_b1_eq(xi1,xi2,xi3,kind,params)
end function
...
function b2_eq (xi1, xi2, xi3, kind, n0_params, params) result( &
  ...
  Dummy_1603 = mod_b2_eq(xi1,xi2,xi3,kind,params)
end function
...
function b3_eq (xi1, xi2, xi3, kind, n0_params, params) result( &
  ...
  Dummy_1337 = mod_b3_eq(xi1,xi2,xi3,kind,params)
end function
...
function rho_eq (xi1, xi2, xi3, kind, n0_params, params) result( &
  ...
  Dummy_9385 = mod_rho_eq(xi1,xi2,xi3,kind,params)
end function
...
function curlb1_eq (xi1, xi2, xi3, kind, n0_params, params) result( &
  ...
  Dummy_7817 = mod_curlb1_eq(xi1,xi2,xi3,kind,params)
end function
...
function curlb2_eq (xi1, xi2, xi3, kind, n0_params, params) result( &
  ...
  Dummy_7656 = mod_curlb2_eq(xi1,xi2,xi3,kind,params)
end function
...
function curlb3_eq (xi1, xi2, xi3, kind, n0_params, params) result( &
  ...
  Dummy_7791 = mod_curlb3_eq(xi1,xi2,xi3,kind,params)
end function