...
use mappings_analytical, only: mapping_tz3wom_f => f
use mappings_analytical, only: mapping_tz3wom_det_df => det_df
implicit none
...
!........................................
function jhx_eq(x, y, z) result(Dummy_4074)

  implicit none
  real(kind=8)  :: Dummy_4074  
  real(kind=8), value  :: x
  real(kind=8), value  :: y
  real(kind=8), value  :: z
  real(kind=8)  :: nh0  
...
!........................................
function jhy_eq(x, y, z) result(Dummy_0657)

  implicit none
  real(kind=8)  :: Dummy_0657  
  real(kind=8), value  :: x
  real(kind=8), value  :: y
  real(kind=8), value  :: z
  real(kind=8)  :: nh0  
...
!........................................
function jhz_eq(x, y, z) result(Dummy_3009)

  implicit none
  real(kind=8)  :: Dummy_3009  
  real(kind=8), value  :: x
  real(kind=8), value  :: y
  real(kind=8), value  :: z
  real(kind=8)  :: nh0  
...
function fh_eq(xi1, xi2, xi3, vx, vy, vz, kind_map, params_map) result( &
  ...
  x = mapping_tz3wom_f(xi1, xi2, xi3, kind_map, params_map, 1_8)
  y = mapping_tz3wom_f(xi1, xi2, xi3, kind_map, params_map, 2_8)
  z = mapping_tz3wom_f(xi1, xi2, xi3, kind_map, params_map, 3_8)


  Dummy_4038 = fh_eq_phys(x, y, z, vx, vy, vz)*mapping_tz3wom_det_df(xi1 &
