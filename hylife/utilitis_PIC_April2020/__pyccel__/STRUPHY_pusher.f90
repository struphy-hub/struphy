...
use mappings_analytical, only: mapping_pesi23_g_inv => g_inv
use mappings_analytical, only: mapping_pesi23_df_inv => df_inv

use core, only: linalg_apxbyi_transpose => transpose
use core, only: linalg_apxbyi_matrix_matrix => matrix_matrix
use core, only: linalg_apxbyi_matrix_vector => matrix_vector
use core, only: linalg_apxbyi_det => det
implicit none
...
subroutine pusher_step3(particles, dt, b_part, u_part, kind_map, &
  ...
  do ip = 0, np - 1_8, 1
    ...
    do i = 0, 2_8, 1
      do j = 0, 2_8, 1
        dfinv(i, j) = mapping_pesi23_df_inv(xi(0_8), xi(1_8), xi(2_8), &
    ...
    call linalg_apxbyi_transpose(dfinv, dfinv_t)


    do i = 0, 2_8, 1
      do j = 0, 2_8, 1
        ginv(i, j) = mapping_pesi23_g_inv(xi(0_8), xi(1_8), xi(2_8), &
      kind_map, params_map, components(i, j))
    ...
    call linalg_apxbyi_matrix_matrix(dfinv_t, b_prod, temp_mat1)
    call linalg_apxbyi_matrix_matrix(temp_mat1, ginv, temp_mat2)
    call linalg_apxbyi_matrix_vector(temp_mat2, u, temp_vec)
...
subroutine pusher_step4(particles, dt, kind_map, params_map) 
  ...
  do ip = 0, np - 1_8, 1
    ...
    call linalg_apxbyi_matrix_vector(dfinv, v, k1)


    do i = 0, 2_8, 1
      do j = 0, 2_8, 1
        dfinv(i, j) = mapping_pesi23_df_inv(dt*(k1(0_8)/Real(2_8, 8)) + &
    ...
    call linalg_apxbyi_matrix_vector(dfinv, v, k2)


    do i = 0, 2_8, 1
      do j = 0, 2_8, 1
        dfinv(i, j) = mapping_pesi23_df_inv(dt*(k2(0_8)/Real(2_8, 8)) + &
    ...
    call linalg_apxbyi_matrix_vector(dfinv, v, k3)


    do i = 0, 2_8, 1
      do j = 0, 2_8, 1
        dfinv(i, j) = mapping_pesi23_df_inv(dt*k3(0_8) + xi(0_8), dt*k3( &
    ...
    call linalg_apxbyi_matrix_vector(dfinv, v, k4)
...
subroutine pusher_step5(particles, dt, b_part, kind_map, params_map) 
  ...
  do ip = 0, np - 1_8, 1
    ...
    call linalg_apxbyi_matrix_matrix(b_prod, dfinv, temp_mat1)
    call linalg_apxbyi_matrix_matrix(dfinv_t, temp_mat1, temp_mat2)


    call linalg_apxbyi_matrix_vector((-dt)*(temp_mat2/Real(2_8, 8)) + &
      identity, v, rhs)
    ...
    det_lhs1 = linalg_apxbyi_det(lhs1)
    det_lhs2 = linalg_apxbyi_det(lhs2)
    det_lhs3 = linalg_apxbyi_det(lhs3)
