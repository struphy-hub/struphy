...
function u1_eq (xi1, xi2, xi3, kind, n0_params, params) result( &
  ...
  Dummy_2434 = mod_u1_eq(xi1,xi2,xi3,kind,params)
end function
...
function u2_eq (xi1, xi2, xi3, kind, n0_params, params) result( &
  ...
  Dummy_5831 = mod_u2_eq(xi1,xi2,xi3,kind,params)
end function
...
function u3_eq (xi1, xi2, xi3, kind, n0_params, params) result( &
  ...
  Dummy_1928 = mod_u3_eq(xi1,xi2,xi3,kind,params)
end function
...
function b1_eq (xi1, xi2, xi3, kind, n0_params, params) result( &
  ...
  Dummy_7883 = mod_b1_eq(xi1,xi2,xi3,kind,params)
end function
...
function b2_eq (xi1, xi2, xi3, kind, n0_params, params) result( &
  ...
  Dummy_1151 = mod_b2_eq(xi1,xi2,xi3,kind,params)
end function
...
function b3_eq (xi1, xi2, xi3, kind, n0_params, params) result( &
  ...
  Dummy_6494 = mod_b3_eq(xi1,xi2,xi3,kind,params)
end function
...
function rho_eq (xi1, xi2, xi3, kind, n0_params, params) result( &
  ...
  Dummy_8674 = mod_rho_eq(xi1,xi2,xi3,kind,params)
end function
...
function curlb1_eq (xi1, xi2, xi3, kind, n0_params, params) result( &
  ...
  Dummy_2636 = mod_curlb1_eq(xi1,xi2,xi3,kind,params)
end function
...
function curlb2_eq (xi1, xi2, xi3, kind, n0_params, params) result( &
  ...
  Dummy_2824 = mod_curlb2_eq(xi1,xi2,xi3,kind,params)
end function
...
function curlb3_eq (xi1, xi2, xi3, kind, n0_params, params) result( &
  ...
  Dummy_3051 = mod_curlb3_eq(xi1,xi2,xi3,kind,params)
end function