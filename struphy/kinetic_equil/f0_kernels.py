from numpy import exp, sqrt, pi, sin, cos, arctan, zeros

import struphy.kinetic_equil.moments_kernels as moments_kernels
...
def maxwellian_6d(x : 'float[:]', v : 'float[:]', moms_spec : 'int[:]', params: 'float[:]') -> float:
    ...
    ----------
        ...
        moms_spec : array[int]
            ...
            Is 0 for constant moment, for more see :meth:`struphy.kinetic_equil.moments_kernels.moments`.

        params : array[float]
            Parameters needed to specify the moments; the order is specified in :ref:`struphy.kinetic_equil.moments_kernels` for the respective functions available.
    ...
    -----
        ...
        Specifier for use in :meth:`struphy.kinetic_equil.background_eval`: 0
    """
