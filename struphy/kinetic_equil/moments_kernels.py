...
def _docstring():
    '''MODULE DOCSTRING for :ref:`struphy.kinetic_equil.moments_kernels`.

    The module contains pyccelized functions that can be used to specify moments of background distribution functions f0.
    
    The main method is :meth:`struphy.kinetic_equil.moments_kernels.moments` at the end of the file, which calls the functions defined before.
    ...
    the if-clause of :meth:`struphy.kinetic_equil.moments_kernels.moments`.'''
...
def modes_sin_cos(x: 'float', y: 'float', z: 'float', n_modes: 'int', kxs: 'float[:]', kys: 'float[:]', kzs: 'float[:]', amps_sin: 'float[:]', amps_cos: 'float[:]') -> float:
    ...
    Notes
    -----
        Specifier for use in :meth:`struphy.kinetic_equil.f0_kernels`: 1
    '''
...
def moments(x : 'float[:]', moms_spec : 'int[:]', params: 'float[:]'):
    ...
    ----------
        ...
        params : array[float]
            Parameters needed to specify the moments; the order is specified in :ref:`struphy.kinetic_equil.moments_kernels` in the function's docstrings.
    ...
    Notes
    -----
        See :ref:`struphy.kinetic_equil.moments_kernels` for available moment functions.
    """
