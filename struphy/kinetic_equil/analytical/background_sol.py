...
def maxwellian_point(v, v0, vth, n0):
    ...
    Arguments:
        ...
        output : np.array
            array with shape(1,) in which the result will be written
...
def maxwellian_vector(v, v0, vth, n0, output):
    """
    Arguments:
        v : np.array
        ...
        output : np.array
            array with shape(Np,) in which the result will be written
    ...
    #$ omp parallel
    #$ omp do private (vx,vy,vz,v0x,v0y,v0z,vth2,Gx,Gy,Gz)
