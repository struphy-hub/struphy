...
fem_2d = Tensor_spline_space([fem_1d_1, fem_1d_2], n_tor=n_tor, basis_tor=b_tor)
...
A, S = get_mhd_continua_2d(fem_2d, domain, omega2_eig, U_eig, [0, 12], params_mhd['B0']/params_mhd['R0'], 1e-2, 3)
