...
def kernel_step(particles, 
    ...
    for ip in range(np):
        ...
        if basis_u == 1:
            ...
            temp11 = particles[6, ip] * ginv[0, 0]
            temp12 = particles[6, ip] * ginv[0, 1]
            temp13 = particles[6, ip] * ginv[0, 2]
            temp22 = particles[6, ip] * ginv[1, 1]
            temp23 = particles[6, ip] * ginv[1, 2]
            temp33 = particles[6, ip] * ginv[2, 2]
