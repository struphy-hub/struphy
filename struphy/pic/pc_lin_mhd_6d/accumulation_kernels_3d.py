...
def kernel_step_ph_full(particles : 'double[:,:]', basis_u : 'int', t1 : 'double[:]', t2 : 'double[:]', t3 : 'double[:]', p : 'int[:]', nel : 'int[:]', nbase_n : 'int[:]', nbase_d : 'int[:]', np : 'int', kind_map : 'int', params_map : 'double[:]', tf1 : 'double[:]', tf2 : 'double[:]', tf3 : 'double[:]', pf : 'int[:]', nelf : 'int[:]', nbasef : 'int[:]', cx : 'double[:,:,:]', cy : 'double[:,:,:]', cz : 'double[:,:,:]', mat11 : 'double[:,:,:,:,:,:,:,:]', mat12 : 'double[:,:,:,:,:,:,:,:]', mat13 : 'double[:,:,:,:,:,:,:,:]', mat22 : 'double[:,:,:,:,:,:,:,:]', mat23 : 'double[:,:,:,:,:,:,:,:]', mat33 : 'double[:,:,:,:,:,:,:,:]', vec1 : 'double[:,:,:,:]', vec2 : 'double[:,:,:,:]', vec3 : 'double[:,:,:,:]'):
    ...
    for ip in range(np):
        ...
        temp13 = particles[6, ip] * temp_mat[0, 2]
        temp22 = particles[6, ip] * temp_mat[1, 1]
        temp23 = particles[6, ip] * temp_mat[1, 2]
        temp33 = particles[6, ip] * temp_mat[2, 2]
                        ...
                        for jl1 in range(pd1 + 1):
                            ...
                            for jl2 in range(pn2 + 1):
                                ...
                                for jl3 in range(pn3 + 1):
                                    ...
                                    for vp in range(3):
                                        for vq in range(3):
                                            mat11[i1, i2, i3, pn1 + jl1 - il1, pn2 + jl2 - il2, pn3 + jl3 - il3, vp, vq] += bj3 *  v[vp] * v[vq]
                        ...
                        for jl1 in range(pn1 + 1):
                            ...
                            for jl2 in range(pd2 + 1):
                                ...
                                for jl3 in range(pn3 + 1):
                                    ...
                                    for vp in range(3):
                                        for vq in range(3):
                                            mat12[i1, i2, i3, pn1 + jl1 - il1, pn2 + jl2 - il2, pn3 + jl3 - il3, vp, vq] += bj3 * v[vp] * v[vq]
                        ...
                        for jl1 in range(pn1 + 1):
                            ...
                            for jl2 in range(pn2 + 1):
                                ...
                                for jl3 in range(pd3 + 1):
                                    ...
                                    for vp in range(3):
                                        for vq in range(3):
                                            mat13[i1, i2, i3, pn1 + jl1 - il1, pn2 + jl2 - il2, pn3 + jl3 - il3, vp, vq] += bj3 * v[vp] * v[vq]
                        ...
                        for jl1 in range(pn1 + 1):
                            ...
                            for jl2 in range(pd2 + 1):
                                ...
                                for jl3 in range(pn3 + 1):
                                    ...
                                    for vp in range(3):
                                        for vq in range(3):
                                            mat22[i1, i2, i3, pn1 + jl1 - il1, pn2 + jl2 - il2, pn3 + jl3 - il3, vp, vq] += bj3 *  v[vp] * v[vq]
                        ...
                        for jl1 in range(pn1 + 1):
                            ...
                            for jl2 in range(pn2 + 1):
                                ...
                                for jl3 in range(pd3 + 1):
                                    ...
                                    for vp in range(3):
                                        for vq in range(3):
                                            mat23[i1, i2, i3, pn1 + jl1 - il1, pn2 + jl2 - il2, pn3 + jl3 - il3, vp, vq] += bj3 * v[vp] * v[vq]
            ...
            for il1 in range(pd1 + 1):
                ...
                for il2 in range(pn2 + 1):
                    ...
                    for il3 in range(pn3 + 1):
                        ...
                        bi3 = bi2 * bn3[il3]
                        for vp in range(2):
                            vec1[i1, i2, i3, vp+1] += bi3 * temp1 * v[vp+1]
                        ...
                        for jl1 in range(pd1 + 1):
                            ...
                            for jl2 in range(pn2 + 1):
                                ...
                                for jl3 in range(pn3 + 1):
                                    ...
                                    for vp in range(2):
                                        for vq in range(2):
                                            mat11[i1, i2, i3, pn1 + jl1 - il1, pn2 + jl2 - il2, pn3 + jl3 - il3, vp+1, vq+1] += bj3 *  v[vp+1] * v[vq+1]
                        ...
                        for jl1 in range(pn1 + 1):
                            ...
                            for jl2 in range(pd2 + 1):
                                ...
                                for jl3 in range(pn3 + 1):
                                    ...
                                    for vp in range(2):
                                        for vq in range(2):
                                            mat12[i1, i2, i3, pn1 + jl1 - il1, pn2 + jl2 - il2, pn3 + jl3 - il3, vp+1, vq+1] += bj3 * v[vp+1] * v[vq+1]
                        ...
                        for jl1 in range(pn1 + 1):
                            ...
                            for jl2 in range(pn2 + 1):
                                ...
                                for jl3 in range(pd3 + 1):
                                    ...
                                    for vp in range(2):
                                        for vq in range(2):
                                            mat13[i1, i2, i3, pn1 + jl1 - il1, pn2 + jl2 - il2, pn3 + jl3 - il3, vp+1, vq+1] += bj3 * v[vp+1] * v[vq+1]
            ...
            for il1 in range(pn1 + 1):
                ...
                for il2 in range(pd2 + 1):
                    ...
                    for il3 in range(pn3 + 1):
                        ...
                        bi3 = bi2 * bn3[il3]
                        for vp in range(2):
                            vec2[i1, i2, i3, vp+1] += bi3 * temp2 * v[vp+1]
                        ...
                        for jl1 in range(pn1 + 1):
                            ...
                            for jl2 in range(pd2 + 1):
                                ...
                                for jl3 in range(pn3 + 1):
                                    ...
                                    for vp in range(2):
                                        for vq in range(2):
                                            mat22[i1, i2, i3, pn1 + jl1 - il1, pn2 + jl2 - il2, pn3 + jl3 - il3, vp+1, vq+1] += bj3 *  v[vp+1] * v[vq+1]
                        ...
                        for jl1 in range(pn1 + 1):
                            ...
                            for jl2 in range(pn2 + 1):
                                ...
                                for jl3 in range(pd3 + 1):
                                    ...
                                    for vp in range(2):
                                        for vq in range(2):
                                            mat23[i1, i2, i3, pn1 + jl1 - il1, pn2 + jl2 - il2, pn3 + jl3 - il3, vp+1, vq+1] += bj3 * v[vp+1] * v[vq+1]
            ...
            for il1 in range(pn1 + 1):
                ...
                for il2 in range(pn2 + 1):
                    ...
                    for il3 in range(pd3 + 1):
                        ...
                        bi3 = bi2 * bd3[il3]
                        for vp in range(2):
                            vec3[i1, i2, i3, vp+1] += bi3 * temp3 * v[vp+1] 
