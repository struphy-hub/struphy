...
@types('int[:]','int[:]','double[:,:]','double[:,:,:]','double[:,:]')
def kernel_int_2d_eta1(subs1, subs_cum1, w1, mat_f, f_int):
...
@types('int[:]','int[:]','double[:,:]','double[:,:,:]','double[:,:]')
def kernel_int_2d_eta2(subs2, subs_cum2, w2, mat_f, f_int):
...
def kernel_int_2d_eta1_old(w1, mat_f, f_int):
...
# ========= kernel for integration along eta2 direction, reducing to a 2d array  ============================
@types('double[:,:]','double[:,:,:]','double[:,:]')
def kernel_int_2d_eta2_old(w2, mat_f, f_int):
...
def kernel_int_2d_eta1_eta2(subs1, subs2, subs_cum1, subs_cum2, w1, w2, mat_f, f_int):
...
def kernel_int_2d_eta1_eta2_old(w1, w2, mat_f, f_int):
...
@types('int[:]','int[:]','double[:,:]','double[:,:,:,:]','double[:,:,:]')
def kernel_int_3d_eta1(subs1, subs_cum1, w1, mat_f, f_int):
...
@types('int[:]','int[:]','double[:,:]','double[:,:,:,:]','double[:,:,:]')
def kernel_int_3d_eta2(subs2, subs_cum2, w2, mat_f, f_int):
...
@types('int[:]','int[:]','double[:,:]','double[:,:,:,:]','double[:,:,:]')
def kernel_int_3d_eta3(subs3, subs_cum3, w3, mat_f, f_int):
...
# ========= kernel for integration along eta1 direction, reducing to a 3d array  ============================
@types('double[:,:]','double[:,:,:,:]','double[:,:,:]')
def kernel_int_3d_eta1_old(w1, mat_f, f_int):
...
# ========= kernel for integration along eta2 direction, reducing to a 3d array  ============================
@types('double[:,:]','double[:,:,:,:]','double[:,:,:]')
def kernel_int_3d_eta2_old(w2, mat_f, f_int):
...
# ========= kernel for integration along eta3 direction, reducing to a 3d array  ============================
@types('double[:,:]','double[:,:,:,:]','double[:,:,:]')
def kernel_int_3d_eta3_old(w3, mat_f, f_int):
...
@types('int[:]','int[:]','int[:]','int[:]','double[:,:]','double[:,:]','double[:,:,:,:,:]','double[:,:,:]')
def kernel_int_3d_eta2_eta3(subs2, subs3, subs_cum2, subs_cum3, w2, w3, mat_f, f_int):
...
@types('int[:]','int[:]','int[:]','int[:]','double[:,:]','double[:,:]','double[:,:,:,:,:]','double[:,:,:]')
def kernel_int_3d_eta1_eta3(subs1, subs3, subs_cum1, subs_cum3, w1, w3, mat_f, f_int):
...
@types('int[:]','int[:]','int[:]','int[:]','double[:,:]','double[:,:]','double[:,:,:,:,:]','double[:,:,:]')
def kernel_int_3d_eta1_eta2(subs1, subs2, subs_cum1, subs_cum2, w1, w2, mat_f, f_int):
...
# ========= kernel for integration in eta2-eta3 plane, reducing to a 3d array  ==============================
@types('double[:,:]','double[:,:]','double[:,:,:,:,:]','double[:,:,:]')
def kernel_int_3d_eta2_eta3_old(w2, w3, mat_f, f_int):
...
@types('double[:,:]','double[:,:]','double[:,:,:,:,:]','double[:,:,:]')
def kernel_int_3d_eta1_eta3_old(w1, w3, mat_f, f_int):
...
# ========= kernel for integration in eta1-eta2 plane, reducing to a 3d array  ============================
@types('double[:,:]','double[:,:]','double[:,:,:,:,:]','double[:,:,:]')
def kernel_int_3d_eta1_eta2_old(w1, w2, mat_f, f_int):
...
def kernel_int_3d_eta1_eta2_eta3(subs1, subs2, subs3, subs_cum1, subs_cum2, subs_cum3, w1, w2, w3, mat_f, f_int):
...
def kernel_int_3d_eta1_eta2_eta3_old(w1, w2, w3, mat_f, f_int):
