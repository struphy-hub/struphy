...
def parameters(map_type):
    if map_type == 'cuboid':
        ...
        l3 = 0.
        r3 = 1.
        answer = {'l1':l1, 'r1':r1, 'l2':l2, 'r2':r2, 'l3':l3, 'r3':r3}
        return answer

    elif map_type == 'hollow_cyl':
        a1 = np.random.rand()
        a2 = np.random.rand()
        a3 = np.random.rand()
        answer = {'a1':a1, 'a2':a2, 'a3':a3}
        return answer
    
    elif map_type == 'colella':
        Lx = 1.
        Ly = 1.
        Lz = 1.
        alpha = np.random.rand()
        answer = {'Lx':Lx, 'Ly':Ly, 'Lz':Lz, 'alpha':alpha}
        return answer
    
    elif map_type == 'orthogonal':
        Lx = 1.
        Ly = 1.
        Lz = 1.
        alpha = np.random.rand()
    ...
    elif map_type == 'hollow_torus':
        a1 = np.random.rand()
        a2 = np.random.rand()
        R0 = np.random.rand()
        answer = {'a1':a1, 'a2':a2, 'R0':R0}
        return answer

    elif map_type == 'ellipse':
        x0 = np.random.rand()
        y0 = np.random.rand()
        z0 = np.random.rand()
        rx = np.random.rand()
        ry = np.random.rand()
        Lz = np.random.rand()
        answer = {'x0':x0, 'y0':y0, 'z0':z0, 'rx':rx, 'ry':ry, 'Lz':Lz}
        return answer

    elif map_type == 'rotated_ellipse':
        x0 = np.random.rand()
        y0 = np.random.rand()
        z0 = np.random.rand()
        r1 = np.random.rand()
        ...
        Lz = np.random.rand()
        th = np.random.rand()
        answer = {'x0':x0, 'y0':y0, 'z0':z0, 'r1':r1, 'r2':r2, 'Lz':Lz, 'th':th}
        return answer

    elif map_type == 'soloviev_approx':
        x0 = np.random.rand()
        y0 = np.random.rand()
        z0 = np.random.rand()
        rx = np.random.rand()
        ...
        R0 = np.random.rand()
        Lz = np.random.rand()
        delta_x = np.random.rand()
        delta_y = np.random.rand()
        delta_gs = np.random.rand()
        epsilon_gs = np.random.rand()
        kappa_gs = np.random.rand()
        answer = {'x0':x0, 'y0':y0, 'z0':z0, 'R0':R0, 'Lz':Lz, 'delta_x':delta_x, 'delta_y':delta_y, 'delta_gs':delta_gs, 'epsilon_gs':epsilon_gs, 'kappa_gs':kappa_gs}
        return answer

    elif map_type == 'spline_cyl':
        a = np.random.rand()
        R0 = np.random.rand()
        Nel = [16, 2]
        p = [3, 1] 
        spl_kind = [False, True]
        answer = {'a':a, 'R0':R0, 'Nel':Nel, 'p':p, 'spl_kind':spl_kind}
        return answer

    elif map_type == 'spline_torus':
        a = np.random.rand()
        R0 = np.random.rand()
        Nel = [16, 2]
        p = [3, 1] 
        ...
        raise ValueError('Mapping is not implemented')
