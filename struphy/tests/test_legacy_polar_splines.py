def test_polar_splines_2D(plot=False):
    ...
    mapping   = 'spline_cyl'      # spline_cyl or spline_torus
    a         = 1.0               # minor radius
    ...
    print('dimension of space V0 : ', space_2d.E0.shape[1], 'dimension of polar space bar(V0) : ', space_2d.E0.shape[0], 'dimension of polar space bar(V0)_0 : ', space_2d.E0_0.shape[0])
    print('dimension of space V1 : ', space_2d.E1.shape[1], 'dimension of polar space bar(V1) : ', space_2d.E1.shape[0], 'dimension of polar space bar(V1)_0 : ', space_2d.E1_0.shape[0])
    print('dimension of space V2 : ', space_2d.E2.shape[1], 'dimension of polar space bar(V2) : ', space_2d.E2.shape[0], 'dimension of polar space bar(V2)_0 : ', space_2d.E2_0.shape[0])
    print('dimension of space V3 : ', space_2d.E3.shape[1], 'dimension of polar space bar(V3) : ', space_2d.E3.shape[0], 'dimension of polar space bar(V3)_0 : ', space_2d.E3_0.shape[0])
