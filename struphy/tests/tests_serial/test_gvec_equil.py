...
def test_gvec_equil():
    ...
    import struphy as _
    dat_file_in = _.__path__[0] + \
        '/fields_background/mhd_equil/gvec' + mhd_equil.params['dat_file']
