...
def main():
    ...
    for k in range(1000):
        ...
        for a in range(3):
            ...
            function_v(p, b1, b2, b3 , ind1, ind2, ind3, vector, filling_v)
            ...
            for b in range(3):
                ...
                if a == b:
                    ...
                    function_m(p, b1, b2, b3, ind1, ind2, ind3, matrix, filling_m)
                    ...
                    function_mv(p, b1, b2, b3, ind1, ind2, ind3, matrix, filling_m, vector, filling_v)
                    ...
                    function_m(p, b1, b2, b3, b4, b5, ind1, ind2, ind3, matrix, filling_m)
                    ...
                    function_mv(p, b1, b2, b3, b4, b5, ind1, ind2, ind3, matrix, filling_m, vector, filling_v)
