...
def test_eval_kernels(Nel, p, spl_kind, n_markers=10):
    ...
    from struphy.feec.basics.spline_evaluation_3d import eval_spline_mpi_kernel as eval3d_mpi
...
def test_eval_field(Nel, p, spl_kind):
    ...
    from struphy.feec import bsplines_kernels as bsp
    from struphy.feec.basics.spline_evaluation_3d import evaluate_matrix
