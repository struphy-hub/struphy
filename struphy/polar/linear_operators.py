...
class PolarLinearOperator(LinOpWithTransp):
    ...
    def __init__(self, V, W, tp_operator=None, blocks_pol_to_ten=None, blocks_pol_to_pol=None, blocks_e3=None, transposed=False):
    ...
    def transpose(self):
        ...
        return PolarLinearOperator(V, W, tp_operator=self.tp_operator.transpose(), blocks_pol_to_ten=blocks_pol_to_ten, blocks_pol_to_pol=blocks_pol_to_pol, blocks_e3=blocks_e3, transposed=not self.transposed)
