...
class PC_LinMHD_6d_full(StruphyModel):
    ...
    def __init__(self, params, comm):
        ...
        if self._u_space == 'Hcurl':
            ...
            Pressurecoupling = getattr(propagators, 'StepFullPressurecouplingHcurl')
            ...
            Pressurecoupling = getattr(propagators, 'StepFullPressurecouplingHdiv')
            PushEta = getattr(propagators, 'StepPushEtaFullPC')
            PushVel = getattr(propagators, 'StepPushVxB')
            ...
            Pressurecoupling = getattr(propagators, 'StepFullPressurecouplingH1vec')
            PushEta = getattr(propagators, 'StepPushEtaFullPC')
            PushVel = getattr(propagators, 'StepPushVxB')
...
class PC_LinMHD_6d(StruphyModel):
    ...
    .. math::
        ...
        \rho_0&\frac{\partial \tilde{\mathbf{U}}}{\partial t} + \nabla \tilde p + \nabla\cdot \tilde{\mathbb{P}}_{h, /perp} 
        =(\nabla\times \tilde{\mathbf{B}})\times\mathbf{B}_0 + \mathbf{J}_0\times \tilde{\mathbf{B}}
        \,, \qquad
        \mathbf{J}_0 = \nabla\times\mathbf{B}_0\,,
        ...
        &\frac{\partial f_h}{\partial t} + (\mathbf{v} + \tilde{\mathbf{U}}_/perp)\cdot\frac{\partial f_h}{\partial \mathbf{x}}
        + (\frac{q_h}{m_h}\mathbf{v}\\times(\mathbf{B} + \tilde{\mathbf{B}}_0) - \nabla \tilde{\mathbf{U}}_/perp \cdot \mathbf{v})\cdot\frac{\partial f_h}{\partial \mathbf{v}}
        = 0\,,

        &\tilde{\mathbb{P}}_{h, /perp}  = \int \mathbf{v}\mathbf{v}_/perp^\top f_h d\mathbf{v} \,.
        domain: struphy.geometry.domain_3d.Domain
