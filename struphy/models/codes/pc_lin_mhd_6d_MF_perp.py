...
def execute(file_in, path_out, restart):
    '''Executes the code pc_lin_mhd_6d_MF_perp.
    ...
    print()
    print('Starting code "pc_lin_mhd_6d_MF_perp" ...')
    print()
    ...
    def update():
        ...
        if params['time']['split_algo'] == 'LieTrotter':
            ...
            UPDATE_PC.step_ph_perp(MHD.up, KIN.particles_loc, print_info=True)
            MPI_COMM.Bcast(MHD.up, root=0)

            UPDATE_MARKERS.step_eta_RK4_pc_perp(KIN.particles_loc, MHD.up, params['mhd_init']['general']['basis_u'], print_info=True)
