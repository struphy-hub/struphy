...
from struphy.models.substeps            import push_cc_MF
...
def execute(file_in, path_out, restart):
    ...
    print()
    print('Starting code "cc_lin_mhd_6d_MF" ...')
    print()
    ...
    UPDATE_CC = push_cc_MF.Current_coupling(dts_cc, DOMAIN, SPACES, MHD_OPS_MF, ACCUM, MPI_COMM, KIN.Np, KIN.Np_loc, 
