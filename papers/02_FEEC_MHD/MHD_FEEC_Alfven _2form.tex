...
\begin{align}
\left((\ast\rho_\text{eq}^3)\wedge\frac{\pa\tilde{U}^2}{\pa t},C^2\right)=&\left(\ast i_{\lozenge B^2_\text{eq}}\mr{d}\ast \tilde{B}^2,C^2\right)+\left(\ast i_{\lozenge\tilde{B}^2}\mr{d}\ast B^2_\text{eq},C^2\right)-\left(\ast\text{d}\tilde{p}^0,C^2\right)\\-&\left((\ast\rho^3_\text{h})\wedge i_{\lozenge\tilde{U}^2}B^2,C^2\right)+\left(i_{\lozenge j_\text{h}^2}B^2,C^2\right)\qquad\forall\;C^2\in H\Lambda^2(\Omega).
\end{align}
...
\begin{align}
\left(\ast i_{\lozenge\tilde{B}^2}\mr{d}\ast B^2_\text{eq},C^2\right)&=\left(\mr{d}\ast\tilde{B}^2,\ast i_{\lozenge C^2}B_\text{eq}^2\right)=\int_{\hat{\Omega}}\frac{1}{g}\hat{\mb{B}}_\text{eq}^\top G\left(\nabla\times(\tilde{\mb{B}}\times G^{-1}\mb{C})\right)\sqrt{g}\,\mr{d}^3q\\
