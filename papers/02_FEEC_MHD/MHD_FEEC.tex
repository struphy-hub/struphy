...
\end{align}
where $(\mathbb{P}^2_{1/2/3})_{ik}=\Lambda^2_{1/2/3,i}(\mb{q}_k)\in\mathbb{R}^{N\times N_p}$ and $\mb{Q}\in\mathbb{R}^{3N_p}$ is the vector holding all particle positions. For reasons of clarity, we neglect the mapping for the moment, i.e. we have $DF=Id$. This yields
\begin{align}
