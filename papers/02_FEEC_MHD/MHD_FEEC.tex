...
\end{pmatrix}\quad&&\Rightarrow \quad\mb{b}(t)=\mb{b}(t_0)-t\mathbb{C}\mathbb{P}_1^1\mb{u},\\
&H_B:\quad\mathbb{J}\nabla_\mb{S}H_U=\begin{pmatrix}
(\mathbb{M}^1)^{-1}(\mathbb{P}_1^1)^\top\mathbb{C}^\top\mathbb{M}^2/(\rho_0\mu_0) \\ 0
\end{pmatrix}\quad&&\Rightarrow \quad\mb{u}(t)=\mb{u}(t_0)+t(\mathbb{M}^1)^{-1}(\mathbb{P}_1^1)^\top\mathbb{C}^\top\mathbb{M}^2/(\rho_0\mu_0)\mb{b},
\end{alignat}
...
\begin{align}
&\omega_{\mr{M}}^\pm(k)^2=\frac{1}{2}k^2(c_\mr{S}^2+v_\mr{A}^2)(1\pm\sqrt{1-\delta}),\quad\delta=\frac{4B_{0z}^2c_\mr{S}^2v_\mr{A}^2}{(c_\mr{S}^2+v_\mr{A}^2)^2B_0^2},\quad c_\mr{S}^2=\frac{\gamma p_0}{2\rho_0},\quad v_\mr{A}^2=\frac{B_0^2}{\mu_0\rho_0}, \\
...
The semi-discrete system which shouls be able to describe these waves reads
\begin{align}
\frac{\pa}{\pa t}\begin{pmatrix}
