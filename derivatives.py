...
def CURL_3d(p, Nbase, bc):
    ...
    grad_xy = sparse.kron(sparse.kron(sparse.identity(Nbase_x_0), sparse.identity(Nbase_y_0 + (1 - bc_y))), grad_z_1d)
    grad_xz = sparse.kron(sparse.kron(sparse.identity(Nbase_x_0), grad_y_1d), sparse.identity(Nbase_z_0 + (1 - bc_z)))

    grad_yx = sparse.kron(sparse.kron(sparse.identity(Nbase_x_0 + (1 - bc_x)), sparse.identity(Nbase_y_0)), grad_z_1d)
    grad_yz = sparse.kron(sparse.kron(grad_x_1d, sparse.identity(Nbase_y_0)), sparse.identity(Nbase_z_0 + (1 - bc_z)))

    grad_zx = sparse.kron(sparse.kron(sparse.identity(Nbase_x_0 + (1 - bc_x)), grad_y_1d), sparse.identity(Nbase_z_0))
    grad_zy = sparse.kron(sparse.kron(grad_x_1d, sparse.identity(Nbase_y_0 + (1 - bc_y))), sparse.identity(Nbase_z_0))
