...
# ========= MPI initialization ===============
Np_loc        = int(Np/mpi_size)

#particles     = None
#w0            = None
#s0            = None

particles_loc = np.empty((Np_loc, 7), dtype=float)
w0_loc        = np.empty( Np_loc    , dtype=float)
s0_loc        = np.empty( Np_loc    , dtype=float)

U_part_loc    = np.empty((Np_loc, 3), dtype=float)
B_part_loc    = np.empty((Np_loc, 3), dtype=float)
# ===========================================
