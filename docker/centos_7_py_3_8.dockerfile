...
RUN groupadd -r struphyUser && useradd -m -r -g struphyUser struphyUser
RUN mkdir -p /centos_7_py_3_8/ && chown struphyUser:struphyUser /centos_7_py_3_8/

WORKDIR /centos_7_py_3_8/
USER struphyUser
