...
def matrix_step1(particles, p0, spans0, Nbase, T1, T2, T3, tt1, tt2, tt3, mapping, B_part, mat12, mat13, mat23):
                    ...
                    for jl1 in range(p0_1 + 1):
                        ...
                        for jl2 in range(p1_2 + 1):
                            ...
                            for jl3 in range(p0_3 + 1):
                                ...
                                mat22[i1, i2, i3, j1, j2, j3] += temp22 * N1[p0_1 - il1] * D2[p1_2 - il2] * N3[p0_3 - il3] * N1[p0_1 - jl1] * D2[p1_2 - jl2] * N3[p0_3 - jl3]
                    ...
                    for jl1 in range(p0_1 + 1):
                        ...
                        for jl2 in range(p0_2 + 1):
                            ...
                            for jl3 in range(p1_3 + 1):
                                ...
                                mat33[i1, i2, i3, j1, j2, j3] += temp33 * N1[p0_1 - il1] * N2[p0_2 - il2] * D3[p1_3 - il3] * N1[p0_1 - jl1] * N2[p0_2 - jl2] * D3[p1_3 - jl3]
...
#==========================================================================================================
@external_call
@types('double[:,:](order=F)','int[:]','int[:,:](order=F)','int[:]','double[:,:,:](order=F)','double[:,:,:](order=F)','double[:,:,:](order=F)','double[:]','double[:]','double[:]','double[:]','double[:]','double[:]','double[:]','double[:]','double[:,:,:](order=F)','double[:,:,:](order=F)','double[:,:,:](order=F)')
def vector_step3(particles, p0, spans0, Nbase, b1, b2, b3, T1, T2, T3, tt1, tt2, tt3, mapping, Beq, vec1, vec2, vec3):
    ...
    for ip in range(np):
        ...
        matrix_matrix(Ginv, B_prod, temp_mat1)
        matrix_matrix(temp_mat1, DFinv, temp_mat2)
        matrix_vector(temp_mat2, v, temp_vec)
        ...
        for il1 in range(p1_1 + 1):
            ...
            for il2 in range(p0_2 + 1):
                ...
                for il3 in range(p0_3 + 1):
                    ...
                    vec1[i1, i2, i3] += temp1 * D1[p1_1 - il1] * N2[p0_2 - il2] * N3[p0_3 - il3]
        ...
        for il1 in range(p0_1 + 1):
            ...
            for il2 in range(p1_2 + 1):
                ...
                for il3 in range(p0_3 + 1):
                    ...
                    vec2[i1, i2, i3] += temp2 * N1[p0_1 - il1] * D2[p1_2 - il2] * N3[p0_3 - il3] 
        ...
        for il1 in range(p0_1 + 1):
            ...
            for il2 in range(p0_2 + 1):
                ...
                for il3 in range(p1_3 + 1):
                    ...
                    vec3[i1, i2, i3] += temp3 * N1[p0_1 - il1] * N2[p0_2 - il2] * D3[p1_3 - il3] 
