...
RUN curl -O --header "PRIVATE-TOKEN: glpat-5QH11Kx-65GGiykzR5xo" "https://gitlab.mpcdf.mpg.de/api/v4/projects/5368/jobs/2014933/artifacts/dist/gvec_to_python-1.0.1-py3-none-any.whl" \
    && pip install gvec_to_python-1.0.1-py3-none-any.whl \
    && rm gvec_to_python-1.0.1-py3-none-any.whl 
