...
class Domain(metaclass=ABCMeta):
    ...
    def show(
        ...
        markers : array-like
            Markers to be plotted. Can be of shape (xp. 3) or (:, xp. 3). For the former, all markers are plotted with the same color. For the latter, with different colors (are interpreted as orbits in time).
