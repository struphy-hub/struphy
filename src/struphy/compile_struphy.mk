...
SOURCES := $(LAC).py $(LAMV).py $(LATR).py $(BK).py $(BEV1).py $(BEV2).py $(BEV3).py $(MAFA).py $(MEVA).py $(TR3).py $(MK).py $(MOMK).py $(F0K).py $(BEVA).py $(PLP).py $(PLM).py $(PLMH).py $(BTS).py $(UTL).py $(FK).py $(MVF).py $(ACC).py $(ACC_GC).py $(PUTL).py $(PUSH).py $(PUSH_GC).py $(EVAL_GC).py $(PS).py $(KM2).py $(KM3).py $(KPG).py $(KPGM).py $(PSY0).py $(PSY1).py $(PSY2).py $(PSY3).py $(PSY4).py
...
$(PSY2)$(SO_EXT) : $(PSY2).py $(PSY0)$(SO_EXT)
	pyccel $(FLAGS) $< 
...
$(UTL)$(SO_EXT) : $(UTL).py $(BEV3)$(SO_EXT) $(BK)$(SO_EXT)
	pyccel $(FLAGS)$(FLAGS_openmp_pic) $<

$(FK)$(SO_EXT) : $(FK).py $(BK)$(SO_EXT)
	pyccel $(FLAGS) $< 
...
$(PUSH)$(SO_EXT) : $(PUSH).py $(PUTL)$(SO_EXT) $(LAC)$(SO_EXT) $(MEVA)$(SO_EXT) $(BK)$(SO_EXT) $(BEV3)$(SO_EXT)
	pyccel $(FLAGS)$(FLAGS_openmp_pic) $< 

$(PUSH_GC)$(SO_EXT) : $(PUSH_GC).py $(PUTL)$(SO_EXT) $(LAC)$(SO_EXT) $(MEVA)$(SO_EXT) $(BK)$(SO_EXT) $(BEV3)$(SO_EXT)
	pyccel $(FLAGS)$(FLAGS_openmp_pic) $< 

$(EVAL_GC)$(SO_EXT) : $(EVAL_GC).py $(PUTL)$(SO_EXT) $(LAC)$(SO_EXT) $(MEVA)$(SO_EXT) $(BK)$(SO_EXT) $(BEV3)$(SO_EXT)
	pyccel $(FLAGS)$(FLAGS_openmp_pic) $< 
...
$(KPGM)$(SO_EXT) : $(KPGM).py $(PSY0)$(SO_EXT)
	pyccel $(FLAGS)$(FLAGS_openmp_mhd) $< 
