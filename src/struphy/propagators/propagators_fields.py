...
class Stokes(Propagator):
    ...
    def __init__(
        ...
        *,
        ...
        print(f'{type(_Fnp)=}')
        print(f'{type(_Fnp[0])=}')
        _A11np =  self._M2np + self._nu*(self._Dnp.T @ self._M3np @ self._Dnp) #+ Hodgenp.T @ Cnp.T @ M2np @ Cnp @ Hodgenp  
        ...
        self._solver_InexactUzawaNumpy = SaddlePointSolverInexactUzawaNumpy(
            _Anp,
            _Bnp,
            _Fnp,
            _Anppre,
