...
if __name__ == "__main__":
    ...
    parser.add_argument("-n", "--name", type=str, metavar="FILE", help="name of .xp. file to analyze", required=True)
    ...
    parser.add_argument(
        ...
        type=str,
        metavar="DIR",
        help="directory with eigenspectrum (.xp.) and parameter (.yml) file, relative to <install_path>/struphy/io/out/ (default=sim_1)",
        default="sim_1",
    )
    ...
    parser.add_argument(
        ...
        type=str,
        metavar="DIR",
        help="directory with eigenspectrum (.xp.) and parameter (.yml) file, absolute path",
    )
    ...
    # absolute path of .xp. spectrum and toroidal mode number
