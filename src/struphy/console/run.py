def struphy_run(
    ...
    # command parts
    cmd_python = ["python3"]
    cmd_main = ["main.py", model, "-i", input_abs, "-o", output_abs, "--runtime", str(runtime), "-s", str(save_step)]
    ...
    if batch_abs is None:
        ...
        if debug:
            ...
            command = (
                ["srun", "-n", str(mpi), "-p", "interactive", "--time", "119", "--mem", "2000"]  # interactive commands
                + cmd_python
