def struphy_compile(language, compiler, omp_pic, omp_feec, delete, status, verbose, dependencies, collect, yes):
    """
    ...
    collect : bool
        Whether to collect Struphy model names and save them in .bin.
