...
def is_installed_editable(package_name):
    """
    Check if a package is installed in editable mode by inspecting `pip show {package_name}`.
    """
    try:
