...
def test_plotting_function():
    ...
    background.plot_density_profile("e1","e2", domain=domains.HollowTorus(), proj_axis=(0,2), in_physical=True, plot_3D=True)
    background.plot_density_profile("e2","e3", domain=domains.HollowTorus(), proj_axis=(1,2), in_physical=True, plot_3D=True)
