...
@pure
def basis_funs(t: 'Final[float[:]]', p: 'int', eta: 'float', span: 'int', left: 'float[:]', right: 'float[:]', values: 'float[:]'):
    """
    Parameters
    ----------
    t : array[float]
...
@pure
def basis_funs_all_ders(knots: 'Final[float[:]]', degree: int, eta: float, span: int, left: 'float[:]', right: 'float[:]', n: int, ders: 'float[:, :]'):
    """
...
def basis_funs_1st_der(t: 'Final[float[:]]', p: 'int', eta: 'float', span: 'int', left: 'float[:]', right: 'float[:]', values: 'float[:]'):
    """
    Parameters
    ----------
    t : array_like
