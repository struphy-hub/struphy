...
class Accumulator:
            ...
            for b in range(3):
                ...
                if self.space.dim == 2:
                    ...
                    self.blocks_loc[a][b] = np.empty(
                        (Ni[0], Ni[1], Ni[2], 2*self.space.p[0] + 1, 2*self.space.p[1] + 1, self.space.NbaseN[2]), dtype=float,
                    )
                    ...
                    self.blocks_loc[a][b] = np.empty(
                        (Ni[0], Ni[1], Ni[2], 2*self.space.p[0] + 1, 2*self.space.p[1] + 1, 2*self.space.p[2] + 1), dtype=float,
                    )
                    self.blocks_glo[a][b] = np.empty(
                        (Ni[0], Ni[1], Ni[2], 2*self.space.p[0] + 1, 2*self.space.p[1] + 1, 2*self.space.p[2] + 1), dtype=float,
                    )
    ...
    def to_sparse_step1(self):
        ...
        M = spa.bmat(
            [
                [None, M[0][1], M[0][2]], [-M[0][1].T, None, M[1][2]],
                [-M[0][2].T, -M[1][2].T, None],
            ], format='csr',
        )
    ...
    def to_sparse_step3(self):
        ...
        M = spa.bmat(
            [
                [M[0][0], M[0][1], M[0][2]], [M[0][1].T, M[1][1], M[1][2]],
                [M[0][2].T, M[1][2].T, M[2][2]],
            ], format='csr',
        )
