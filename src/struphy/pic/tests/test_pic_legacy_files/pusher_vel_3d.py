...
# ==========================================================================================================
@types('double[:,:]', 'double', 'double[:]', 'double[:]', 'double[:]', 'int[:]', 'int[:]', 'int[:]', 'int[:]', 'int', 'double[:,:,:]', 'double[:,:,:]', 'double[:,:,:]', 'double[:,:,:]', 'double[:,:,:]', 'double[:,:,:]', 'double[:,:,:]', 'int', 'int', 'double[:]', 'double[:]', 'double[:]', 'double[:]', 'int[:]', 'int[:]', 'int[:]', 'double[:,:,:]', 'double[:,:,:]', 'double[:,:,:]', 'double[:]', 'double[:]')
def pusher_step3(particles, dt, t1, t2, t3, p, nel, nbase_n, nbase_d, np, b2_1, b2_2, b2_3, b0, u1, u2, u3, basis_u, kind_map, params_map, tf1, tf2, tf3, pf, nelf, nbasef, cx, cy, cz, mu, power):
    ...
    for ip in range(np):
        ...
        mapping_fast.df_all(
            kind_map, params_map, tf1, tf2, tf3, pf, nbasef, span1f, span2f, span3f, cx, cy, cz, l1f,
        ...
        if basis_u == 0:
            ...
            u[0] = eva3.evaluation_kernel_3d(
                pn1, pn2, pn3, bn1, bn2, bn3, span1, span2,
        ...
        # velocity field (1-form, push forward with df^(-T))
            ...
            u[0] = eva3.evaluation_kernel_3d(
                pd1, pn2, pn3, bd1, bn2, bn3, span1 - 1,
                span2, span3, nbase_d[0], nbase_n[1], nbase_n[2], u1,
            )
            u[1] = eva3.evaluation_kernel_3d(
                pn1, pd2, pn3, bn1, bd2, bn3, span1, span2 -
                1, span3, nbase_n[0], nbase_d[1], nbase_n[2], u2,
            )
            u[2] = eva3.evaluation_kernel_3d(
                pn1, pn2, pd3, bn1, bn2, bd3, span1, span2,
                span3 - 1, nbase_n[0], nbase_n[1], nbase_d[2], u3,
            )
        ...
        # velocity field (2-form, push forward with df/|det df|)
            ...
            u[0] = eva3.evaluation_kernel_3d(
                pn1, pd2, pd3, bn1, bd2, bd3, span1, span2 - 1,
                span3 - 1, nbase_n[0], nbase_d[1], nbase_d[2], u1,
            )
            u[1] = eva3.evaluation_kernel_3d(
                pd1, pn2, pd3, bd1, bn2, bd3, span1 - 1,
                span2, span3 - 1, nbase_d[0], nbase_n[1], nbase_d[2], u2,
            )
            u[2] = eva3.evaluation_kernel_3d(
                pd1, pd2, pn3, bd1, bd2, bn3, span1 - 1,
                span2 - 1, span3, nbase_d[0], nbase_d[1], nbase_n[2], u3,
            )
        ...
        b[0] = eva3.evaluation_kernel_3d(
            pn1, pd2, pd3, bn1, bd2, bd3, span1, span2 - 1,
            span3 - 1, nbase_n[0], nbase_d[1], nbase_d[2], b2_1,
        )
        b[1] = eva3.evaluation_kernel_3d(
            pd1, pn2, pd3, bd1, bn2, bd3, span1 - 1, span2,
            span3 - 1, nbase_d[0], nbase_n[1], nbase_d[2], b2_2,
        )
        b[2] = eva3.evaluation_kernel_3d(
            pd1, pd2, pn3, bd1, bd2, bn3, span1 - 1, span2 -
            1, span3, nbase_d[0], nbase_d[1], nbase_n[2], b2_3,
        )
        ...
        b_grad[0] = eva3.evaluation_kernel_3d(
            pn1, pn2, pn3, der1, bn2, bn3, span1,
            span2, span3, nbase_n[0], nbase_n[1], nbase_n[2], b0,
        )
        b_grad[1] = eva3.evaluation_kernel_3d(
            pn1, pn2, pn3, bn1, der2, bn3, span1,
            span2, span3, nbase_n[0], nbase_n[1], nbase_n[2], b0,
        )
        b_grad[2] = eva3.evaluation_kernel_3d(
            pn1, pn2, pn3, bn1, bn2, der3, span1,
            span2, span3, nbase_n[0], nbase_n[1], nbase_n[2], b0,
        )
...
def pusher_step5_old(particles, dt, t1, t2, t3, p, nel, nbase_n, nbase_d, np, b2_1, b2_2, b2_3, kind_map, params_map, tf1, tf2, tf3, pf, nelf, nbasef, cx, cy, cz):
...
# ==========================================================================================================
@types('double[:,:]', 'double', 'double[:]', 'double[:]', 'double[:]', 'int[:]', 'int[:]', 'int[:]', 'int[:]', 'int', 'double[:,:,:]', 'double[:,:,:]', 'double[:,:,:]', 'int', 'double[:]', 'double[:]', 'double[:]', 'double[:]', 'int[:]', 'int[:]', 'int[:]', 'double[:,:,:]', 'double[:,:,:]', 'double[:,:,:]')
def pusher_step5(particles, dt, t1, t2, t3, p, nel, nbase_n, nbase_d, np, b2_1, b2_2, b2_3, kind_map, params_map, tf1, tf2, tf3, pf, nelf, nbasef, cx, cy, cz):
...
def pusher_v_pressure_full(particles, dt, t1, t2, t3, p, nel, nbase_n, nbase_d, np, u11, u12, u13, u21, u22, u23, u31, u32, u33, kind_map, params_map, tf1, tf2, tf3, pf, nelf, nbasef, cx, cy, cz):
    ...
    for ip in range(np):
        ...
        u[0] = eva3.evaluation_kernel_3d(
            pd1, pn2, pn3, bd1, bn2, bn3, span1 - 1, span2,
            span3, nbase_d[0], nbase_n[1], nbase_n[2], u11 * v[0] + u21 * v[1] + u31 * v[2],
        )
        u[1] = eva3.evaluation_kernel_3d(
            pn1, pd2, pn3, bn1, bd2, bn3, span1, span2 - 1,
            span3, nbase_n[0], nbase_d[1], nbase_n[2], u12 * v[0] + u22 * v[1] + u32 * v[2],
        )
        u[2] = eva3.evaluation_kernel_3d(
            pn1, pn2, pd3, bn1, bn2, bd3, span1, span2, span3 - 1,
            nbase_n[0], nbase_n[1], nbase_d[2], u13 * v[0] + u23 * v[1] + u33 * v[2],
        )
...
# ==========================================================================================================
@types('double[:,:]', 'double', 'double[:]', 'double[:]', 'double[:]', 'int[:]', 'int[:]', 'int[:]', 'int[:]', 'int', 'double[:,:,:]', 'double[:,:,:]', 'double[:,:,:]', 'double[:,:,:]', 'double[:,:,:]', 'double[:,:,:]', 'double[:,:,:]', 'double[:,:,:]', 'double[:,:,:]', 'int', 'int', 'double[:]', 'double[:]', 'double[:]', 'double[:]', 'int[:]', 'int[:]', 'int[:]', 'double[:,:,:]', 'double[:,:,:]', 'double[:,:,:]')
def pusher_v_pressure_perp(particles, dt, t1, t2, t3, p, nel, nbase_n, nbase_d, np, u11, u12, u13, u21, u22, u23, u31, u32, u33, kind_map, params_map, tf1, tf2, tf3, pf, nelf, nbasef, cx, cy, cz):
    ...
    for ip in range(np):
        ...
        u[0] = eva3.evaluation_kernel_3d(
            pd1, pn2, pn3, bd1, bn2, bn3, span1 - 1, span2,
            span3, nbase_d[0], nbase_n[1], nbase_n[2], u21 * v[1] + u31 * v[2],
        )
        u[1] = eva3.evaluation_kernel_3d(
            pn1, pd2, pn3, bn1, bd2, bn3, span1, span2 - 1,
            span3, nbase_n[0], nbase_d[1], nbase_n[2], u22 * v[1] + u32 * v[2],
        )
        u[2] = eva3.evaluation_kernel_3d(
            pn1, pn2, pd3, bn1, bn2, bd3, span1, span2,
            span3 - 1, nbase_n[0], nbase_n[1], nbase_d[2], u23 * v[1] + u33 * v[2],
        )
