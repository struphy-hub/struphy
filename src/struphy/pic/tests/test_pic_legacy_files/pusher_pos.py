...
def pusher_step4(particles, dt, np, kind_map, params_map, tf1, tf2, tf3, pf, nelf, nbasef, cx, cy, cz, bc):
    ...
    for ip in range(np):
        ...
        mapping_fast.df_all(
            kind_map, params_map, tf1, tf2, tf3, pf, nbasef, span1f, span2f, span3f, cx, cy, cz, l1f, l2f,
            l3f, r1f, r2f, r3f, b1f, b2f, b3f, d1f, d2f, d3f, der1f, der2f, der3f, e_new[0], e_new[1], e_new[2], df, fx, 0,
        )
...
def pusher_step4_pcart(particles, dt, np, kind_map, params_map, tf1, tf2, tf3, pf, nelf, nbasef, cx, cy, cz, map_pseudo, r0_pseudo):
    ...
    for ip in range(np):
        ...
        fx_pseudo[0] = mapping.f(
            eta[0], eta[1], eta[2], 1, map_pseudo,
            params_pseudo, tf1, tf2, tf3, pf, nbasef, cx, cy, cz,
        )
        fx_pseudo[1] = mapping.f(
            eta[0], eta[1], eta[2], 2, map_pseudo,
            params_pseudo, tf1, tf2, tf3, pf, nbasef, cx, cy, cz,
        )
        fx_pseudo[2] = mapping.f(
            eta[0], eta[1], eta[2], 3, map_pseudo,
            params_pseudo, tf1, tf2, tf3, pf, nbasef, cx, cy, cz,
        )
        ...
        mapping_fast.df_all(
            kind_map, params_map, tf1, tf2, tf3, pf, nbasef, span1f, span2f, span3f, cx, cy, cz, l1f, l2f,
            l3f, r1f, r2f, r3f, b1f, b2f, b3f, d1f, d2f, d3f, der1f, der2f, der3f, eta[0], eta[1], eta[2], df_old, fx, 0,
        )
        ...
        df_pseudo_old[0, 0] = mapping.df(
            eta[0], eta[1], eta[2], 11, map_pseudo,
            params_pseudo, tf1, tf2, tf3, pf, nbasef, cx, cy, cz,
        )
        df_pseudo_old[0, 1] = mapping.df(
            eta[0], eta[1], eta[2], 12, map_pseudo,
            params_pseudo, tf1, tf2, tf3, pf, nbasef, cx, cy, cz,
        )
        df_pseudo_old[0, 2] = mapping.df(
            eta[0], eta[1], eta[2], 13, map_pseudo,
            params_pseudo, tf1, tf2, tf3, pf, nbasef, cx, cy, cz,
        )

        df_pseudo_old[1, 0] = mapping.df(
            eta[0], eta[1], eta[2], 21, map_pseudo,
            params_pseudo, tf1, tf2, tf3, pf, nbasef, cx, cy, cz,
        )
        df_pseudo_old[1, 1] = mapping.df(
            eta[0], eta[1], eta[2], 22, map_pseudo,
            params_pseudo, tf1, tf2, tf3, pf, nbasef, cx, cy, cz,
        )
        df_pseudo_old[1, 2] = mapping.df(
            eta[0], eta[1], eta[2], 23, map_pseudo,
            params_pseudo, tf1, tf2, tf3, pf, nbasef, cx, cy, cz,
        )

        df_pseudo_old[2, 0] = mapping.df(
            eta[0], eta[1], eta[2], 31, map_pseudo,
            params_pseudo, tf1, tf2, tf3, pf, nbasef, cx, cy, cz,
        )
        df_pseudo_old[2, 1] = mapping.df(
            eta[0], eta[1], eta[2], 32, map_pseudo,
            params_pseudo, tf1, tf2, tf3, pf, nbasef, cx, cy, cz,
        )
        df_pseudo_old[2, 2] = mapping.df(
            eta[0], eta[1], eta[2], 33, map_pseudo,
            params_pseudo, tf1, tf2, tf3, pf, nbasef, cx, cy, cz,
        )
        ...
        while True:
            ...
            mapping_fast.df_all(
                ...
                l2f, l3f, r1f, r2f, r3f, b1f, b2f, b3f, d1f, d2f, d3f, der1f, der2f, der3f, eta[0], eta[1], eta[2], df, fx, 0,
            )
...
def pusher_step4_cart(particles, dt, np, kind_map, params_map, tf1, tf2, tf3, pf, nelf, nbasef, cx, cy, cz, tol):
    ...
    for ip in range(np):
        ...
        mapping_fast.df_all(
            kind_map, params_map, tf1, tf2, tf3, pf, nbasef, span1f, span2f, span3f, cx, cy, cz, l1f,
            l2f, l3f, r1f, r2f, r3f, b1f, b2f, b3f, d1f, d2f, d3f, der1f, der2f, der3f, e[0], e[1], e[2], df, x_old, 2,
        )
