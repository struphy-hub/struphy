...
def f(eta1 : 'float', eta2 : 'float', eta3 : 'float', component : 'int', kind_map : 'int', params_map : 'float[:]', tn1 : 'float[:]', tn2 : 'float[:]', tn3 : 'float[:]', pn : 'int[:]', nbase_n : 'int[:]', cx : 'float[:,:,:]', cy : 'float[:,:,:]', cz : 'float[:,:,:]') -> 'float':
    ...
    if kind_map == 0:
        ...
        if component == 1:
            value = eva_3d.evaluate_n_n_n(
                tn1, tn2, tn3, pn[0], pn[1], pn[2],
                nbase_n[0], nbase_n[1], nbase_n[2], cx, eta1, eta2, eta3,
            )

        elif component == 2:
            value = eva_3d.evaluate_n_n_n(
                tn1, tn2, tn3, pn[0], pn[1], pn[2],
                nbase_n[0], nbase_n[1], nbase_n[2], cy, eta1, eta2, eta3,
            )

        elif component == 3:
            value = eva_3d.evaluate_n_n_n(
                tn1, tn2, tn3, pn[0], pn[1], pn[2],
                nbase_n[0], nbase_n[1], nbase_n[2], cz, eta1, eta2, eta3,
            )
    ...
    # ==== 2d spline (curvature in 3rd direction) ===
        ...
        if component == 1:
            value = eva_2d.evaluate_n_n(
                tn1, tn2, pn[0], pn[1], nbase_n[0],
                nbase_n[1], cx[:, :, 0], eta1, eta2,
            ) * cos(2*pi*eta3)
    ...
    if kind_map == 0:
        ...
        if component == 11:
            value = eva_3d.evaluate_diffn_n_n(
                tn1, tn2, tn3, pn[0], pn[1], pn[2], nbase_n[0], nbase_n[1], nbase_n[2], cx, eta1, eta2, eta3,
            )
        elif component == 12:
            ...
            value = eva_3d.evaluate_diffn_n_n(
                tn1, tn2, tn3, pn[0], pn[1], pn[2], nbase_n[0], nbase_n[1], nbase_n[2], cy, eta1, eta2, eta3,
            )
        elif component == 22:
            value = eva_3d.evaluate_n_diffn_n(
                tn1, tn2, tn3, pn[0], pn[1], pn[2], nbase_n[0], nbase_n[1], nbase_n[2], cy, eta1, eta2, eta3,
            ...
            value = eva_3d.evaluate_diffn_n_n(
                tn1, tn2, tn3, pn[0], pn[1], pn[2], nbase_n[0], nbase_n[1], nbase_n[2], cz, eta1, eta2, eta3,
            )
        elif component == 32:
            value = eva_3d.evaluate_n_diffn_n(
                tn1, tn2, tn3, pn[0], pn[1], pn[2], nbase_n[0], nbase_n[1], nbase_n[2], cz, eta1, eta2, eta3,
