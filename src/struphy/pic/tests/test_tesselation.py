...
def test_draw(ppb, nx, ny, nz):
    ...
    # test
    tiles_x = int(nx / particles.xp.ocs[0] * particles.tesselation.nt_per_dim[0])
    tiles_y = int(ny / particles.xp.ocs[1] * particles.tesselation.nt_per_dim[1])
    tiles_z = int(nz / particles.xp.ocs[2] * particles.tesselation.nt_per_dim[2])
