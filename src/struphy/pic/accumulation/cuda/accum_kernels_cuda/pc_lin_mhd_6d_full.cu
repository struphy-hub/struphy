    ...
    const int v1_n2, const int v1_n3, const int v2_n2, const int v2_n3, const int v3_n2, const int v3_n3)
{
    ...
    fill_mat_vec_pressure_full_dev(pd1,p2,p3, pd1,p2,p3, bd1,bn2,bn3, bd1,bn2,bn3, span1,span2,span3, start0,start1,start2, p1,p2,p3,
        mat11_11, mat11_12, mat11_13, mat11_22, mat11_23, mat11_33, m11_d2,m11_d3,m11_d4,m11_d5,m11_d6, fill11,
        vec1_1, vec1_2, vec1_3, v1_n2,v1_n3, fill1, vx,vy,vz);

    fill_mat_pressure_full_dev(pd1,p2,p3, p1,pd2,p3, bd1,bn2,bn3, bn1,bd2,bn3, span1,span2,span3, start0,start1,start2, p1,p2,p3,
        mat12_11, mat12_12, mat12_13, mat12_22, mat12_23, mat12_33, m12_d2,m12_d3,m12_d4,m12_d5,m12_d6, fill12, vx,vy,vz);

    fill_mat_pressure_full_dev(pd1,p2,p3, p1,p2,pd3, bd1,bn2,bn3, bn1,bn2,bd3, span1,span2,span3, start0,start1,start2, p1,p2,p3,
        mat13_11, mat13_12, mat13_13, mat13_22, mat13_23, mat13_33, m13_d2,m13_d3,m13_d4,m13_d5,m13_d6, fill13, vx,vy,vz);

    fill_mat_vec_pressure_full_dev(p1,pd2,p3, p1,pd2,p3, bn1,bd2,bn3, bn1,bd2,bn3, span1,span2,span3, start0,start1,start2, p1,p2,p3,
        mat22_11, mat22_12, mat22_13, mat22_22, mat22_23, mat22_33, m22_d2,m22_d3,m22_d4,m22_d5,m22_d6, fill22,
        vec2_1, vec2_2, vec2_3, v2_n2,v2_n3, fill2, vx,vy,vz);

    fill_mat_pressure_full_dev(p1,pd2,p3, p1,p2,pd3, bn1,bd2,bn3, bn1,bn2,bd3, span1,span2,span3, start0,start1,start2, p1,p2,p3,
        mat23_11, mat23_12, mat23_13, mat23_22, mat23_23, mat23_33, m23_d2,m23_d3,m23_d4,m23_d5,m23_d6, fill23, vx,vy,vz);

    fill_mat_vec_pressure_full_dev(p1,p2,pd3, p1,p2,pd3, bn1,bn2,bd3, bn1,bn2,bd3, span1,span2,span3, start0,start1,start2, p1,p2,p3,
        mat33_11, mat33_12, mat33_13, mat33_22, mat33_23, mat33_33, m33_d2,m33_d3,m33_d4,m33_d5,m33_d6, fill33,
        vec3_1, vec3_2, vec3_3, v3_n2,v3_n3, fill3, vx,vy,vz);
