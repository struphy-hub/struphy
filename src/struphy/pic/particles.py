...
class Particles6D(Particles):
    ...
    **params : dict
    ...
    def default_bckgr_params(cls):
        return {"type": "Maxwellian3D", "Maxwellian3D": {}}
...
class Particles5D(Particles):
    ...
    **params : dict
    ...
    @classmethod
    def default_bckgr_params(cls):
        return {"type": "GyroMaxwellian2D", "GyroMaxwellian2D": {}}
    ...
    def __init__(
        ...
        **marker_params,
        ...
        self._unit_b1_h = self.derham.P["1"](
            [self.magn_bckgr.unit_b1_1, self.magn_bckgr.unit_b1_2, self.magn_bckgr.unit_b1_3]
        )
    ...
    def svol(self, eta1, eta2, eta3, *v):
        ...
        *v : array_like
        ...
        self._svol = maxwellians.GyroMaxwellian2D(maxw_params=maxw_params, volume_form=True, mhd_equil=self._magn_bckgr)
    ...
    def save_constants_of_motion(self, epsilon, abs_B0=None, f_coords="constants_of_motion", initial=False):
        ...
        if initial:
            utilities_kernels.eval_magnetic_moment_5d(self.markers, self.derham.args_derham, abs_B0._data)

        utilities_kernels.eval_energy_5d(self.markers, self.derham.args_derham, abs_B0._data)
        ...
        if f_coords == "constants_of_motion":
            ...
            utilities_kernels.eval_canonical_toroidal_moment_5d(
                self.markers, self.derham.args_derham, epsilon, B0, R0, abs_B0._data
            )
    ...
    def save_magnetic_background_energy(self):
        ...
        utilities_kernels.eval_magnetic_background_energy(
            self.markers, self.derham.args_derham, self.domain.args_domain, abs_B0._data
        )
