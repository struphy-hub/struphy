...
class Vlasov(StruphyModel):
    ...
    @staticmethod
    def propagators_dct():
        return {propagators_markers.PushVxB: ["ions"], propagators_markers.PushEta: ["ions"]}
...
class GuidingCenter(StruphyModel):
    ...
    def update_scalar_quantities(self):
        ...
        self._en_tot[0] = (
            ...
            .dot(self.pointer["ions"].markers[~self.pointer["ions"].holes, 8])
        ...
        self.derham.comm.Allreduce(self._mpi_in_place, self._en_tot, op=self._mpi_sum)
...
class ShearAlfven(StruphyModel):
    ...
    def __init__(self, params, comm, inter_comm=None):
        ...
        # set keyword arguments for propagators
        self._kwargs[propagators_fields.ShearAlfven] = {"u_space": "Hdiv", "solver": alfven_solver}
...
class Poisson(StruphyModel):
    ...
    @staticmethod
    def propagators_dct():
        return {propagators_fields.TimeDependentSource: ["source"], propagators_fields.ImplicitDiffusion: ["phi"]}
    ...
    def __init__(self, params, comm, inter_comm=None):
        ...
        # set keyword arguments for propagators
        self._kwargs[propagators_fields.TimeDependentSource] = {"omega": omega, "hfun": hfun}
