...
class LinearMHD(StruphyModel):
    ...
    def __init__(self, params, comm, inter_comm=None):
        ...
        self._kwargs[propagators_fields.ShearAlfven] = {"u_space": u_space, "solver": alfven_solver}
...
class LinearExtendedMHDuniform(StruphyModel):
    ...
    def __init__(self, params, comm, inter_comm=None):
        ...
        self._b_eq = self.derham.P["1"]([self.mhd_equil.b1_1, self.mhd_equil.b1_2, self.mhd_equil.b1_3])
        self._p_eq = self.derham.P["3"](self.mhd_equil.p3)
        self._ones = self.pointer["mhd_p"].space.zeros()
        # project background vector potential (1-form)
        self._a_eq = self.derham.P["1"]([self.mhd_equil.a1_1, self.mhd_equil.a1_2, self.mhd_equil.a1_3])
        ...
        # set keyword arguments for propagators
        self._kwargs[propagators_fields.ShearAlfvenB1] = {"solver": alfven_solver, "solver_M1": M1_inv}

        self._kwargs[propagators_fields.Hall] = {"solver": hall_solver, "epsilon": epsilon}
...
class ColdPlasma(StruphyModel):
    ...
    def __init__(self, params, comm, inter_comm=None):
        ...
        self._kwargs[propagators_fields.JxBCold] = {"epsilon": self._epsilon, "solver": params_jxbcold}
