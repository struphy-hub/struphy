...
class GuidingCenter(StruphyModel):
    ...
    def doc_pde(cls):
        ...
        The model solves the collisionless guiding-center transport equation for
        a 5D distribution :math:`f(\mathbf X, v_\parallel, \mu, t)` in a fixed
        magnetic equilibrium. The dynamics include parallel motion along
        :math:`\mathbf B^*` and drift motion generated by :math:`\mathbf E^*`."""
