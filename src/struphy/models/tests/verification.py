...
def IsothermalEulerSPH_soundwave(
    ...
    ee1, ee2, ee3 = xp.load(os.path.join(path_n_sph, "grid_n_sph.xp."))
    n_sph = xp.load(os.path.join(path_n_sph, "n_sph.xp."))
...
def Maxwell_coaxial(
    ...
    t_grid = xp.load(os.path.join(pproc_path, "t_grid.xp."))
