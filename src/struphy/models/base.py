...
class StruphyModel(metaclass=ABCMeta):
    ...
    def __init__(self, params, comm=None, inter_comm=None):
        ...
        if comm.Get_rank() == 0:
            ...
            print("splitting algo:".ljust(25), params["time"]["split_algo"])
                        ...
                        if self._comm_world_rank == 0:
                            ...
                            if "perturbation" in self.em_fields["params"]:
                                ...
                                if pert_type is None:
                                    ...
                                    raise NotImplementedError(
                                        "The type of initial perturbation must be null or str or list.",
                                    )
    ...
    def model_units(cls, params, verbose=False, comm=None):
        ...
        if verbose and rank == 0:
            print("\nUNITS:")
            print(
                "Unit of length:".ljust(25),
                "{:4.3e}".format(units["x"]) + " m",
            )
            print(
                "Unit of time:".ljust(25),
                "{:4.3e}".format(units["t"]) + " s",
            )
            print(
                "Unit of velocity:".ljust(25),
                "{:4.3e}".format(units["v"]) + " m/s",
            )
            print(
                "Unit of magnetic field:".ljust(25),
                "{:4.3e}".format(units["B"]) + " T",
            )

            if A_bulk is not None:
                print(
                    "Unit of particle density:".ljust(25),
                    "{:4.3e}".format(units["n"]) + " m⁻³",
                )
                print(
                    "Unit of mass density:".ljust(25),
                    "{:4.3e}".format(units["rho"]) + " kg/m³",
                )
                print(
                    "Unit of pressure:".ljust(25),
                    "{:4.3e}".format(units["p"] * 1e-5) + " bar",
                )
                print(
                    "Unit of current density:".ljust(25),
    ...
    def _print_plasma_params(self, verbose=True):
        ...
        if verbose:
            ...
            for species, ch in pparams.items():
                print("name:".ljust(25), species)
                print("type:".ljust(25), ch["type"])
                ch.pop("type")
                print("is bulk:".ljust(25), species == self.bulk_species())
