                    ...
                    for q1 in range(nq1):
                        for q2 in range(nq2):
                            ...
                            value += (
                                ...
                                * basis
                                * mat_eq[
                                    row1[i1] + j1 + subs_cum1[row1[i1]], q1, row2[i2] + j2 + subs_cum2[row2[i2]], q2
                                ]
                            )
        ...
        for i2 in range(len(indices2[0])):
            for i3 in range(len(indices3[0])):
                ...
                for j1 in range(n_row_sub1[indices1[0, i1]]):
                    for q1 in range(nq1):
                        value += (
                            ...
                            * bsp12[indices1[0, i1] + j1 + counter1, q1, indices1[2, i1]]
                ...
                rhs[i] += (
                    ...
                    * bsp21[indices2[0, i2], indices2[1, i2]]
                    * bsp22[indices2[0, i2], indices2[2, i2]]
                    * bsp31[indices3[0, i3], indices3[1, i3]]
                ...
                for j2 in range(n_row_sub2[indices2[0, i2]]):
                    for q2 in range(nq2):
                        value += (
                            ...
                            * bsp22[indices2[0, i2] + j2 + counter2, q2, indices2[2, i2]]
                ...
                for j3 in range(n_row_sub3[indices3[0, i3]]):
                    for q3 in range(nq3):
                        value += (
                            ...
                            * bsp32[indices3[0, i3] + j3 + counter3, q3, indices3[2, i3]]
