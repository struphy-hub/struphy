                    ...
                    for j3 in range(subs3[i3]):
                        for q2 in range(nq2):
                            for q3 in range(nq3):
                                ...
                                mat_f[
                                    i1, i2 + j2 + subs_cum2[i2], q2, i3 + j3 +
                                    subs_cum3[i3], q3,
                                ] = wvol * f_int[i1, i2, i3]
                    ...
                    for j3 in range(subs3[i3]):
                        for q1 in range(nq1):
                            for q3 in range(nq3):
                                ...
                                mat_f[
                                    i1 + j1 + subs_cum1[i1], q1, i2, i3 + j3 +
                                    subs_cum3[i3], q3,
                                ] = wvol * f_int[i1, i2, i3]
                            ...
                            for q1 in range(nq1):
                                for q2 in range(nq2):
                                    for q3 in range(nq3):
                                        ...
                                        wvol   = w1[i1 + j1 + subs_cum1[i1], q1] * w2[
                                            i2 + j2 +
                                            subs_cum2[i2], q2,
                                        ] * w3[i3 + j3 + subs_cum3[i3], q3]

                                        value += wvol * mat_f[
                                            i1 + j1 + subs_cum1[i1], q1, i2 +
                                            j2 + subs_cum2[i2], q2, i3 + j3 + subs_cum3[i3], q3,
                                        ]
                            ...
                            for q1 in range(nq1):
                                for q2 in range(nq2):
                                    for q3 in range(nq3):
                                        ...
                                        mat_f[
                                            i1 + j1 + subs_cum1[i1], q1, i2 + j2 + subs_cum2[i2],
                                            q2, i3 + j3 + subs_cum3[i3], q3,
                                        ] = wvol * f_int[i1, i2, i3]
        ...
        for ie2 in range(ne2):
            for ie3 in range(ne3):
                ...
                for q1 in range(nq1):
                    for q2 in range(nq2):
                        for q3 in range(nq3):
                            f_int[ie1, ie2, ie3] += w1[ie1, q1] * w2[ie2, q2] * \
                                w3[ie3, q3] * mat_f[ie1, q1, ie2, q2, ie3, q3]
