...
def get_M0(tensor_space_FEM, domain, apply_boundary_ops=False, weight=None):
    ...
    ker.kernel_mass(
        np.array(Nel), np.array(p), np.array(n_quad), np.array([0, 0, 0]), np.array(
            [0, 0, 0],
        ), wts[0], wts[1], wts[2], basisN[0], basisN[1], basisN[2], basisN[0], basisN[1], basisN[2], indN[0], indN[1], indN[2], M, mat_w*det_df,
    )
            ...
            if np.any(mat_w):
                ker.kernel_mass(
                    np.array(Nel), np.array(p), np.array(n_quad), np.array(ns[a]), np.array(
                        ns[b],
                    ), wts[0], wts[1], wts[2], basis[a][0], basis[a][1], basis[a][2], basis[b][0], basis[b][1], basis[b][2], ind[a][0], ind[a][1], ind[a][2], M[a][b], mat_w*det_df,
                )
...
def get_M3(tensor_space_FEM, domain, apply_boundary_ops=False, weight=None):
    ...
    ker.kernel_mass(
        np.array(Nel), np.array(p), np.array(n_quad), np.array([1, 1, 1]), np.array(
            [1, 1, 1],
        ), wts[0], wts[1], wts[2], basisD[0], basisD[1], basisD[2], basisD[0], basisD[1], basisD[2], indD[0], indD[1], indD[2], M, mat_w/det_df,
    )
