...
def l2_error_V0(tensor_space_FEM, domain, fun, coeff):
    ...
    ker.kernel_l2error(
        Nel, p, n_quad, wts[0], wts[1], wts[2], [0, 0, 0], [0, 0, 0], basisN[0], basisN[1], basisN[2], basisN[0], basisN[1], basisN[2], indN[0], indN[1], indN[2], indN[0], indN[1], indN[2], error, mat_f.reshape(
            Nel[0], n_quad[0], Nel[1], n_quad[1], Nel[2], n_quad[2],
        ), mat_f.reshape(Nel[0], n_quad[0], Nel[1], n_quad[1], Nel[2], n_quad[2]), coeff, coeff, det_df.reshape(Nel[0], n_quad[0], Nel[1], n_quad[1], Nel[2], n_quad[2]),
    )
...
def l2_error_V1(tensor_space_FEM, domain, fun, coeff):
    ...
    # 1 * f1 * G^11 * |det(DF)| * f1
    ker.kernel_l2error(
        Nel, p, n_quad, wts[0], wts[1], wts[2], [1, 0, 0], [1, 0, 0], basisD[0], basisN[1], basisN[2], basisD[0], basisN[1], basisN[2], [indD[0], indN[1], indN[2]], [indD[0], indN[1], indN[2]], error, mat_f1.reshape(
            Nel[0], n_quad[0], Nel[1], n_quad[1], Nel[2], n_quad[2],
        ), mat_f1.reshape(Nel[0], n_quad[0], Nel[1], n_quad[1], Nel[2], n_quad[2]), coeff1, coeff1, 1*metric_coeffs[0, 0].reshape(Nel[0], n_quad[0], Nel[1], n_quad[1], Nel[2], n_quad[2]),
    )

    # 2 * f1 * G^12 * |det(DF)| * f2
    ker.kernel_l2error(
        Nel, p, n_quad, wts[0], wts[1], wts[2], [1, 0, 0], [0, 1, 0], basisD[0], basisN[1], basisN[2], basisN[0], basisD[1], basisN[2], [indD[0], indN[1], indN[2]], [indN[0], indD[1], indN[2]], error, mat_f1.reshape(
            Nel[0], n_quad[0], Nel[1], n_quad[1], Nel[2], n_quad[2],
        ), mat_f2.reshape(Nel[0], n_quad[0], Nel[1], n_quad[1], Nel[2], n_quad[2]), coeff1, coeff2, 2*metric_coeffs[0, 1].reshape(Nel[0], n_quad[0], Nel[1], n_quad[1], Nel[2], n_quad[2]),
    )

    # 2 * f1 * G^13 * |det(DF)| * f3
    ker.kernel_l2error(
        Nel, p, n_quad, wts[0], wts[1], wts[2], [1, 0, 0], [0, 0, 1], basisD[0], basisN[1], basisN[2], basisN[0], basisN[1], basisD[2], [indD[0], indN[1], indN[2]], [indN[0], indN[1], indD[2]], error, mat_f1.reshape(
            Nel[0], n_quad[0], Nel[1], n_quad[1], Nel[2], n_quad[2],
        ), mat_f3.reshape(Nel[0], n_quad[0], Nel[1], n_quad[1], Nel[2], n_quad[2]), coeff1, coeff3, 2*metric_coeffs[0, 2].reshape(Nel[0], n_quad[0], Nel[1], n_quad[1], Nel[2], n_quad[2]),
    )

    # 1 * f2 * G^22 * |det(DF)| * f2
    ker.kernel_l2error(
        Nel, p, n_quad, wts[0], wts[1], wts[2], [0, 1, 0], [0, 1, 0], basisN[0], basisD[1], basisN[2], basisN[0], basisD[1], basisN[2], [indN[0], indD[1], indN[2]], [indN[0], indD[1], indN[2]], error, mat_f2.reshape(
            Nel[0], n_quad[0], Nel[1], n_quad[1], Nel[2], n_quad[2],
        ), mat_f2.reshape(Nel[0], n_quad[0], Nel[1], n_quad[1], Nel[2], n_quad[2]), coeff2, coeff2, 1*metric_coeffs[1, 1].reshape(Nel[0], n_quad[0], Nel[1], n_quad[1], Nel[2], n_quad[2]),
    )

    # 2 * f2 * G^23 * |det(DF)| * f3
    ker.kernel_l2error(
        Nel, p, n_quad, wts[0], wts[1], wts[2], [0, 1, 0], [0, 0, 1], basisN[0], basisD[1], basisN[2], basisN[0], basisN[1], basisD[2], [indN[0], indD[1], indN[2]], [indN[0], indN[1], indD[2]], error, mat_f2.reshape(
            Nel[0], n_quad[0], Nel[1], n_quad[1], Nel[2], n_quad[2],
        ), mat_f3.reshape(Nel[0], n_quad[0], Nel[1], n_quad[1], Nel[2], n_quad[2]), coeff2, coeff3, 2*metric_coeffs[1, 2].reshape(Nel[0], n_quad[0], Nel[1], n_quad[1], Nel[2], n_quad[2]),
    )

    # 1 * f3 * G^33 * |det(DF)| * f3
    ker.kernel_l2error(
        Nel, p, n_quad, wts[0], wts[1], wts[2], [0, 0, 1], [0, 0, 1], basisN[0], basisN[1], basisD[2], basisN[0], basisN[1], basisD[2], [indN[0], indN[1], indD[2]], [indN[0], indN[1], indD[2]], error, mat_f3.reshape(
            Nel[0], n_quad[0], Nel[1], n_quad[1], Nel[2], n_quad[2],
        ), mat_f3.reshape(Nel[0], n_quad[0], Nel[1], n_quad[1], Nel[2], n_quad[2]), coeff3, coeff3, 1*metric_coeffs[2, 2].reshape(Nel[0], n_quad[0], Nel[1], n_quad[1], Nel[2], n_quad[2]),
    )
...
def l2_error_V2(tensor_space_FEM, domain, fun, coeff):
    ...
    # 1 * f1 * G_11 / |det(DF)| * f1
    ker.kernel_l2error(
        Nel, p, n_quad, wts[0], wts[1], wts[2], [0, 1, 1], [0, 1, 1], basisN[0], basisD[1], basisD[2], basisN[0], basisD[1], basisD[2], [indN[0], indD[1], indD[2]], [indN[0], indD[1], indD[2]], error, mat_f1.reshape(
            Nel[0], n_quad[0], Nel[1], n_quad[1], Nel[2], n_quad[2],
        ), mat_f1.reshape(Nel[0], n_quad[0], Nel[1], n_quad[1], Nel[2], n_quad[2]), coeff1, coeff1, 1*metric_coeffs[0, 0].reshape(Nel[0], n_quad[0], Nel[1], n_quad[1], Nel[2], n_quad[2]),
    )
    ...
    # 2 * f1 * G_12 / |det(DF)| * f2
    ker.kernel_l2error(
        Nel, p, n_quad, wts[0], wts[1], wts[2], [0, 1, 1], [1, 0, 1], basisN[0], basisD[1], basisD[2], basisD[0], basisN[1], basisD[2], [indN[0], indD[1], indD[2]], [indD[0], indN[1], indD[2]], error, mat_f1.reshape(
            Nel[0], n_quad[0], Nel[1], n_quad[1], Nel[2], n_quad[2],
        ), mat_f2.reshape(Nel[0], n_quad[0], Nel[1], n_quad[1], Nel[2], n_quad[2]), coeff1, coeff2, 2*metric_coeffs[0, 1].reshape(Nel[0], n_quad[0], Nel[1], n_quad[1], Nel[2], n_quad[2]),
    )
    ...
    # 2 * f1 * G_13 / |det(DF)| * f3
    ker.kernel_l2error(
        Nel, p, n_quad, wts[0], wts[1], wts[2], [0, 1, 1], [1, 1, 0], basisN[0], basisD[1], basisD[2], basisD[0], basisD[1], basisN[2], [indN[0], indD[1], indD[2]], [indD[0], indD[1], indN[2]], error, mat_f1.reshape(
            Nel[0], n_quad[0], Nel[1], n_quad[1], Nel[2], n_quad[2],
        ), mat_f3.reshape(Nel[0], n_quad[0], Nel[1], n_quad[1], Nel[2], n_quad[2]), coeff1, coeff3, 2*metric_coeffs[0, 2].reshape(Nel[0], n_quad[0], Nel[1], n_quad[1], Nel[2], n_quad[2]),
    )
    ...
    # 1 * f2 * G_22 / |det(DF)| * f2
    ker.kernel_l2error(
        Nel, p, n_quad, wts[0], wts[1], wts[2], [1, 0, 1], [1, 0, 1], basisD[0], basisN[1], basisD[2], basisD[0], basisN[1], basisD[2], [indD[0], indN[1], indD[2]], [indD[0], indN[1], indD[2]], error, mat_f2.reshape(
            Nel[0], n_quad[0], Nel[1], n_quad[1], Nel[2], n_quad[2],
        ), mat_f2.reshape(Nel[0], n_quad[0], Nel[1], n_quad[1], Nel[2], n_quad[2]), coeff2, coeff2, 1*metric_coeffs[1, 1].reshape(Nel[0], n_quad[0], Nel[1], n_quad[1], Nel[2], n_quad[2]),
    )
    ...
    # 2 * f2 * G_23 / |det(DF)| * f3
    ker.kernel_l2error(
        Nel, p, n_quad, wts[0], wts[1], wts[2], [1, 0, 1], [1, 1, 0], basisD[0], basisN[1], basisD[2], basisD[0], basisD[1], basisN[2], [indD[0], indN[1], indD[2]], [indD[0], indD[1], indN[2]], error, mat_f2.reshape(
            Nel[0], n_quad[0], Nel[1], n_quad[1], Nel[2], n_quad[2],
        ), mat_f3.reshape(Nel[0], n_quad[0], Nel[1], n_quad[1], Nel[2], n_quad[2]), coeff2, coeff3, 2*metric_coeffs[1, 2].reshape(Nel[0], n_quad[0], Nel[1], n_quad[1], Nel[2], n_quad[2]),
    )
    ...
    # 1 * f3 * G_33 / |det(DF)| * f3
    ker.kernel_l2error(
        Nel, p, n_quad, wts[0], wts[1], wts[2], [1, 1, 0], [1, 1, 0], basisD[0], basisD[1], basisN[2], basisD[0], basisD[1], basisN[2], [indD[0], indD[1], indN[2]], [indD[0], indD[1], indN[2]], error, mat_f3.reshape(
            Nel[0], n_quad[0], Nel[1], n_quad[1], Nel[2], n_quad[2],
        ), mat_f3.reshape(Nel[0], n_quad[0], Nel[1], n_quad[1], Nel[2], n_quad[2]), coeff3, coeff3, 1*metric_coeffs[2, 2].reshape(Nel[0], n_quad[0], Nel[1], n_quad[1], Nel[2], n_quad[2]),
    )
...
def l2_error_V3(tensor_space_FEM, domain, fun, coeff):
    ...
    ker.kernel_l2error(
        Nel, p, n_quad, wts[0], wts[1], wts[2], [1, 1, 1], [1, 1, 1], basisD[0], basisD[1], basisD[2], basisD[0], basisD[1], basisD[2], indD[0], indD[1], indD[2], indD[0], indD[1], indD[2], error, mat_f.reshape(
            Nel[0], n_quad[0], Nel[1], n_quad[1], Nel[2], n_quad[2],
        ), mat_f.reshape(Nel[0], n_quad[0], Nel[1], n_quad[1], Nel[2], n_quad[2]), coeff, coeff, 1/det_df.reshape(Nel[0], n_quad[0], Nel[1], n_quad[1], Nel[2], n_quad[2]),
    )
