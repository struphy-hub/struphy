                                ...
                                for q1 in range(quad[0]):
                                    for q2 in range(quad[1]):
                                        for q3 in range(quad[2]):
                                            basisvalue = (
                                                bd1[index1 % Nel[0], lambda_index1, 0, q1]
                                                * bn2[index2 % Nel[1], lambda_index2, 0, q2]
                                                * bn3[index3 % Nel[2], lambda_index3, 0, q3]
                                                * wts1[index1 % Nel[0], q1]
                                                * wts2[index2 % Nel[1], q2]
                                                * wts3[index3 % Nel[2], q3]
                                            )
                            ...
                            for lambda_index3 in range(p[2] + 1):
                                ...
                                for q1 in range(quad[0]):
                                    for q2 in range(quad[1]):
                                        for q3 in range(quad[2]):
                                            basisvalue = (
                                                bn1[index1 % Nel[0], lambda_index1, 0, q1]
                                                * bd2[index2 % Nel[1], lambda_index2, 0, q2]
                                                * bn3[index3 % Nel[2], lambda_index3, 0, q3]
                                                * wts1[index1 % Nel[0], q1]
                                                * wts2[index2 % Nel[1], q2]
                                                * wts3[index3 % Nel[2], q3]
                                    ...
                                    for q2 in range(quad[1]):
                                        for q3 in range(quad[2]):
                                            basisvalue = (
                                                bn1[index1 % Nel[0], lambda_index1, 0, q1]
                                                * bn2[index2 % Nel[1], lambda_index2, 0, q2]
                                                * bd3[index3 % Nel[2], lambda_index3, 0, q3]
                                                * wts1[index1 % Nel[0], q1]
                                                * wts2[index2 % Nel[1], q2]
                                                * wts3[index3 % Nel[2], q3]
                                            )
