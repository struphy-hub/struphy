                    ...
                    for il1 in range(num_cell[0]):
                        ...
                        for il2 in range(num_cell[1]):
                            ...
                            for il3 in range(num_cell[2]):
                                ...
                                mat_f[i1, i2, i3, il1, il2, il3] = value_x * value_y * \
                                    value_z / (p_size[0]*p_size[1]*p_size[2]) / det_df
                        ...
                        for lambda_index2 in range(p[1]):
                            ...
                            for lambda_index3 in range(p[2]):
                                ...
                                for il1 in range(num_cell[0]):
                                    for il2 in range(num_cell[1]):
                                        for il3 in range(num_cell[2]):
                                            lambdas[final_1, final_2, final_3] += coeff_x[2*(p[0]-1) - 2 * lambda_index1 + il1] * coeff_y[
                                                2*(
                                                    p[1]-1
                                                ) - 2 * lambda_index2 + il2
                                            ] * coeff_z[2*(p[2]-1) - 2 * lambda_index3 + il3] * mat_f[i1, i2, i3, il1, il2, il3]
                    ...
                    for il1 in range(num_cell[0]):
                        ...
                        for il2 in range(num_cell[1]):
                            ...
                            for il3 in range(num_cell[2]):
                                ...
                                value_z = bsp.piecewise(p_shape[2], p_size[2], abs(eta3 - particle[2, ip]))
                                # here should devided by det_df = abs(linalg.det(df))
                                mat_f[i1, i2, i3, il1, il2, il3] = w * value_x * value_y * \
                                    value_z / (p_size[0]*p_size[1]*p_size[2]) / det_df
