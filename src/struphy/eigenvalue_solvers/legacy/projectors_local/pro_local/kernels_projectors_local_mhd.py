...
@types('int[:]', 'int[:]', 'int[:]', 'int[:,:]', 'int[:,:]', 'int[:,:]', 'int[:,:]', 'int[:,:]', 'int[:,:]', 'double[:,:]', 'double[:,:]', 'double[:,:]',
       'int[:]', 'int[:]', 'int[:]', 'double[:,:]', 'double[:,:]', 'double[:,:]', 'int[:,:]', 'int[:,:]', 'int[:,:]', 'double[:,:,:,:,:,:]', 'double[:,:,:]')
def kernel_pi0(
        n,
        n_int,
        n_nvbf,
...
# ========================================================
@types('int[:]', 'int', 'int[:]', 'int[:]', 'int[:,:]', 'int[:,:]', 'int[:,:]', 'int[:,:]', 'int[:,:]', 'int[:,:]', 'double[:,:]', 'double[:,:]', 'double[:,:]', 'int[:]',
       'int[:]', 'int[:]', 'double[:,:,:]', 'double[:,:]', 'double[:,:]', 'int[:,:]', 'int[:,:]', 'int[:,:]', 'double[:,:]', 'double[:,:,:,:,:,:]', 'double[:,:,:,:]')
def kernel_pi1_1(
        n,
        n_quad1,
        n_inthis,
                                ...
                                for kl2 in range(n_nvbf[1]):
                                    ...
                                    for kl3 in range(n_nvbf[2]):
                                        ...
                                        for q1 in range(n_quad1):
                                            f_int += wts1[x_his_ind1[i1, j1], q1] * bs1[x_his_ind1[i1, j1], q1, k1] * bs2[x_int_ind2[i2, j2],
                                                                                                                          k2] * bs3[x_int_ind3[i3, j3], k3] * mat_eq[x_his_ind1[i1, j1], q1, x_int_ind2[i2, j2], x_int_ind3[i3, j3]]
                                ...
                                for kl2 in range(n_nvbf[1]):
                                    ...
                                    for kl3 in range(n_nvbf[2]):
                                        ...
                                        for q2 in range(n_quad2):
                                            f_int += wts2[x_his_ind2[i2, j2], q2] * bs1[x_int_ind1[i1, j1], k1] * bs2[x_his_ind2[i2, j2], q2,
                                                                                                                      k2] * bs3[x_int_ind3[i3, j3], k3] * mat_eq[x_int_ind1[i1, j1], x_his_ind2[i2, j2], q2, x_int_ind3[i3, j3]]
                                ...
                                for kl2 in range(n_nvbf[1]):
                                    ...
                                    for kl3 in range(n_nvbf[2]):
                                        ...
                                        for q3 in range(n_quad3):
                                            f_int += wts3[x_his_ind3[i3, j3], q3] * bs1[x_int_ind1[i1, j1], k1] * bs2[x_int_ind2[i2, j2],
                                                                                                                      k2] * bs3[x_his_ind3[i3, j3], q3, k3] * mat_eq[x_int_ind1[i1, j1], x_int_ind2[i2, j2], x_his_ind3[i3, j3], q3]
                                    ...
                                    for kl3 in range(n_nvbf[2]):
                                        ...
                                        for q2 in range(n_quad[0]):
                                            for q3 in range(n_quad[1]):
                                                ...
                                                f_int += wvol * bs1[x_int_ind1[i1, j1], k1] * bs2[x_his_ind2[i2, j2], q2, k2] * bs3[x_his_ind3[i3, j3],
                                                                                                                                    q3, k3] * mat_eq[x_int_ind1[i1, j1], x_his_ind2[i2, j2], q2, x_his_ind3[i3, j3], q3]
                                    ...
                                    for kl3 in range(n_nvbf[2]):
                                        ...
                                        for q1 in range(n_quad[0]):
                                            for q3 in range(n_quad[1]):
                                                ...
                                                f_int += wvol * bs1[x_his_ind1[i1, j1], q1, k1] * bs2[x_int_ind2[i2, j2], k2] * bs3[x_his_ind3[i3, j3],
                                                                                                                                    q3, k3] * mat_eq[x_his_ind1[i1, j1], q1, x_int_ind2[i2, j2], x_his_ind3[i3, j3], q3]
                                    ...
                                    for kl3 in range(n_nvbf[2]):
                                        ...
                                        for q1 in range(n_quad[0]):
                                            for q2 in range(n_quad[1]):
                                                ...
                                                f_int += wvol * bs1[x_his_ind1[i1, j1],
                                                                    q1, k1] * bs2[x_his_ind2[i2, j2],
                                                                                  q2, k2] * bs3[x_int_ind3[i3, j3],
                                                                                                k3] * mat_eq[x_his_ind1[i1, j1],
                                                                                                             q1, x_his_ind2[i2, j2],
                                                                                                             q2, x_int_ind3[i3, j3]]
                                        ...
                                        for q1 in range(n_quad[0]):
                                            for q2 in range(n_quad[1]):
                                                for q3 in range(n_quad[2]):
                                                    ...
                                                    f_int += wvol * bs1[x_his_ind1[i1, j1], q1, k1] * bs2[x_his_ind2[i2, j2], q2, k2] * bs3[x_his_ind3[i3, j3],
                                                                                                                                            q3, k3] * mat_eq[x_his_ind1[i1, j1], q1, x_his_ind2[i2, j2], q2, x_his_ind3[i3, j3], q3]
