                ...
                for il1 in range(n_pts1):
                    for il2 in range(n_pts2):
                        for il3 in range(n_pts3):
                            ...
                            lambdas[i1, i2, i3] += coeff_i1[coeffi_ind1[i1],
                                                            il1] * coeff_i2[coeffi_ind2[i2],
                                                                            il2] * coeff_i3[coeffi_ind3[i3],
                                                                                            il3] * mat_f[x_int_ind1[i1, il1],
                                                                                                         x_int_ind2[i2, il2],
                                                                                                         x_int_ind3[i3, il3]]


# ==========================================================================================
@types('int[:]', 'int[:]', 'int[:]', 'double[:,:]', 'double[:,:]', 'double[:,:]', 'int[:]', 'int[:]',
...
# ==========================================================================================
@types('int[:]', 'int[:]', 'int[:]', 'double[:,:]', 'double[:,:]', 'double[:,:]', 'int[:]', 'int[:]', 'int[:]',
...
# ==========================================================================================
@types('int[:]', 'int[:]', 'int[:]', 'double[:,:]', 'double[:,:]', 'double[:,:]', 'int[:]', 'int[:]', 'int[:]', 'int[:,:]',
