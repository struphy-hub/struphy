                ...
                for il1 in range(n_pts1):
                    for il2 in range(n_pts2):
                        for il3 in range(n_pts3):
                            ...
                            lambdas[i1, i2, i3] += coeff_i1[coeffi_ind1[i1], il1] * coeff_i2[coeffi_ind2[i2], il2] * \
                                coeff_i3[coeffi_ind3[i3], il3] * mat_f[
                                    x_int_ind1[i1, il1],
                                    x_int_ind2[i2, il2], x_int_ind3[i3, il3],
                            ]
                    ...
                    for il2 in range(n_pts2):
                        for il3 in range(n_pts3):
                            ...
                            for q1 in range(nq[0]):
                                f_int += wts1[x_his_ind1[i1, il1], q1] * \
                                    mat_f[x_his_ind1[i1, il1], q1, x_int_ind2[i2, il2], x_int_ind3[i3, il3]]

                            lambdas[i1, i2, i3] += coeff_h1[coeffh_ind1[i1], il1] * \
                                coeff_i2[coeffi_ind2[i2], il2] * coeff_i3[coeffi_ind3[i3], il3] * f_int
                    ...
                    for il2 in range(n_his2):
                        for il3 in range(n_pts3):
                            ...
                            for q2 in range(nq[1]):
                                f_int += wts2[x_his_ind2[i2, il2], q2] * \
                                    mat_f[x_int_ind1[i1, il1], x_his_ind2[i2, il2], q2, x_int_ind3[i3, il3]]

                            lambdas[i1, i2, i3] += coeff_i1[coeffi_ind1[i1], il1] * \
                                coeff_h2[coeffh_ind2[i2], il2] * coeff_i3[coeffi_ind3[i3], il3] * f_int
                    ...
                    for il2 in range(n_pts2):
                        for il3 in range(n_his3):
                            ...
                            for q3 in range(nq[2]):
                                f_int += wts3[x_his_ind3[i3, il3], q3] * \
                                    mat_f[x_int_ind1[i1, il1], x_int_ind2[i2, il2], x_his_ind3[i3, il3], q3]

                            lambdas[i1, i2, i3] += coeff_i1[coeffi_ind1[i1], il1] * \
                                coeff_i2[coeffi_ind2[i2], il2] * coeff_h3[coeffh_ind3[i3], il3] * f_int
                ...
                for il1 in range(n_pts1):
                    for il2 in range(n_his2):
                        for il3 in range(n_his3):
                            ...
                            lambdas[i1, i2, i3] += coeff_i1[coeffi_ind1[i1], il1] * \
                                coeff_h2[coeffh_ind2[i2], il2] * coeff_h3[coeffh_ind3[i3], il3] * f_int
                    ...
                    for il2 in range(n_his2):
                        for il3 in range(n_his3):
                            ...
                            for q1 in range(nq[0]):
                                for q2 in range(nq[1]):
                                    for q3 in range(nq[2]):
                                        wvol = wts1[x_his_ind1[i1, il1], q1] * \
                                            wts2[x_his_ind2[i2, il2], q2] * wts3[x_his_ind3[i3, il3], q3]
                                        f_int += wvol * mat_f[
                                            x_his_ind1[i1, il1], q1,
                                            x_his_ind2[i2, il2], q2, x_his_ind3[i3, il3], q3,
                                        ]
