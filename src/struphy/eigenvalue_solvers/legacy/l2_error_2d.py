    ...
    if method == 'standard':
        ...
        ker.kernel_l2error(
            Nel, p, n_quad, wts[0], wts[1], [
                0, 0], [
                0, 0], basisN[0], basisN[1], basisN[0], basisN[1], indN[0], indN[1], indN[0], indN[1], error, f0.reshape(
                Nel[0], n_quad[0], Nel[1], n_quad[1]), f0.reshape(
                    Nel[0], n_quad[0], Nel[1], n_quad[1]), c0, c0, det_df.reshape(
