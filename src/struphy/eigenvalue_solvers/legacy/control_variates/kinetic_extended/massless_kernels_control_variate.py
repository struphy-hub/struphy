                ...
                for q1 in range(nq1):
                    for q2 in range(nq2):
                        for q3 in range(nq3):
                            ...
                            weight0[ie1, ie2, ie3, q1, q2, q3] = (
                                -uvalue[ie1, ie2, ie3, q1, q2, q3]
                                * (
                                    b1value[ie1, ie2, ie3, q1, q2, q3] * generate_weight3[0]
                                    + b2value[ie1, ie2, ie3, q1, q2, q3] * generate_weight3[1]
...
def uvfinal(
    ...
    temp_final_3[:, :, :] = 0.0
    # -- removed omp: #$ omp parallel
    # -- removed omp: #$ omp do reduction ( + : temp_final_0) private (ie1, ie2, ie3, q1, q2, q3, il1, il2, il3, value)
    for ie1 in range(nel1):
        for ie2 in range(nel2):
            for ie3 in range(nel3):
                for il1 in range(p1 + 1):
