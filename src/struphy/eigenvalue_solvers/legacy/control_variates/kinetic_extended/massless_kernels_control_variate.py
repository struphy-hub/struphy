                            ...
                            for il1 in range(p1 + 1):
                                for il2 in range(p2 + 1):
                                    for il3 in range(p3 + 1):
                                        value += bn1[ie1, il1, 0, q1] * bn2[ie2, il2, 0, q2] * bn3[
                                            ie3,
                                            il3, 0, q3,
                                        ] * u[idnx[ie1, il1], idny[ie2, il2], idnz[ie3, il3]]
                ...
                for q1 in range(nq1):
                    for q2 in range(nq2):
                        for q3 in range(nq3):
                            ...
                            weight1[ie1, ie2, ie3, q1, q2, q3] = detdet * uvalue[ie1, ie2, ie3, q1, q2, q3] * \
                                generate_weight3[0] * wts1[ie1, q1] * wts2[ie2, q2] * wts3[ie3, q3]
                            weight2[ie1, ie2, ie3, q1, q2, q3] = detdet * uvalue[ie1, ie2, ie3, q1, q2, q3] * \
                                generate_weight3[1] * wts1[ie1, q1] * wts2[ie2, q2] * wts3[ie3, q3]
                            weight3[ie1, ie2, ie3, q1, q2, q3] = detdet * uvalue[ie1, ie2, ie3, q1, q2, q3] * \
                                generate_weight3[2] * wts1[ie1, q1] * wts2[ie2, q2] * wts3[ie3, q3]
                            weight0[ie1, ie2, ie3, q1, q2, q3] = - uvalue[ie1, ie2, ie3, q1, q2, q3] * (
                                b1value[ie1, ie2, ie3, q1, q2, q3]*generate_weight3[0] + b2value[
                                    ie1, ie2,
                                    ie3, q1, q2, q3,
                                ]*generate_weight3[1] + b3value[ie1, ie2, ie3, q1, q2, q3]*generate_weight3[2]
                            ) * detdet * wts1[ie1, q1] * wts2[ie2, q2] * wts3[ie3, q3]
                    ...
                    for il2 in range(p2 + 1):
                        for il3 in range(p3 + 1):
                            ...
                            for q1 in range(nq1):
                                for q2 in range(nq2):
                                    for q3 in range(nq3):
                                        value += weight0[ie1, ie2, ie3, q1, q2, q3] * bn1[
                                            ie1, il1,
                                            0, q1,
    ...
    for ip in range(Np_loc):
        ...
        U_value = exp(
            -eva.evaluation_kernel(
                pn1, pn2, pn3, bn1, bn2, bn3,
                span1, span2, span3, NbaseN[0], NbaseN[1], NbaseN[2], u,
            ),
        )
