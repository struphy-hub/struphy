...
# ==========================================================================================
@types('int[:,:]', 'int[:,:]', 'int[:,:]', 'int', 'int', 'int', 'int', 'int', 'int', 'int', 'int', 'int',
                            ...
                            weight0[ie1,
                                    ...
                                    q3] = - uvalue[ie1,
                                                   ...
                                                   q3] * (b1value[ie1,
                                                                  ...
                                                                  q1,
                                                                  q2,
                                                                  q3]*generate_weight3[0] + b2value[ie1,
                                                                                                    ie2,
                                                                                                    ie3,
                                                                                                    q1,
                                                                                                    q2,
                                                                                                    q3]*generate_weight3[1] + b3value[ie1,
                                                                                                                                      ie2,
                                                                                                                                      ie3,
                                                                                                                                      q1,
                                                                                                                                      q2,
                                                                                                                                      q3]*generate_weight3[2]) * detdet * wts1[ie1,
                                                                                                                                                                               q1] * wts2[ie2,
                                                                                                                                                                                          q2] * wts3[ie3,
                                                                                                                                                                                                     q3]
...
@types('int[:,:]',
       ...
       'double[:,:,:,:]',
       'double[:,:,:,:]')
def uvfinal(idnx, idny, idnz, iddx, iddy, iddz, nel1, nel2, nel3, nq1, nq2, nq3, p1, p2, p3, d1, d2, d3, weight1, weight2,
            weight3, weight0, temp_final_0, temp_final_1, temp_final_2, temp_final_3, bn1, bn2, bn3, bd1, bd2, bd3):
