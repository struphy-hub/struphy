                ...
                for il1 in range(n_quad[0]):
                    for il2 in range(n_quad[1]):
                        for il3 in range(n_quad[2]):
                            # ========= physical domain =============
                            x1 = map3d.f(
                                pts1[ie1, il1], pts2[ie2, il2], pts3[ie3, il3], 1,
                                kind_map, params_map, tf1, tf2, tf3, pf, nbasef, cx, cy, cz,
                            )
                            x2 = map3d.f(
                                pts1[ie1, il1], pts2[ie2, il2], pts3[ie3, il3], 2,
                                kind_map, params_map, tf1, tf2, tf3, pf, nbasef, cx, cy, cz,
                            )
                            x3 = map3d.f(
                                pts1[ie1, il1], pts2[ie2, il2], pts3[ie3, il3], 3,
                                kind_map, params_map, tf1, tf2, tf3, pf, nbasef, cx, cy, cz,
                            )
