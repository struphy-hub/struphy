    ...
    for ie1 in range(Nel[0]):
        for ie2 in range(Nel[1]):
            for ie3 in range(Nel[2]):
                # ========= physical domain =============
                x1 = mapping3d.f(
                    ie1/Nel[0], ie2/Nel[2], ie3/Nel[2], 1, kind_map,
                    params_map, tf1, tf2, tf3, pf, nbasef, cx, cy, cz,
                )
                x2 = mapping3d.f(
                    ie1/Nel[0], ie2/Nel[2], ie3/Nel[2], 2, kind_map,
                    params_map, tf1, tf2, tf3, pf, nbasef, cx, cy, cz,
                )
                x3 = mapping3d.f(
                    ie1/Nel[0], ie2/Nel[2], ie3/Nel[2], 3, kind_map,
                    params_map, tf1, tf2, tf3, pf, nbasef, cx, cy, cz,
                )
                            ...
                            for il1 in range(d1 + 1):
                                for il2 in range(p2 + 1):
                                    for il3 in range(p3 + 1):
                                        value += bd1[ie1, il1, 0, q1] * bn2[ie2, il2, 0, q2] * bn3[
                                            ie3,
                                            il3, 0, q3,
                        ...
                        for q3 in range(nq3):
                            ...
                            for il1 in range(p1 + 1):
                                for il2 in range(d2 + 1):
                                    for il3 in range(p3 + 1):
                                        value += bn1[ie1, il1, 0, q1] * bd2[ie2, il2, 0, q2] * bn3[
                                            ie3,
                                            il3, 0, q3,
                            ...
                            for il1 in range(p1 + 1):
                                for il2 in range(p2 + 1):
                                    for il3 in range(d3 + 1):
                                        value += bn1[ie1, il1, 0, q1] * bn2[ie2, il2, 0, q2] * bd3[
                                            ie3,
                                            il3, 0, q3,
                    ...
                    for il2 in range(d2 + 1):
                        for il3 in range(d3 + 1):
                            ...
                            for q1 in range(nq1):
                                for q2 in range(nq2):
                                    for q3 in range(nq3):
                                        value += b1value[ie1, ie2, ie3, q1, q2, q3] * bn1[
                                            ie1, il1,
                                            0, q1,
                                        ] * bd2[ie2, il2, 0, q2] * bd3[ie3, il3, 0, q3]
                    ...
                    for il2 in range(p2 + 1):
                        for il3 in range(d3 + 1):
                            ...
                            for q1 in range(nq1):
                                for q2 in range(nq2):
                                    for q3 in range(nq3):
                                        value += b2value[ie1, ie2, ie3, q1, q2, q3] * bd1[
                                            ie1, il1,
                                            0, q1,
                                        ] * bn2[ie2, il2, 0, q2] * bd3[ie3, il3, 0, q3]
                    ...
                    for il2 in range(d2 + 1):
                        for il3 in range(p3 + 1):
                            ...
                            for q1 in range(nq1):
                                for q2 in range(nq2):
                                    for q3 in range(nq3):
                                        value += b3value[ie1, ie2, ie3, q1, q2, q3] * bd1[
                                            ie1, il1,
                                            0, q1,
                                        ] * bd2[ie2, il2, 0, q2] * bn3[ie3, il3, 0, q3]
...
# =============================================================================================================================================================================
@types('double', 'double[:,:]', 'double[:]', 'double[:,:,:]', 'double[:,:,:]', 'double[:,:,:]', 'double[:,:,:]', 'int', 'int[:]', 'int[:]', 'int[:]', 'int[:]', 'double[:]', 'double[:]', 'double[:]', 'double[:,:]', 'int', 'double[:]', 'double[:]', 'double[:]', 'double[:]', 'int[:]', 'int[:]', 'int[:]', 'double[:,:,:]', 'double[:,:,:]', 'double[:,:,:]')
