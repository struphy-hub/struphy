                            ...
                            for il1 in range(d1 + 1):
                                for il2 in range(p2 + 1):
                                    for il3 in range(p3 + 1):
                                        value += bd1[ie1, il1, 0, q1] * bn2[ie2, il2, 0, q2] * bn3[ie3, il3, 0,
                                                                                                   q3] * b1[D_index_x[ie1, il1], N_index_y[ie2, il2], N_index_z[ie3, il3]]
                        ...
                        for q3 in range(nq3):
                            ...
                            for il1 in range(p1 + 1):
                                for il2 in range(d2 + 1):
                                    for il3 in range(p3 + 1):
                                        value += bn1[ie1, il1, 0, q1] * bd2[ie2, il2, 0, q2] * bn3[ie3, il3, 0,
                                                                                                   q3] * b2[N_index_x[ie1, il1], D_index_y[ie2, il2], N_index_z[ie3, il3]]
                            ...
                            for il1 in range(p1 + 1):
                                for il2 in range(p2 + 1):
                                    for il3 in range(d3 + 1):
                                        value += bn1[ie1, il1, 0, q1] * bn2[ie2, il2, 0, q2] * bd3[ie3, il3, 0,
                                                                                                   q3] * b3[N_index_x[ie1, il1], N_index_y[ie2, il2], D_index_z[ie3, il3]]
...
@types('int[:,:]',
       ...
       'double[:,:,:]',
       'double[:,:,:]')
def right_hand2(N_index_x, N_index_y, N_index_z, D_index_x, D_index_y, D_index_z, nel1, nel2, nel3, nq1, nq2, nq3, p1, p2, p3,
                d1, d2, d3, bn1, bn2, bn3, bd1, bd2, bd3, right_1, right_2, right_3, temp_vector_1, temp_vector_2, temp_vector_3):
                    ...
                    for q2 in range(nq2):
                        for q3 in range(nq3):
                            ...
                            for il1 in range(p1 + 1):
                                for il2 in range(d2 + 1):
                                    for il3 in range(d3 + 1):
                                        value += bn1[ie1, il1, 0, q1] * bd2[ie2, il2, 0, q2] * bd3[ie3, il3, 0,
                                                                                                   q3] * temp_vector_1[N_index_x[ie1, il1], D_index_y[ie2, il2], D_index_z[ie3, il3]]
                    ...
                    for q2 in range(nq2):
                        for q3 in range(nq3):
                            ...
                            for il1 in range(d1 + 1):
                                for il2 in range(p2 + 1):
                                    for il3 in range(d3 + 1):
                                        value += bd1[ie1, il1, 0, q1] * bn2[ie2, il2, 0, q2] * bd3[ie3, il3, 0,
                                                                                                   q3] * temp_vector_2[D_index_x[ie1, il1], N_index_y[ie2, il2], D_index_z[ie3, il3]]
                    ...
                    for q2 in range(nq2):
                        for q3 in range(nq3):
                            ...
                            for il1 in range(d1 + 1):
                                for il2 in range(d2 + 1):
                                    for il3 in range(p3 + 1):
                                        value += bd1[ie1, il1, 0, q1] * bd2[ie2, il2, 0, q2] * bn3[ie3, il3, 0,
                                                                                                   q3] * temp_vector_3[D_index_x[ie1, il1], D_index_y[ie2, il2], N_index_z[ie3, il3]]
...
@types('int[:,:]',
       ...
       'double[:,:,:]',
       'double[:,:,:]')
def right_hand1(N_index_x, N_index_y, N_index_z, D_index_x, D_index_y, D_index_z, nel1, nel2, nel3, nq1, nq2, nq3, p1, p2, p3,
                d1, d2, d3, bn1, bn2, bn3, bd1, bd2, bd3, right_1, right_2, right_3, temp_vector_1, temp_vector_2, temp_vector_3):
                        ...
                        for q3 in range(nq3):
                            ...
                            for il1 in range(d1 + 1):
                                for il2 in range(p2 + 1):
                                    for il3 in range(p3 + 1):
                                        value += bd1[ie1, il1, 0, q1] * bn2[ie2, il2, 0, q2] * bn3[ie3, il3, 0,
                                                                                                   q3] * temp_vector_1[D_index_x[ie1, il1], N_index_y[ie2, il2], N_index_z[ie3, il3]]
                        ...
                        for q3 in range(nq3):
                            ...
                            for il1 in range(p1 + 1):
                                for il2 in range(d2 + 1):
                                    for il3 in range(p3 + 1):
                                        value += bn1[ie1, il1, 0, q1] * bd2[ie2, il2, 0, q2] * bn3[ie3, il3, 0,
                                                                                                   q3] * temp_vector_2[N_index_x[ie1, il1], D_index_y[ie2, il2], N_index_z[ie3, il3]]
                        ...
                        for q3 in range(nq3):
                            ...
                            for il1 in range(p1 + 1):
                                for il2 in range(p2 + 1):
                                    for il3 in range(d3 + 1):
                                        value += bn1[ie1, il1, 0, q1] * bn2[ie2, il2, 0, q2] * bd3[ie3, il3, 0,
                                                                                                   q3] * temp_vector_3[N_index_x[ie1, il1], N_index_y[ie2, il2], D_index_z[ie3, il3]]
                ...
                for q1 in range(nq1):
                    for q2 in range(nq2):
                        for q3 in range(nq3):
                            ...
                            generate_weight1[0] = -(b2value[ie1, ie2, ie3, q1, q2, q3] * right_3[ie1, ie2, ie3, q1, q2,
                                                    q3] - b3value[ie1, ie2, ie3, q1, q2, q3] * right_2[ie1, ie2, ie3, q1, q2, q3])
                            generate_weight1[1] = -(b3value[ie1, ie2, ie3, q1, q2, q3] * right_1[ie1, ie2, ie3, q1, q2,
                                                    q3] - b1value[ie1, ie2, ie3, q1, q2, q3] * right_3[ie1, ie2, ie3, q1, q2, q3])
                            generate_weight1[2] = -(b1value[ie1, ie2, ie3, q1, q2, q3] * right_2[ie1, ie2, ie3, q1, q2,
                                                    q3] - b2value[ie1, ie2, ie3, q1, q2, q3] * right_1[ie1, ie2, ie3, q1, q2, q3])
                            linalg.matrix_vector(dft, generate_weight1, generate_weight3)
                            # -(b2value[ie1,ie2,ie3,q1,q2,q3] * right_3[ie1,ie2,ie3,q1,q2,q3] - b3value[ie1,ie2,ie3,q1,q2,q3] * right_2[ie1,ie2,ie3,q1,q2,q3])
                            weight1[ie1, ie2, ie3, q1, q2, q3] = generate_weight3[0]
                            # -(b3value[ie1,ie2,ie3,q1,q2,q3] * right_1[ie1,ie2,ie3,q1,q2,q3] - b1value[ie1,ie2,ie3,q1,q2,q3] * right_3[ie1,ie2,ie3,q1,q2,q3])
                            weight2[ie1, ie2, ie3, q1, q2, q3] = generate_weight3[1]
                            # -(b1value[ie1,ie2,ie3,q1,q2,q3] * right_2[ie1,ie2,ie3,q1,q2,q3] - b2value[ie1,ie2,ie3,q1,q2,q3] * right_1[ie1,ie2,ie3,q1,q2,q3])
                            weight3[ie1, ie2, ie3, q1, q2, q3] = generate_weight3[2]
    # $ omp end do
    # $ omp end parallel
...
@types('int[:,:]',
       ...
       'double[:,:,:,:]',
       'double[:,:,:,:]')
def final_left(N_index_x, N_index_y, N_index_z, D_index_x, D_index_y, D_index_z, nel1, nel2, nel3, nq1, nq2, nq3, p1, p2, p3,
               d1, d2, d3, weight1, weight2, weight3, temp_final_1, temp_final_2, temp_final_3, bn1, bn2, bn3, bd1, bd2, bd3):
    temp_final_1[:, :, :] = 0.0
    temp_final_2[:, :, :] = 0.0
    temp_final_3[:, :, :] = 0.0
    # $ omp parallel
...
@types('int[:,:]',
       ...
       'double[:,:,:,:]',
       'double[:,:,:,:]')
def final_right(N_index_x, N_index_y, N_index_z, D_index_x, D_index_y, D_index_z, nel1, nel2, nel3, nq1, nq2, nq3, p1, p2, p3,
                d1, d2, d3, weight1, weight2, weight3, temp_final_1, temp_final_2, temp_final_3, bn1, bn2, bn3, bd1, bd2, bd3):
    temp_final_1[:, :, :] = 0.0
    temp_final_2[:, :, :] = 0.0
    temp_final_3[:, :, :] = 0.0
