                    ...
                    for q2 in range(nq2):
                        for q3 in range(nq3):
                            ...
                            generate_weight1[0] = b1value[ie1, ie2, ie3, q1, q2, q3] * \
                                wts1[ie1, q1] * wts2[ie2, q2] * wts3[ie3, q3] * detdet
                    ...
                    for q2 in range(nq2):
                        for q3 in range(nq3):
                            ...
                            for il1 in range(p1 + 1):
                                for il2 in range(d2 + 1):
                                    for il3 in range(d3 + 1):
                                        value += bn1[ie1, il1, 0, q1] * bd2[ie2, il2, 0, q2] * bd3[ie3, il3, 0, q3] * \
                                            temp_vector_1[N_index_x[ie1, il1], D_index_y[ie2, il2], D_index_z[ie3, il3]]
                    ...
                    for q2 in range(nq2):
                        for q3 in range(nq3):
                            ...
                            for il1 in range(d1 + 1):
                                for il2 in range(p2 + 1):
                                    for il3 in range(d3 + 1):
                                        value += bd1[ie1, il1, 0, q1] * bn2[ie2, il2, 0, q2] * bd3[ie3, il3, 0, q3] * \
                                            temp_vector_2[D_index_x[ie1, il1], N_index_y[ie2, il2], D_index_z[ie3, il3]]
                    ...
                    for q2 in range(nq2):
                        for q3 in range(nq3):
                            ...
                            for il1 in range(d1 + 1):
                                for il2 in range(d2 + 1):
                                    for il3 in range(p3 + 1):
                                        value += bd1[ie1, il1, 0, q1] * bd2[ie2, il2, 0, q2] * bn3[ie3, il3, 0, q3] * \
                                            temp_vector_3[D_index_x[ie1, il1], D_index_y[ie2, il2], N_index_z[ie3, il3]]
                    ...
                    for q2 in range(nq2):
                        for q3 in range(nq3):
                            ...
                            for il1 in range(d1 + 1):
                                for il2 in range(p2 + 1):
                                    for il3 in range(p3 + 1):
                                        value += bd1[ie1, il1, 0, q1] * bn2[ie2, il2, 0, q2] * bn3[ie3, il3, 0, q3] * \
                                            temp_vector_1[D_index_x[ie1, il1], N_index_y[ie2, il2], N_index_z[ie3, il3]]
                    ...
                    for q2 in range(nq2):
                        for q3 in range(nq3):
                            ...
                            for il1 in range(p1 + 1):
                                for il2 in range(d2 + 1):
                                    for il3 in range(p3 + 1):
                                        value += bn1[ie1, il1, 0, q1] * bd2[ie2, il2, 0, q2] * bn3[ie3, il3, 0, q3] * \
                                            temp_vector_2[N_index_x[ie1, il1], D_index_y[ie2, il2], N_index_z[ie3, il3]]
                    ...
                    for q2 in range(nq2):
                        for q3 in range(nq3):
                            ...
                            for il1 in range(p1 + 1):
                                for il2 in range(p2 + 1):
                                    for il3 in range(d3 + 1):
                                        value += bn1[ie1, il1, 0, q1] * bn2[ie2, il2, 0, q2] * bd3[ie3, il3, 0, q3] * \
                                            temp_vector_3[N_index_x[ie1, il1], N_index_y[ie2, il2], D_index_z[ie3, il3]]
                ...
                for q1 in range(nq1):
                    for q2 in range(nq2):
                        for q3 in range(nq3):
                            ...
                            linalg.matrix_vector(dft, generate_weight1, generate_weight3)
                            weight1[ie1, ie2, ie3, q1, q2, q3] = b2value[ie1, ie2, ie3, q1, q2, q3] * \
                                generate_weight3[2] - b3value[ie1, ie2, ie3, q1, q2, q3] * generate_weight3[1]
                            weight2[ie1, ie2, ie3, q1, q2, q3] = b3value[ie1, ie2, ie3, q1, q2, q3] * \
                                generate_weight3[0] - b1value[ie1, ie2, ie3, q1, q2, q3] * generate_weight3[2]
                            weight3[ie1, ie2, ie3, q1, q2, q3] = b1value[ie1, ie2, ie3, q1, q2, q3] * \
                                generate_weight3[1] - b2value[ie1, ie2, ie3, q1, q2, q3] * generate_weight3[0]
    # $ omp end do
    # $ omp end parallel
                    ...
                    for il2 in range(d2 + 1):
                        for il3 in range(d3 + 1):
                            ...
                            for q1 in range(nq1):
                                for q2 in range(nq2):
                                    for q3 in range(nq3):
                                        value += weight1[ie1, ie2, ie3, q1, q2, q3] * bn1[
                                            ie1, il1,
                                            0, q1,
                    ...
                    for il2 in range(p2 + 1):
                        for il3 in range(d3 + 1):
                            ...
                            for q1 in range(nq1):
                                for q2 in range(nq2):
                                    for q3 in range(nq3):
                                        value += weight2[ie1, ie2, ie3, q1, q2, q3] * bd1[
                                            ie1, il1,
                                            0, q1,
                    ...
                    for il2 in range(d2 + 1):
                        for il3 in range(p3 + 1):
                            ...
                            for q1 in range(nq1):
                                for q2 in range(nq2):
                                    for q3 in range(nq3):
                                        value += weight3[ie1, ie2, ie3, q1, q2, q3] * bd1[
                                            ie1, il1,
                                            0, q1,
                    ...
                    for il2 in range(p2 + 1):
                        for il3 in range(p3 + 1):
                            ...
                            for q1 in range(nq1):
                                for q2 in range(nq2):
                                    for q3 in range(nq3):
                                        value += weight1[ie1, ie2, ie3, q1, q2, q3] * bd1[
                                            ie1, il1,
                                            0, q1,
                                        ] * bn2[ie2, il2, 0, q2] * bn3[ie3, il3, 0, q3]
                    ...
                    for il2 in range(d2 + 1):
                        for il3 in range(p3 + 1):
                            ...
                            for q1 in range(nq1):
                                for q2 in range(nq2):
                                    for q3 in range(nq3):
                                        value += weight2[ie1, ie2, ie3, q1, q2, q3] * bn1[
                                            ie1, il1,
                                            0, q1,
                                        ] * bd2[ie2, il2, 0, q2] * bn3[ie3, il3, 0, q3]
                    ...
                    for il2 in range(p2 + 1):
                        for il3 in range(d3 + 1):
                            ...
                            for q1 in range(nq1):
                                for q2 in range(nq2):
                                    for q3 in range(nq3):
                                        value += weight3[ie1, ie2, ie3, q1, q2, q3] * bn1[
                                            ie1, il1,
                                            0, q1,
                                        ] * bn2[ie2, il2, 0, q2] * bd3[ie3, il3, 0, q3]
