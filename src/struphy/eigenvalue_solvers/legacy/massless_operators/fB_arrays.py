...
TENSOR_SPACE_FEM : tensor_spline_space-tensor product B-spline space
    ...
    def __init__(self, TENSOR_SPACE_FEM, DOMAIN, control, mpi_comm):
        ...
        self.oneform_temp_long     = np.empty(
            TENSOR_SPACE_FEM.Ntot_1form[0]+TENSOR_SPACE_FEM.Ntot_1form[1]+TENSOR_SPACE_FEM.Ntot_1form[2], dtype=float,
        )
        ...
        self.twoform_temp_long     = np.empty(
            TENSOR_SPACE_FEM.Ntot_2form[0]+TENSOR_SPACE_FEM.Ntot_2form[1]+TENSOR_SPACE_FEM.Ntot_2form[2], dtype=float,
        )
        ...
        self.LO_inv = np.empty(
            (
                self.Nel[0], self.Nel[1], self.Nel[2], TENSOR_SPACE_FEM.n_quad[0],
                TENSOR_SPACE_FEM.n_quad[1], TENSOR_SPACE_FEM.n_quad[2],
            ), dtype=float,
        )
