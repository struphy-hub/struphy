...
@types('int[:,:]',
       ...
       'double[:,:,:]',
       'double[:,:,:]')
def bvalue(idnx, idny, idnz, iddx, iddy, iddz, nel1, nel2, nel3, nq1, nq2, nq3, p1, p2, p3, d1, d2, d3, b1, b2, b3,
           bn1, bn2, bn3, bd1, bd2, bd3, b1value, b2value, b3value, temp_vector_1, temp_vector_2, temp_vector_3):
                ...
                for q1 in range(nq1):
                    for q2 in range(nq2):
                        for q3 in range(nq3):
                            ...
                            weight1[ie1, ie2, ie3, q1, q2, q3] = temp * (generate_weight3[1] * right_3[ie1, ie2, ie3, q1, q2,
                                                                         q3] - generate_weight3[2] * right_2[ie1, ie2, ie3, q1, q2, q3])
                            weight2[ie1, ie2, ie3, q1, q2, q3] = temp * (generate_weight3[2] * right_1[ie1, ie2, ie3, q1, q2,
                                                                         q3] - generate_weight3[0] * right_3[ie1, ie2, ie3, q1, q2, q3])
                            weight3[ie1, ie2, ie3, q1, q2, q3] = temp * (generate_weight3[0] * right_2[ie1, ie2, ie3, q1, q2,
                                                                         q3] - generate_weight3[1] * right_1[ie1, ie2, ie3, q1, q2, q3])
