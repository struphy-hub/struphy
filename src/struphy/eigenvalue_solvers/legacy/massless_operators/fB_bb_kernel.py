...
def weight(
    nel1, nel2, nel3, nq1, nq2, nq3, b1value, b2value, b3value, right_1, right_2, right_3, weight1, weight2, weight3
):
    # -- removed omp: #$ omp parallel
...
def right_bwvalue(
    ...
    # -- removed omp: #$ omp parallel
    # -- removed omp: #$ omp do private (ie1, ie2, ie3, q1, q2, q3, dft, generate_weight1,  generate_weight3, temp)
    for ie1 in range(nel1):
        for ie2 in range(nel2):
            for ie3 in range(nel3):
                for q1 in range(nq1):
                    for q2 in range(nq2):
                        for q3 in range(nq3):
                            ...
                            b3value[ie1, ie2, ie3, q1, q2, q3] = (
                                generate_weight3[2] * temp
                            )  # we here multilying uvalue and weights into b1, b2, b3
