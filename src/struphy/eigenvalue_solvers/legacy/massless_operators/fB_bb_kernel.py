                            ...
                            for il1 in range(p1 + 1):
                                for il2 in range(d2 + 1):
                                    for il3 in range(d3 + 1):
                                        ...
                                        value  += bn1[ie1, il1, 0, q1] * bd2[ie2, il2, 0, q2] * bd3[
                                            ie3, il3,
                                            0, q3,
                                        ] * temp_vector_1[idnx[ie1, il1], iddy[ie2, il2], iddz[ie3, il3]]
                            ...
                            for il1 in range(d1 + 1):
                                for il2 in range(p2 + 1):
                                    for il3 in range(d3 + 1):
                                        ...
                                        value += bd1[ie1, il1, 0, q1] * bn2[ie2, il2, 0, q2] * bd3[
                                            ie3, il3, 0,
                                            q3,
                                        ] * temp_vector_2[iddx[ie1, il1], idny[ie2, il2], iddz[ie3, il3]]
                            ...
                            for il1 in range(d1 + 1):
                                for il2 in range(d2 + 1):
                                    for il3 in range(p3 + 1):
                                        ...
                                        value += bd1[ie1, il1, 0, q1] * bd2[ie2, il2, 0, q2] * bn3[
                                            ie3, il3, 0,
                                            q3,
                                        ] * temp_vector_3[iddx[ie1, il1], iddy[ie2, il2], idnz[ie3, il3]]
        ...
        for ie2 in range(nel2):
            for ie3 in range(nel3):
                for q1 in range(nq1):
                    for q2 in range(nq2):
                        for q3 in range(nq3):
                            weight1[ie1, ie2, ie3, q1, q2, q3] = b2value[ie1, ie2, ie3, q1, q2, q3] * right_3[
                                ie1, ie2,
                                ie3, q1, q2, q3,
                            ] - b3value[ie1, ie2, ie3, q1, q2, q3] * right_2[ie1, ie2, ie3, q1, q2, q3]
                            weight2[ie1, ie2, ie3, q1, q2, q3] = b3value[ie1, ie2, ie3, q1, q2, q3] * right_1[
                                ie1, ie2,
                                ie3, q1, q2, q3,
                            ] - b1value[ie1, ie2, ie3, q1, q2, q3] * right_3[ie1, ie2, ie3, q1, q2, q3]
                            weight3[ie1, ie2, ie3, q1, q2, q3] = b1value[ie1, ie2, ie3, q1, q2, q3] * right_2[
                                ie1, ie2,
                                ie3, q1, q2, q3,
                ...
                for q1 in range(nq1):
                    for q2 in range(nq2):
                        for q3 in range(nq3):
                            ...
                            b3value[ie1, ie2, ie3, q1, q2, q3] = generate_weight3[2] * \
                                temp  # we here multilying uvalue and weights into b1, b2, b3
                            weight1[ie1, ie2, ie3, q1, q2, q3] = temp * (
                                generate_weight3[1] * right_3[ie1, ie2, ie3, q1, q2, q3] -
                                generate_weight3[2] * right_2[ie1, ie2, ie3, q1, q2, q3]
                            )
                            weight2[ie1, ie2, ie3, q1, q2, q3] = temp * (
                                generate_weight3[2] * right_1[ie1, ie2, ie3, q1, q2, q3] -
                                generate_weight3[0] * right_3[ie1, ie2, ie3, q1, q2, q3]
                            )
                            weight3[ie1, ie2, ie3, q1, q2, q3] = temp * (
                                generate_weight3[0] * right_2[ie1, ie2, ie3, q1, q2, q3] -
                                generate_weight3[1] * right_1[ie1, ie2, ie3, q1, q2, q3]
                            )
