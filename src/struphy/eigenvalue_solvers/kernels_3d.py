...
def kernel_mass(
    ...
    #$ omp parallel default(shared) private(ie1, ie2, ie3, il1, il2, il3, jl1, jl2, jl3, value1, q1, q2, q3, wvol, bi, bj)
...
def kernel_inner(
    ...
    #$ omp parallel default(shared) private(ie1, ie2, ie3, il1, il2, il3, value1, q1, q2, q3, wvol, bi)
    #$ omp for reduction ( + : mat)
    for ie1 in range(nel[0]):
        for ie2 in range(nel[1]):
            for ie3 in range(nel[2]):
...
def kernel_l2error(
    ...
    #$ omp parallel default(shared) private(ie1, ie2, ie3, q1, q2, q3, wvol, bi, bj, il1, il2, il3, jl1, jl2, jl3)
    #$ omp for
...
def kernel_evaluate_2form(
    ...
    #$ omp parallel default(shared) private(ie1, ie2, ie3, q1, q2, q3, il1, il2, il3)
    #$ omp for
    for ie1 in range(nel[0]):
        for ie2 in range(nel[1]):
            for ie3 in range(nel[2]):
