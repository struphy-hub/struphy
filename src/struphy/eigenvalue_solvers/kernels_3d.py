                            ...
                            for jl1 in range(p[0] + 1 - nj[0]):
                                for jl2 in range(p[1] + 1 - nj[1]):
                                    for jl3 in range(p[2] + 1 - nj[2]):
                                        ...
                                        for q1 in range(nq[0]):
                                            for q2 in range(nq[1]):
                                                for q3 in range(nq[2]):
                                                    ...
                                                    wvol = w1[ie1, q1] * w2[ie2, q2] * w3[
                                                        ie3,
                                                        q3,
                                                    ] * mat_fun[ie1, q1, ie2, q2, ie3, q3]
                                                    bi = bi1[ie1, il1, 0, q1] * bi2[
                                                        ie2,
                                                        il2, 0, q2,
                                                    ] * bi3[ie3, il3, 0, q3]
                                                    bj = bj1[ie1, jl1, 0, q1] * bj2[
                                                        ie2,
                                                        jl2, 0, q2,
                                                    ] * bj3[ie3, jl3, 0, q3]
                                        ...
                                        mat[
                                            ind_base1[ie1, il1], ind_base2[ie2, il2], ind_base3[ie3, il3],
                                            p[0] + jl1 - il1, p[1] + jl2 - il2, p[2] + jl3 - il3,
                                        ] += value
    # $ omp end parallel
                ...
                for il1 in range(p[0] + 1 - ni[0]):
                    for il2 in range(p[1] + 1 - ni[1]):
                        for il3 in range(p[2] + 1 - ni[2]):
                            ...
                            mat[
                                ind_base1[ie1, il1], ind_base2[ie2, il2],
                                ind_base3[ie3, il3],
                            ] += value
    # $ omp end parallel
                            ...
                            for il1 in range(p[0] + 1 - ni[0]):
                                for il2 in range(p[1] + 1 - ni[1]):
                                    for il3 in range(p[2] + 1 - ni[2]):
                                        ...
                                        bi += c1[
                                            ind_basei1[ie1, il1], ind_basei2[ie2, il2], ind_basei3[ie3, il3],
                            ...
                            for jl1 in range(p[0] + 1 - nj[0]):
                                for jl2 in range(p[1] + 1 - nj[1]):
                                    for jl3 in range(p[2] + 1 - nj[2]):
                                        ...
                                        bj += c2[
                                            ind_basej1[ie1, il1], ind_basej2[ie2, il2], ind_basej3[ie3, il3],
                            ...
                            for il1 in range(p[0] + 1 - ns[0]):
                                for il2 in range(p[1] + 1 - ns[1]):
                                    for il3 in range(p[2] + 1 - ns[2]):
                                        ...
                                        b_eva[ie1, q1, ie2, q2, ie3, q3] += b_coeff[
                                            ind_base1[ie1, il1], ind_base2[ie2, il2],
                                            ind_base3[ie3, il3],
                                        ] * bi1[ie1, il1, 0, q1] * bi2[ie2, il2, 0, q2] * bi3[ie3, il3, 0, q3]
    # $ omp end parallel
