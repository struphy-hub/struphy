...
class MHDOperatorsCore:
    ...
    def get_blocks_EF(self, pol=True):
        ...
        if self.basis_u == 0:
            ...
            if pol or self.space.dim == 2:
                ...
                ker.rhs0_2d(
                    self.dofs_0_N_i[0][0], self.dofs_0_N_i[1][0], self.dofs_0_N_i[0][1],
                    self.dofs_0_N_i[1][1], self.basis_int_N[0], self.basis_int_N[1], -B2_2_pts, val, row, col,
                )
                ...
                ker.rhs0_2d(
                    self.dofs_0_N_i[0][0], self.dofs_0_N_i[1][0], self.dofs_0_N_i[0][1],
                    self.dofs_0_N_i[1][1], self.basis_int_N[0], self.basis_int_N[1], B2_1_pts, val, row, col,
                )
                ...
                # assemble sparse matrix
                val = np.empty(
                    self.dofs_1_N_i[0][0].size*self.dofs_0_N_i[1]
                    [0].size*self.dofs_0_N_i[2][0].size, dtype=float,
                )
                row = np.empty(
                    self.dofs_1_N_i[0][0].size*self.dofs_0_N_i[1]
                    [0].size*self.dofs_0_N_i[2][0].size, dtype=int,
                )
                col = np.empty(
                    self.dofs_1_N_i[0][0].size*self.dofs_0_N_i[1]
                    [0].size*self.dofs_0_N_i[2][0].size, dtype=int,
                ...
                # assemble sparse matrix
                val = np.empty(
                    self.dofs_0_N_i[0][0].size*self.dofs_1_N_i[1]
                    [0].size*self.dofs_0_N_i[2][0].size, dtype=float,
                )
                row = np.empty(
                    self.dofs_0_N_i[0][0].size*self.dofs_1_N_i[1]
                ...
                # assemble sparse matrix
                val = np.empty(
                    self.dofs_0_N_i[0][0].size*self.dofs_0_N_i[1]
                    [0].size*self.dofs_1_N_i[2][0].size, dtype=float,
                )
                row = np.empty(
                    self.dofs_0_N_i[0][0].size*self.dofs_0_N_i[1]
                    [0].size*self.dofs_1_N_i[2][0].size, dtype=int,
                )
                col = np.empty(
                    self.dofs_0_N_i[0][0].size*self.dofs_0_N_i[1]
                    [0].size*self.dofs_1_N_i[2][0].size, dtype=int,
            ...
            if pol or self.space.dim == 2:
                ...
                ker.rhs0_2d(
                    self.dofs_0_N_i[0][0], self.dofs_0_D_i[1][0], self.dofs_0_N_i[0][1], self.dofs_0_D_i[1]
                ...
                ker.rhs0_2d(
                    self.dofs_0_D_i[0][0], self.dofs_0_N_i[1][0], self.dofs_0_D_i[0][1], self.dofs_0_N_i[1]
                    [1], self.basis_int_D[0], self.basis_int_N[1], B2_1_pts/det_dF, val, row, col,
                )
                ...
                det_dF = abs(
                    self.equilibrium.domain.jacobian_det(
                        self.eta_his[0].flatten(), self.eta_int[1], self.eta_int[2],
                    ),
                )
                ...
                # assemble sparse matrix
                val = np.empty(
                    self.dofs_1_D_i[0][0].size*self.dofs_0_N_i[1]
                    [0].size*self.dofs_0_D_i[2][0].size, dtype=float,
                )
                row = np.empty(
                    self.dofs_1_D_i[0][0].size*self.dofs_0_N_i[1]
                    [0].size*self.dofs_0_D_i[2][0].size, dtype=int,
                )
                col = np.empty(
                    self.dofs_1_D_i[0][0].size*self.dofs_0_N_i[1]
                    [0].size*self.dofs_0_D_i[2][0].size, dtype=int,
                ...
                # assemble sparse matrix
                val = np.empty(
                    self.dofs_1_D_i[0][0].size*self.dofs_0_D_i[1]
                    [0].size*self.dofs_0_N_i[2][0].size, dtype=float,
                )
                row = np.empty(
                    self.dofs_1_D_i[0][0].size*self.dofs_0_D_i[1]
                ...
                det_dF = abs(
                    self.equilibrium.domain.jacobian_det(
                        self.eta_int[0], self.eta_his[1].flatten(), self.eta_int[2],
                    ),
                )
                ...
                # assemble sparse matrix
                val = np.empty(
                    self.dofs_0_N_i[0][0].size*self.dofs_1_D_i[1]
                    [0].size*self.dofs_0_D_i[2][0].size, dtype=float,
                )
                row = np.empty(
                    self.dofs_0_N_i[0][0].size*self.dofs_1_D_i[1]
                ...
                # assemble sparse matrix
                val = np.empty(
                    self.dofs_0_D_i[0][0].size*self.dofs_1_D_i[1]
                    [0].size*self.dofs_0_N_i[2][0].size, dtype=float,
                )
                row = np.empty(
                    self.dofs_0_D_i[0][0].size*self.dofs_1_D_i[1]
                ...
                det_dF = abs(
                    self.equilibrium.domain.jacobian_det(
                        self.eta_int[0], self.eta_int[1], self.eta_his[2].flatten(),
                    ),
                )
                ...
                # assemble sparse matrix
                val = np.empty(
                    self.dofs_0_N_i[0][0].size*self.dofs_0_D_i[1]
                    [0].size*self.dofs_1_D_i[2][0].size, dtype=float,
                )
                row = np.empty(
                    self.dofs_0_N_i[0][0].size*self.dofs_0_D_i[1]
                    [0].size*self.dofs_1_D_i[2][0].size, dtype=int,
                )
                col = np.empty(
                    self.dofs_0_N_i[0][0].size*self.dofs_0_D_i[1]
                    [0].size*self.dofs_1_D_i[2][0].size, dtype=int,
                ...
                # assemble sparse matrix
                val = np.empty(
                    self.dofs_0_D_i[0][0].size*self.dofs_0_N_i[1]
                    [0].size*self.dofs_1_D_i[2][0].size, dtype=float,
                )
                row = np.empty(
                    self.dofs_0_D_i[0][0].size*self.dofs_0_N_i[1]
    ...
    def get_blocks_FL(self, which, pol=True):
        ...
        if self.basis_u == 0:
            ...
            if pol or self.space.dim == 2:
                ...
                # assemble sparse matrix
                val = np.empty(
                    self.dofs_1_N_i[0][0].size*self.dofs_1_N_i[1]
                    [0].size*self.dofs_0_N_i[2][0].size, dtype=float,
                )
                row = np.empty(
                    self.dofs_1_N_i[0][0].size*self.dofs_1_N_i[1]
            ...
            if pol or self.space.dim == 2:
                ...
                det_dF = abs(
                    self.equilibrium.domain.jacobian_det(
                        self.eta_his[0].flatten(), self.eta_his[1].flatten(), 0.,
                    ),
                )
                ...
                # assemble sparse matrix
                val = np.empty(
                    self.dofs_1_D_i[0][0].size*self.dofs_1_D_i[1]
                    [0].size*self.dofs_0_N_i[2][0].size, dtype=float,
                )
                row = np.empty(
                    self.dofs_1_D_i[0][0].size*self.dofs_1_D_i[1]
    ...
    def get_blocks_PR(self, pol=True):
        ...
        if pol or self.space.dim == 2:
            ...
            P3_pts = self.equilibrium.p3(
                ...
                ), self.eta_his[1].flatten(), self.eta_his[2].flatten(),
            )
    ...
    def get_blocks_Mn(self, pol=True):
        ...
        weight11 = lambda s, chi, phi : self.equilibrium.n0(
            s, chi, phi,
        )*self.equilibrium.domain.metric(s, chi, phi)[0, 0]
        weight12 = lambda s, chi, phi : self.equilibrium.n0(
            s, chi, phi,
        )*self.equilibrium.domain.metric(s, chi, phi)[0, 1]
        weight13 = lambda s, chi, phi : self.equilibrium.n0(
            s, chi, phi,
        )*self.equilibrium.domain.metric(s, chi, phi)[0, 2]

        weight21 = lambda s, chi, phi : self.equilibrium.n0(
            s, chi, phi,
        )*self.equilibrium.domain.metric(s, chi, phi)[1, 0]
        weight22 = lambda s, chi, phi : self.equilibrium.n0(
            s, chi, phi,
        )*self.equilibrium.domain.metric(s, chi, phi)[1, 1]
        weight23 = lambda s, chi, phi : self.equilibrium.n0(
            s, chi, phi,
        )*self.equilibrium.domain.metric(s, chi, phi)[1, 2]

        weight31 = lambda s, chi, phi : self.equilibrium.n0(
            s, chi, phi,
        )*self.equilibrium.domain.metric(s, chi, phi)[2, 0]
        weight32 = lambda s, chi, phi : self.equilibrium.n0(
            s, chi, phi,
        )*self.equilibrium.domain.metric(s, chi, phi)[2, 1]
        weight33 = lambda s, chi, phi : self.equilibrium.n0(
            s, chi, phi,
        )*self.equilibrium.domain.metric(s, chi, phi)[2, 2]
