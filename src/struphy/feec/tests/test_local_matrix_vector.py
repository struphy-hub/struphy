...
def test_local_matrix_vector():
    from struphy.feec.utilities import LocalRotationMatrix, LocalVector
    ...
    for i in range(n1):
        ...
        for j in range(n2):
            ...
            for k in range(n3):
                ...
                expected_S = (
                    fun0(ee1_i, ee2_j, ee3_k) * v[i, j, k, 0]
                    + fun1(ee1_i, ee2_j, ee3_k) * v[i, j, k, 1]
                    + fun2(ee1_i, ee2_j, ee3_k) * v[i, j, k, 2]
                )
                ...
                expected_R2[0, 0] = (
                    fun1(ee1_i, ee2_j, ee3_k) * mat[i, j, k, 2, 0] - fun2(ee1_i, ee2_j, ee3_k) * mat[i, j, k, 1, 0]
                )
                expected_R2[1, 0] = (
                    -fun0(ee1_i, ee2_j, ee3_k) * mat[i, j, k, 2, 0] + fun2(ee1_i, ee2_j, ee3_k) * mat[i, j, k, 0, 0]
                )
                expected_R2[2, 0] = (
                    fun0(ee1_i, ee2_j, ee3_k) * mat[i, j, k, 1, 0] - fun1(ee1_i, ee2_j, ee3_k) * mat[i, j, k, 0, 0]
                )

                expected_R2[0, 1] = (
                    fun1(ee1_i, ee2_j, ee3_k) * mat[i, j, k, 2, 1] - fun2(ee1_i, ee2_j, ee3_k) * mat[i, j, k, 1, 1]
                )
                expected_R2[1, 1] = (
                    -fun0(ee1_i, ee2_j, ee3_k) * mat[i, j, k, 2, 1] + fun2(ee1_i, ee2_j, ee3_k) * mat[i, j, k, 0, 1]
                )
                expected_R2[2, 1] = (
                    fun0(ee1_i, ee2_j, ee3_k) * mat[i, j, k, 1, 1] - fun1(ee1_i, ee2_j, ee3_k) * mat[i, j, k, 0, 1]
                )

                expected_R2[0, 2] = (
                    fun1(ee1_i, ee2_j, ee3_k) * mat[i, j, k, 2, 2] - fun2(ee1_i, ee2_j, ee3_k) * mat[i, j, k, 1, 2]
                )
                expected_R2[1, 2] = (
                    -fun0(ee1_i, ee2_j, ee3_k) * mat[i, j, k, 2, 2] + fun2(ee1_i, ee2_j, ee3_k) * mat[i, j, k, 0, 2]
                )
                expected_R2[2, 2] = (
                    fun0(ee1_i, ee2_j, ee3_k) * mat[i, j, k, 1, 2] - fun1(ee1_i, ee2_j, ee3_k) * mat[i, j, k, 0, 2]
                )
