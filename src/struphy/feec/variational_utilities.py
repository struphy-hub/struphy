...
class BracketOperator(LinOpWithTransp):
    ...
    def __init__(self, derham, u):
        ...
        V0h = derham.Vh_fem['0']
        V1h = derham.Vh_fem['1']
        self._domain = Xh.vector_space
        self._codomain = Xh.vector_space
        ...
        self.gp1v = V1h.vector_space.zeros()
        self.gp2v = V1h.vector_space.zeros()
        self.gp3v = V1h.vector_space.zeros()
        ...
        self.interpolation_grid_spans, self.interpolation_grid_bn, self.interpolation_grid_bd = derham.prepare_eval_tp_fixed(interpolation_grid)
