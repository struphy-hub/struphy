    ...
    **weights : dict
    ...
    def M0(self):
        ...
        if not hasattr(self, "_M0"):
            self._M0 = self.create_weighted_mass("H1", "H1", weights=["sqrt_g"], name="M0", assemble=True)
        return self._M0
    ...
    def M1(self):
        ...
        if not hasattr(self, "_M1"):
            self._M1 = self.create_weighted_mass("Hcurl", "Hcurl", weights=["Ginv", "sqrt_g"], name="M1", assemble=True)
    ...
    def M2(self):
        ...
        if not hasattr(self, "_M2"):
            self._M2 = self.create_weighted_mass("Hdiv", "Hdiv", weights=["G", "1/sqrt_g"], name="M2", assemble=True)
    ...
    def M3(self):
        ...
        if not hasattr(self, "_M3"):
            self._M3 = self.create_weighted_mass("L2", "L2", weights=["1/sqrt_g"], name="M3", assemble=True)
    ...
    def Mv(self):
        ...
        if not hasattr(self, "_Mv"):
            self._Mv = self.create_weighted_mass("H1vec", "H1vec", weights=["G", "sqrt_g"], name="Mv", assemble=True)
    ...
    def M1n(self):
        ...
        if not hasattr(self, "_M1n"):
            self._M1n = self.create_weighted_mass(
                "Hcurl", "Hcurl", weights=["Ginv", "sqrt_g", "eq_n0"], name="M1n", assemble=True
            )
    ...
    def M2n(self):
        ...
        if not hasattr(self, "_M2n"):
            self._M2n = self.create_weighted_mass(
                "Hdiv", "Hdiv", weights=["G", "1/sqrt_g", "eq_n0"], name="M2n", assemble=True
            )
    ...
    def Mvn(self):
        ...
        if not hasattr(self, "_Mvn"):
            self._Mvn = self.create_weighted_mass(
                "H1vec", "H1vec", weights=["G", "sqrt_g", "eq_n0"], name="Mvn", assemble=True
            )
    ...
    def M1ninv(self):
        ...
        if not hasattr(self, "_M1ninv"):
            self._M1ninv = self.create_weighted_mass(
                "Hcurl", "Hcurl", weights=["Ginv", "sqrt_g", "1/eq_n0"], name="M1ninv", assemble=True
            )
    ...
    def M1J(self):
        ...
        if not hasattr(self, "_M1J"):
            ...
            self._M1J = self.create_weighted_mass("Hdiv", "Hcurl", weights=["Ginv", rot_J], name="M1J", assemble=True)
    ...
    def M2J(self):
        ...
        if not hasattr(self, "_M2J"):
            ...
            self._M2J = self.create_weighted_mass(
                "Hdiv", "Hdiv", weights=[rot_J, "1/sqrt_g"], name="M2J", assemble=True
            )
    ...
    def MvJ(self):
        ...
        if not hasattr(self, "_MvJ"):
            ...
            self._MvJ = self.create_weighted_mass("Hdiv", "H1vec", weights=[rot_J], name="MvJ", assemble=True)
    ...
    def M2B(self):
        ...
        if not hasattr(self, "_M2B"):
            ...
            def b02funx(x, y, z):
                return b02fun(x, y, z, squeeze_output=True, local=True)[0]

            def b02funy(x, y, z):
                return b02fun(x, y, z, squeeze_output=True, local=True)[1]

            def b02funz(x, y, z):
                return b02fun(x, y, z, squeeze_output=True, local=True)[2]

            rot_B = RotationMatrix(b02funx, b02funy, b02funz)
    ...
    def M2Bn(self):
        ...
        if not hasattr(self, "_M2Bn"):
            ...
            self._M2Bn = self.create_weighted_mass(
                "Hdiv", "Hdiv", weights=[rot_B, "1/sqrt_g", "eq_n0"], name="M2Bn", assemble=True
            )
    ...
    def M1Bninv(self):
        ...
        if not hasattr(self, "_M1Bninv"):
            ...
            self._M1Bninv = self.create_weighted_mass(
                "Hcurl", "Hcurl", weights=["Ginv", rot_B, "Ginv", "sqrt_g", "1/eq_n0"], name="M1Bninv", assemble=True
            )
    ...
    def M1perp(self):
        ...
        if not hasattr(self, "_M1perp"):
            ...
            self._M1perp = self.create_weighted_mass(
                "Hcurl", "Hcurl", weights=["DFinv", D, "DFinv", "sqrt_g"], name="M1perp", assemble=True
            )
    ...
    def M0ad(self):
        ...
        if not hasattr(self, "_M0ad"):
            self._M0ad = self.create_weighted_mass("H1", "H1", weights=["eq_n0", "sqrt_g"], name="M0ad", assemble=True)
    ...
    def M1gyro(self):
        ...
        if not hasattr(self, "_M1gyro"):
            ...
            self._M1gyro = self.create_weighted_mass(
                "Hcurl",
                "Hcurl",
                weights=["eq_n0", "1/eq_absB0", "1/eq_absB0", D, "Ginv", D, "sqrt_g"],
                name="M1gyro",
                assemble=True,
            )
        ...
        if isinstance(weights, (str, type(None))):  # Case 2 and Case 3
            ...
            for n, f in enumerate(weights):
                if isinstance(f, str):
                    ...
                    if "eq_" in f:
                        ...
                        f_call = getattr(self.weights[self.selected_weight], f_components[-1])
                    elif "/" in f:
                        ...
                        if f_components[-1] == "G":
                            ...
                            raise NotImplementedError(f"The option {f} is not available.")
                    else:
                        if f == "G":
                            f_call = G
                        elif f == "Ginv":
            ...
            # only rank 0 weights were given
                ...
                if operations[0] == "*":
                    ...
                    fun = [[lambda e1, e2, e3: 1.0 / weights_rank0[0](e1, e2, e3)]]

                for f2, op in zip(weights_rank0[1:], operations[1:]):
                    fun = [[lambda e1, e2, e3, f=fun[0][0], op=op, f2=f2: self._operate(f, f2, op, e1, e2, e3)]]
    ...
    **weights : dict
    ...
    def M1(self):
        ...
        if not hasattr(self, "_M1"):
            ...
            self._M1 = self._assemble_weighted_mass(fun, "Hcurl", "Hcurl", name="M1")
    ...
    def M2(self):
        ...
        if not hasattr(self, "_M2"):
            ...
            self._M2 = self._assemble_weighted_mass(fun, "Hdiv", "Hdiv", name="M2")
    ...
    def Mv(self):
        ...
        if not hasattr(self, "_Mv"):
            ...
            self._Mv = self._assemble_weighted_mass(fun, "H1vec", "H1vec", name="Mv")
    ...
    def M1n(self):
        ...
        if not hasattr(self, "_M1n"):
            ...
            self._M1n = self._assemble_weighted_mass(fun, "Hcurl", "Hcurl", name="M1n")
    ...
    def M2n(self):
        ...
        if not hasattr(self, "_M2n"):
            ...
            self._M2n = self._assemble_weighted_mass(fun, "Hdiv", "Hdiv", name="M2n")
    ...
    def Mvn(self):
        ...
        if not hasattr(self, "_Mvn"):
            ...
            self._Mvn = self._assemble_weighted_mass(fun, "H1vec", "H1vec", name="Mvn")
    ...
    def M1ninv(self):
        ...
        if not hasattr(self, "_M1ninv"):
            ...
            self._M1ninv = self._assemble_weighted_mass(fun, "Hcurl", "Hcurl", name="M1ninv")
    ...
    def M1J(self):
        ...
        if not hasattr(self, "_M1J"):
            ...
            for m in range(3):
                fun += [[]]
                for n in range(3):
                    fun[-1] += [lambda e1, e2, e3, m=m, n=n: (self.Ginv(e1, e2, e3) @ rot_J(e1, e2, e3))[:, :, :, m, n]]

            self._M1J = self._assemble_weighted_mass(fun, "Hdiv", "Hcurl", name="M1J")
    ...
    def M2J(self):
        ...
        if not hasattr(self, "_M2J"):
            ...
            self._M2J = self._assemble_weighted_mass(fun, "Hdiv", "Hdiv", name="M2J")
    ...
    def MvJ(self):
        ...
        if not hasattr(self, "_MvJ"):
            ...
            self._MvJ = self._assemble_weighted_mass(fun, "Hdiv", "H1vec", name="MvJ")
    ...
    def M2B(self):
        ...
        if not hasattr(self, "_M2B"):
            ...
            self._M2B = self._assemble_weighted_mass(fun, "Hdiv", "Hdiv", name="M2B")
    ...
    def M2Bn(self):
        ...
        if not hasattr(self, "_M2BN"):  # typo M2BN instead of M2Bn??
            ...
            self._M2BN = self._assemble_weighted_mass(fun, "Hdiv", "Hdiv", name="M2Bn")
    ...
    def M1Bninv(self):
        ...
        if not hasattr(self, "_M1Bninv"):
            ...
            self._M1Bninv = self._assemble_weighted_mass(fun, "Hcurl", "Hcurl", name="M1Bninv")
    ...
    def M1perp(self):
        ...
        if not hasattr(self, "_M1perp"):
            ...
            self._M1perp = self._assemble_weighted_mass(fun, "Hcurl", "Hcurl", name="M1perp")
    ...
    def M0ad(self):
        ...
        if not hasattr(self, "_M0ad"):
            fun = [[lambda e1, e2, e3: self.weights[self.selected_weight].n0(e1, e2, e3) * self.sqrt_g(e1, e2, e3)]]

            self._M0ad = self._assemble_weighted_mass(fun, "H1", "H1", name="M0ad")
    ...
    def M1gyro(self):
        ...
        if not hasattr(self, "_M1gyro"):
            ...
            for m in range(3):
                ...
                for n in range(3):
                    fun[-1] += [
                        ...
                        / self.weights[self.selected_weight].absB0(e1, e2, e3) ** 2
            ...
            self._M1gyro = self._assemble_weighted_mass(fun, "Hcurl", "Hcurl", name="M1gyro")

        return self._M1gyro

    def _assemble_weighted_mass(self, fun: list, V_id: str, W_id: str, name=None):
        r"""Weighted mass matrix :math:`V^\alpha_h \to V^\beta_h` with given (matrix-valued) weight function :math:`W(\boldsymbol \eta)`:
        ...
        if isinstance(weights_info, str):
            ...
            if self._matrix_free:
                if weights_info == "symm":
                    blocks = [[StencilMatrixFreeMassOperator(Vs, Ws) for Vs in V.spaces] for Ws in W.spaces]
                elif weights_info == "asym":
                    blocks = [
                        [StencilMatrixFreeMassOperator(Vs, Ws) if i != j else None for j, Vs in enumerate(V.spaces)]
                ...
                if weights_info == "symm":
                    blocks = [
                        [
                            StencilMatrix(
                                Vs.vector_space, Ws.vector_space, backend=PSYDAC_BACKEND_GPYCCEL, precompiled=True
                            )
                            for Vs in V.spaces
                        ]
                        for Ws in W.spaces
            ...
            self._mat = BlockLinearOperator(V.vector_space, W.vector_space, blocks=blocks)
                    ...
                    if weights_info is None:
                        ...
                        if weights_info[a][b] is None:
                            ...
                            if np.any(np.abs(mat_w) > 1e-14):
                                if self._matrix_free:
                                    blocks[-1] += [
                                        StencilMatrixFreeMassOperator(vspace, wspace, weights=weights_info[a][b])
                                    ]
                                else:
                                    blocks[-1] += [
                                        StencilMatrix(
                    ...
                    for a, weights_row in enumerate(weights):
                        for b, weight in enumerate(weights_row):
                            if weight is not None:
                                assert callable(weight) or isinstance(weight, np.ndarray)
            ...
            for a, codomain_space in enumerate(codomain_spaces):
                ...
                for b, domain_space in enumerate(domain_spaces):
                    ...
                    if callable(loc_weight):
                        ...
                        raise TypeError(
                            "weights must be callable or np.ndarray or None but is {}".format(type(self._weights[a][b]))
                        )
                    ...
                    domain_basis = [
                        quad_grid[nquad].basis
                        for quad_grid, nquad in zip(domain_space._quad_grids, domain_space.nquads)
                    ]
    ...
    def eval_quad(W, coeffs, out=None):
        ...
        if out is None:
            ...
            if isinstance(W, TensorFemSpace):
                out += (
                    np.zeros(
                        [q_grid[nquad].points.size for q_grid, nquad in zip(W._quad_grids, W.nquads)], dtype=float
                    ),
                )
            else:
                for space in W.spaces:
                    out += (
                        np.zeros(
                            [q_grid[nquad].points.size for q_grid, nquad in zip(space._quad_grids, space.nquads)],
                            dtype=float,
                        ),
                    )
        ...
        for a, wspace in enumerate(Wspaces):
            ...
            # global quadrature points (flattened) and weights in format (local element, local weight)
            pts = [quad_grid[nquad].points.flatten() for quad_grid, nquad in zip(wspace._quad_grids, wspace.nquads)]
            ...
            if isinstance(coeffs, StencilVector):
                kernel(*spans, *wspace.degree, *starts, *pads, *basis, coeffs._data, out[a])
            else:
                kernel(*spans, *wspace.degree, *starts, *pads, *basis, coeffs[a]._data, out[a])
...
class StencilMatrixFreeMassOperator(LinOpWithTransp):
    ...
    def __init__(self, V, W, weights=None):
        ...
        self._weights = weights
        self._dtype = V.vector_space.dtype
        self._dot_kernel = getattr(mass_kernels, "kernel_" + str(self._V.ldim) + "d_matrixfree")

        self._diag_kernel = getattr(mass_kernels, "kernel_" + str(self._V.ldim) + "d_diag")

        shape = tuple(e - s + 1 for s, e in zip(V.vector_space.starts, V.vector_space.ends))
        self._diag_tmp = np.zeros((shape))

        # knot span indices of elements of local domain
        self._codomain_spans = [quad_grid[nquad].spans for quad_grid, nquad in zip(self._W._quad_grids, self._W.nquads)]
        ...
        # evaluated basis functions at quadrature points of codomain space
        self._codomain_basis = [quad_grid[nquad].basis for quad_grid, nquad in zip(self._W._quad_grids, self._W.nquads)]

        # knot span indices of elements of local domain
        self._domain_spans = [quad_grid[nquad].spans for quad_grid, nquad in zip(self._V._quad_grids, self._V.nquads)]
        ...
        # evaluated basis functions at quadrature points of domain space
        self._domain_basis = [quad_grid[nquad].basis for quad_grid, nquad in zip(self._V._quad_grids, self._V.nquads)]

        # global quadrature points (flattened) and weights in format (local element, local weight)
        self._pts = [quad_grid[nquad].points.flatten() for quad_grid, nquad in zip(self._W._quad_grids, self._W.nquads)]
        self._wts = [quad_grid[nquad].weights for quad_grid, nquad in zip(self._W._quad_grids, self._W.nquads)]
