    ...
    **weights : dict
    ...
    def M1perp(self):
        ...
        if not hasattr(self, "_M1perp"):
            ...
            for m in range(3):
                ...
                for n in range(3):
                    fun[-1] += [
                        lambda e1, e2, e3, m=m, n=n: self.DFinv(e1, e2, e3)[:, :, :, m, n]
                        * self.D[m][n]
                        * self.DFinv(e1, e2, e3)[:, :, :, n, m]
                        * self.sqrt_g(e1, e2, e3)
                    ]

            self._M1perp = self.assemble_weighted_mass(fun, "Hcurl", "Hcurl", name="M1perp")
    ...
    def M0ad(self):
        ...
        if not hasattr(self, "_M0ad"):
            ...
            self._M0ad = self.assemble_weighted_mass(fun, "H1", "H1", name="M0ad")
    ...
    def M1gyro(self):
        ...
        if not hasattr(self, "_M1gyro"):
            ...
            self._M1gyro = self.assemble_weighted_mass(fun, "Hcurl", "Hcurl", name="M1gyro")
