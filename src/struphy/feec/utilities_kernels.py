                ...
                for q1 in range(nq1):
                    for q2 in range(nq2):
                        for q3 in range(nq3):
                            ...
                            G[0, 1] = df_out[0, 0]*df_out[0, 1] + df_out[1, 0]*df_out[1, 1] + \
                                df_out[2, 0]*df_out[2, 1]
                            G[0, 2] = df_out[0, 0]*df_out[0, 2] + df_out[1, 0]*df_out[1, 2] + \
                                df_out[2, 2]*df_out[2, 2]

                            G[1, 1] = df_out[0, 1]*df_out[0, 1] + df_out[1, 1]*df_out[1, 1] + \
                                df_out[2, 1]*df_out[2, 1]
                            G[1, 2] = df_out[0, 1]*df_out[0, 2] + df_out[1, 1]*df_out[1, 2] + \
                                df_out[2, 1]*df_out[2, 2]

                            G[2, 2] = df_out[0, 2]*df_out[0, 2] + df_out[1, 2]*df_out[1, 2] + \
                                df_out[2, 2]*df_out[2, 2]
                            ...
                            data1[iel1*nq1+q1, iel2*nq2+q2, iel3*nq3+q3] = \
                                value_new[0]
                            data2[iel1*nq1+q1, iel2*nq2+q2, iel3*nq3+q3] = \
                                value_new[1]
