...
class SaddlePointSolver:
    ...
    def __call__(self, U_init=None, Ue_init=None, P_init=None, out=None):  # todo should have options to use other than uzawa. should solve in full generality. A being block diagonal is a special case of uzawa
        """
        ...
        # TODO this contains two different strategies! favágás and actual uzawa
        if self._variant == "Inverse_Solver":   # todo not in the """""saddle point solver"""""""
