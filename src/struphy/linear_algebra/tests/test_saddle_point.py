...
def test_saddlepointsolver(method_for_solving, Nel, p, spl_kind, dirichlet_bc, mapping, show_plots=False):
    ...
    from struphy.linear_algebra.saddle_point import SaddlePointSolver, SaddlePointSolverNoCG, SaddlePointSolverTest, SaddlePointSolverInexactUzawa, SaddlePointSolverArrowHurwicz, SaddlePointSolverGMRES
    ...
    if method_for_solving == 'SaddlePointSolverTest':
        ...
        count = 0
        solver = SaddlePointSolverArrowHurwicz(A, B, F,
                                rho=rho,
                                solver_name=solver_name,
                                tol=tol,
                                max_iter=max_iter,
