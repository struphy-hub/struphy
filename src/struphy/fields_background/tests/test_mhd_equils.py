...
@pytest.mark.parametrize(
    'equil_domain_pair', [
        ...
        (
            'ShearedSlab', {'a': 0.75, 'R0': 3.5, 'q0': 'inf', 'q1': 'inf'},
            'Cuboid', {'r1': 0.75, 'r2': 2*np.pi*0.75, 'r3': 2*np.pi*3.5},
        ),
        ...
        (
            'ScrewPinch', {'a': 0.45, 'R0': 2.5, 'q0': 1.5, 'q1': 1.5},
            'HollowCylinder', {'a1': 0.05, 'a2': 0.45, 'Lz': 2*np.pi*2.5},
        ),
        (
            'ScrewPinch', {'a': 1.45, 'R0': 6.5, 'q0': 1.5, 'q1': 1.5},
            'IGAPolarCylinder', {'a': 1.45, 'Lz': 2*np.pi*6.5},
        ),
        (
            'ScrewPinch', {'a': 0.45, 'R0': 2.5, 'q0': 'inf', 'q1': 'inf'},
            'HollowCylinder', {'a1': 0.05, 'a2': 0.45, 'Lz': 2*np.pi*2.5},
        ),
        (
            'ScrewPinch', {'a': 1.45, 'R0': 6.5, 'q0': 'inf', 'q1': 'inf'},
            'IGAPolarCylinder', {'a': 1.45, 'Lz': 2*np.pi*6.5},
        ),
        (
            'AdhocTorus', {'a': 1.45, 'R0': 6.5, 'q_kind': 0, 'p_kind': 0},
            'HollowTorus', {'a1': 0.05, 'a2': 1.45, 'R0': 6.5, 'sfl': False},
        ),
        (
            'AdhocTorus', {'a': 1.45, 'R0': 6.5, 'q_kind': 0, 'p_kind': 1},
            'HollowTorus', {'a1': 0.05, 'a2': 1.45, 'R0': 6.5, 'sfl': False},
        ),
        (
            'AdhocTorus', {'a': 1.45, 'R0': 6.5, 'q_kind': 1, 'p_kind': 0},
            'HollowTorus', {'a1': 0.05, 'a2': 1.45, 'R0': 6.5, 'sfl': False},
        ),
        (
            'AdhocTorus', {'a': 1.45, 'R0': 6.5, 'q_kind': 1, 'p_kind': 1},
            'HollowTorus', {'a1': 0.05, 'a2': 1.45, 'R0': 6.5, 'sfl': False},
        ),
        (
            'AdhocTorus', {'a': 1.45, 'R0': 6.5, 'q_kind': 0, 'p_kind': 0},
            'HollowTorus', {'a1': 0.05, 'a2': 1.45, 'R0': 6.5, 'sfl': True},
        ),
        (
            'AdhocTorus', {'a': 1.45, 'R0': 6.5, 'q_kind': 0, 'p_kind': 1},
            'HollowTorus', {'a1': 0.05, 'a2': 1.45, 'R0': 6.5, 'sfl': True},
        ...
        (
            'AdhocTorus', {'a': 1.45, 'R0': 6.5, 'q_kind': 0, 'p_kind': 0},
            'IGAPolarTorus', {'a': 1.45, 'R0': 6.5, 'sfl': True},
        ),
        (
            'AdhocTorus', {'a': 1.45, 'R0': 6.5, 'q_kind': 0, 'p_kind': 1},
            'IGAPolarTorus', {'a': 1.45, 'R0': 6.5, 'sfl': True},
