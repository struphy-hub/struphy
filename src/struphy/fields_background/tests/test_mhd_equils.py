...
def test_equils(equil_domain_pair):
    ...
    # for logical MHD equilibria, no domain is needed
    if isinstance(eq_mhd, LogicalMHDequilibrium):
    ...
    # scalar functions
    results.append(eq_mhd.absB0(*pt))
    results.append(eq_mhd.p0(*pt))
    results.append(eq_mhd.p3(*pt))
    results.append(eq_mhd.n0(*pt))
    results.append(eq_mhd.n3(*pt))
    
    # vector-valued functions (logical)
    results.append(eq_mhd.b1(*pt))
    results.append(eq_mhd.b2(*pt))
    results.append(eq_mhd.bv(*pt))
    results.append(eq_mhd.j1(*pt))
    results.append(eq_mhd.j2(*pt))
    results.append(eq_mhd.jv(*pt))
    results.append(eq_mhd.unit_b1(*pt))
    results.append(eq_mhd.unit_b2(*pt))
    results.append(eq_mhd.unit_bv(*pt))
    
    # vector-valued functions (cartesian)
    results.append(eq_mhd.b_cart(*pt))
    results.append(eq_mhd.j_cart(*pt))
    results.append(eq_mhd.unit_b_cart(*pt))
    ...
    # scalar functions
    results.append(eq_mhd.absB0(e1, e2_pt, e3_pt))
    results.append(eq_mhd.p0(e1, e2_pt, e3_pt))
    results.append(eq_mhd.p3(e1, e2_pt, e3_pt))
    results.append(eq_mhd.n0(e1, e2_pt, e3_pt))
    results.append(eq_mhd.n3(e1, e2_pt, e3_pt))
    
    # vector-valued functions (logical)
    results.append(eq_mhd.b1(e1, e2_pt, e3_pt))
    results.append(eq_mhd.b2(e1, e2_pt, e3_pt))
    results.append(eq_mhd.bv(e1, e2_pt, e3_pt))
    results.append(eq_mhd.j1(e1, e2_pt, e3_pt))
    results.append(eq_mhd.j2(e1, e2_pt, e3_pt))
    results.append(eq_mhd.jv(e1, e2_pt, e3_pt))
    results.append(eq_mhd.unit_b1(e1, e2_pt, e3_pt))
    results.append(eq_mhd.unit_b2(e1, e2_pt, e3_pt))
    results.append(eq_mhd.unit_bv(e1, e2_pt, e3_pt))
    
    # vector-valued functions (cartesian)
    results.append(eq_mhd.b_cart(e1, e2_pt, e3_pt))
    results.append(eq_mhd.j_cart(e1, e2_pt, e3_pt))
    results.append(eq_mhd.unit_b_cart(e1, e2_pt, e3_pt))
    ...
    # scalar functions
    results.append(eq_mhd.absB0(e1_pt, e2, e3_pt))
    results.append(eq_mhd.p0(e1_pt, e2, e3_pt))
    results.append(eq_mhd.p3(e1_pt, e2, e3_pt))
    results.append(eq_mhd.n0(e1_pt, e2, e3_pt))
    results.append(eq_mhd.n3(e1_pt, e2, e3_pt))
    
    # vector-valued functions (logical)
    results.append(eq_mhd.b1(e1_pt, e2, e3_pt))
    results.append(eq_mhd.b2(e1_pt, e2, e3_pt))
    results.append(eq_mhd.bv(e1_pt, e2, e3_pt))
    results.append(eq_mhd.j1(e1_pt, e2, e3_pt))
    results.append(eq_mhd.j2(e1_pt, e2, e3_pt))
    results.append(eq_mhd.jv(e1_pt, e2, e3_pt))
    results.append(eq_mhd.unit_b1(e1_pt, e2, e3_pt))
    results.append(eq_mhd.unit_b2(e1_pt, e2, e3_pt))
    results.append(eq_mhd.unit_bv(e1_pt, e2, e3_pt))
    
    # vector-valued functions (cartesian)
    results.append(eq_mhd.b_cart(e1_pt, e2, e3_pt))
    results.append(eq_mhd.j_cart(e1_pt, e2, e3_pt))
    results.append(eq_mhd.unit_b_cart(e1_pt, e2, e3_pt))
    ...
    # scalar functions
    results.append(eq_mhd.absB0(e1_pt, e2_pt, e3))
    results.append(eq_mhd.p0(e1_pt, e2_pt, e3))
    results.append(eq_mhd.p3(e1_pt, e2_pt, e3))
    results.append(eq_mhd.n0(e1_pt, e2_pt, e3))
    results.append(eq_mhd.n3(e1_pt, e2_pt, e3))
    
    # vector-valued functions (logical)
    results.append(eq_mhd.b1(e1_pt, e2_pt, e3))
    results.append(eq_mhd.b2(e1_pt, e2_pt, e3))
    results.append(eq_mhd.bv(e1_pt, e2_pt, e3))
    results.append(eq_mhd.j1(e1_pt, e2_pt, e3))
    results.append(eq_mhd.j2(e1_pt, e2_pt, e3))
    results.append(eq_mhd.jv(e1_pt, e2_pt, e3))
    results.append(eq_mhd.unit_b1(e1_pt, e2_pt, e3))
    results.append(eq_mhd.unit_b2(e1_pt, e2_pt, e3))
    results.append(eq_mhd.unit_bv(e1_pt, e2_pt, e3))
    
    # vector-valued functions (cartesian)
    results.append(eq_mhd.b_cart(e1_pt, e2_pt, e3))
    results.append(eq_mhd.j_cart(e1_pt, e2_pt, e3))
    results.append(eq_mhd.unit_b_cart(e1_pt, e2_pt, e3))
    ...
    # scalar functions
    results.append(eq_mhd.absB0(e1, e2, e3_pt))
    results.append(eq_mhd.p0(e1, e2, e3_pt))
    results.append(eq_mhd.p3(e1, e2, e3_pt))
    results.append(eq_mhd.n0(e1, e2, e3_pt))
    results.append(eq_mhd.n3(e1, e2, e3_pt))
    
    # vector-valued functions (logical)
    results.append(eq_mhd.b1(e1, e2, e3_pt))
    results.append(eq_mhd.b2(e1, e2, e3_pt))
    results.append(eq_mhd.bv(e1, e2, e3_pt))
    results.append(eq_mhd.j1(e1, e2, e3_pt))
    results.append(eq_mhd.j2(e1, e2, e3_pt))
    results.append(eq_mhd.jv(e1, e2, e3_pt))
    results.append(eq_mhd.unit_b1(e1, e2, e3_pt))
    results.append(eq_mhd.unit_b2(e1, e2, e3_pt))
    results.append(eq_mhd.unit_bv(e1, e2, e3_pt))
    
    # vector-valued functions (cartesian)
    results.append(eq_mhd.b_cart(e1, e2, e3_pt))
    results.append(eq_mhd.j_cart(e1, e2, e3_pt))
    results.append(eq_mhd.unit_b_cart(e1, e2, e3_pt))
    ...
    # scalar functions
    results.append(eq_mhd.absB0(e1, e2_pt, e3))
    results.append(eq_mhd.p0(e1, e2_pt, e3))
    results.append(eq_mhd.p3(e1, e2_pt, e3))
    results.append(eq_mhd.n0(e1, e2_pt, e3))
    results.append(eq_mhd.n3(e1, e2_pt, e3))
    
    # vector-valued functions (logical)
    results.append(eq_mhd.b1(e1, e2_pt, e3))
    results.append(eq_mhd.b2(e1, e2_pt, e3))
    results.append(eq_mhd.bv(e1, e2_pt, e3))
    results.append(eq_mhd.j1(e1, e2_pt, e3))
    results.append(eq_mhd.j2(e1, e2_pt, e3))
    results.append(eq_mhd.jv(e1, e2_pt, e3))
    results.append(eq_mhd.unit_b1(e1, e2_pt, e3))
    results.append(eq_mhd.unit_b2(e1, e2_pt, e3))
    results.append(eq_mhd.unit_bv(e1, e2_pt, e3))
    
    # vector-valued functions (cartesian)
    results.append(eq_mhd.b_cart(e1, e2_pt, e3))
    results.append(eq_mhd.j_cart(e1, e2_pt, e3))
    results.append(eq_mhd.unit_b_cart(e1, e2_pt, e3))
    ...
    # scalar functions
    results.append(eq_mhd.absB0(e1_pt, e2, e3))
    results.append(eq_mhd.p0(e1_pt, e2, e3))
    results.append(eq_mhd.p3(e1_pt, e2, e3))
    results.append(eq_mhd.n0(e1_pt, e2, e3))
    results.append(eq_mhd.n3(e1_pt, e2, e3))
    
    # vector-valued functions (logical)
    results.append(eq_mhd.b1(e1_pt, e2, e3))
    results.append(eq_mhd.b2(e1_pt, e2, e3))
    results.append(eq_mhd.bv(e1_pt, e2, e3))
    results.append(eq_mhd.j1(e1_pt, e2, e3))
    results.append(eq_mhd.j2(e1_pt, e2, e3))
    results.append(eq_mhd.jv(e1_pt, e2, e3))
    results.append(eq_mhd.unit_b1(e1_pt, e2, e3))
    results.append(eq_mhd.unit_b2(e1_pt, e2, e3))
    results.append(eq_mhd.unit_bv(e1_pt, e2, e3))
    ...
    # scalar functions
    results.append(eq_mhd.absB0(e1, e2, e3))
    results.append(eq_mhd.p0(e1, e2, e3))
    results.append(eq_mhd.p3(e1, e2, e3))
    results.append(eq_mhd.n0(e1, e2, e3))
    results.append(eq_mhd.n3(e1, e2, e3))
    
    # vector-valued functions (logical)
    results.append(eq_mhd.b1(e1, e2, e3))
    results.append(eq_mhd.b2(e1, e2, e3))
    results.append(eq_mhd.bv(e1, e2, e3))
    results.append(eq_mhd.j1(e1, e2, e3))
    results.append(eq_mhd.j2(e1, e2, e3))
    results.append(eq_mhd.jv(e1, e2, e3))
    results.append(eq_mhd.unit_b1(e1, e2, e3))
    results.append(eq_mhd.unit_b2(e1, e2, e3))
    results.append(eq_mhd.unit_bv(e1, e2, e3))
    
    # vector-valued functions (cartesian)
    results.append(eq_mhd.b_cart(e1, e2, e3))
    results.append(eq_mhd.j_cart(e1, e2, e3))
    results.append(eq_mhd.unit_b_cart(e1, e2, e3))
    ...
    # scalar functions
    results.append(eq_mhd.absB0(mat_12_1, mat_12_2, e3_pt))
    results.append(eq_mhd.p0(mat_12_1, mat_12_2, e3_pt))
    results.append(eq_mhd.p3(mat_12_1, mat_12_2, e3_pt))
    results.append(eq_mhd.n0(mat_12_1, mat_12_2, e3_pt))
    results.append(eq_mhd.n3(mat_12_1, mat_12_2, e3_pt))
    
    # vector-valued functions (logical)
    results.append(eq_mhd.b1(mat_12_1, mat_12_2, e3_pt))
    results.append(eq_mhd.b2(mat_12_1, mat_12_2, e3_pt))
    results.append(eq_mhd.bv(mat_12_1, mat_12_2, e3_pt))
    results.append(eq_mhd.j1(mat_12_1, mat_12_2, e3_pt))
    results.append(eq_mhd.j2(mat_12_1, mat_12_2, e3_pt))
    results.append(eq_mhd.jv(mat_12_1, mat_12_2, e3_pt))
    results.append(eq_mhd.unit_b1(mat_12_1, mat_12_2, e3_pt))
    results.append(eq_mhd.unit_b2(mat_12_1, mat_12_2, e3_pt))
    results.append(eq_mhd.unit_bv(mat_12_1, mat_12_2, e3_pt))
    
    # vector-valued functions (cartesian)
    results.append(eq_mhd.b_cart(mat_12_1, mat_12_2, e3_pt))
    results.append(eq_mhd.j_cart(mat_12_1, mat_12_2, e3_pt))
    results.append(eq_mhd.unit_b_cart(mat_12_1, mat_12_2, e3_pt))
    ...
    # scalar functions
    results.append(eq_mhd.absB0(mat_13_1, e2_pt, mat_13_3))
    results.append(eq_mhd.p0(mat_13_1, e2_pt, mat_13_3))
    results.append(eq_mhd.p3(mat_13_1, e2_pt, mat_13_3))
    results.append(eq_mhd.n0(mat_13_1, e2_pt, mat_13_3))
    results.append(eq_mhd.n3(mat_13_1, e2_pt, mat_13_3))
    
    # vector-valued functions (logical)
    results.append(eq_mhd.b1(mat_13_1, e2_pt, mat_13_3))
    results.append(eq_mhd.b2(mat_13_1, e2_pt, mat_13_3))
    results.append(eq_mhd.bv(mat_13_1, e2_pt, mat_13_3))
    results.append(eq_mhd.j1(mat_13_1, e2_pt, mat_13_3))
    results.append(eq_mhd.j2(mat_13_1, e2_pt, mat_13_3))
    results.append(eq_mhd.jv(mat_13_1, e2_pt, mat_13_3))
    results.append(eq_mhd.unit_b1(mat_13_1, e2_pt, mat_13_3))
    results.append(eq_mhd.unit_b2(mat_13_1, e2_pt, mat_13_3))
    results.append(eq_mhd.unit_bv(mat_13_1, e2_pt, mat_13_3))
    
    # vector-valued functions (cartesian)
    results.append(eq_mhd.b_cart(mat_13_1, e2_pt, mat_13_3))
    results.append(eq_mhd.j_cart(mat_13_1, e2_pt, mat_13_3))
    results.append(eq_mhd.unit_b_cart(mat_13_1, e2_pt, mat_13_3))
    ...
    # scalar functions
    results.append(eq_mhd.absB0(e1_pt, mat_23_2, mat_23_3))
    results.append(eq_mhd.p0(e1_pt, mat_23_2, mat_23_3))
    results.append(eq_mhd.p3(e1_pt, mat_23_2, mat_23_3))
    results.append(eq_mhd.n0(e1_pt, mat_23_2, mat_23_3))
    results.append(eq_mhd.n3(e1_pt, mat_23_2, mat_23_3))
    
    # vector-valued functions (logical)
    results.append(eq_mhd.b1(e1_pt, mat_23_2, mat_23_3))
    results.append(eq_mhd.b2(e1_pt, mat_23_2, mat_23_3))
    results.append(eq_mhd.bv(e1_pt, mat_23_2, mat_23_3))
    results.append(eq_mhd.j1(e1_pt, mat_23_2, mat_23_3))
    results.append(eq_mhd.j2(e1_pt, mat_23_2, mat_23_3))
    results.append(eq_mhd.jv(e1_pt, mat_23_2, mat_23_3))
    results.append(eq_mhd.unit_b1(e1_pt, mat_23_2, mat_23_3))
    results.append(eq_mhd.unit_b2(e1_pt, mat_23_2, mat_23_3))
    results.append(eq_mhd.unit_bv(e1_pt, mat_23_2, mat_23_3))
    
    # vector-valued functions (cartesian)
    results.append(eq_mhd.b_cart(e1_pt, mat_23_2, mat_23_3))
    results.append(eq_mhd.j_cart(e1_pt, mat_23_2, mat_23_3))
    results.append(eq_mhd.unit_b_cart(e1_pt, mat_23_2, mat_23_3))
...
if __name__ == '__main__':
    ...
    #test_equils(('GVECequilibrium', {}, None, {}))