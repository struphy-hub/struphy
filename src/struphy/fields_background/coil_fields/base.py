...
class CoilMagneticField(metaclass=ABCMeta):
    ...
    def domain(self):
        ...
        """
        assert hasattr(self, '_domain'), 'Domain for CoilMagneticField not set. Only bfield_logical available at this stage. Please do obj.domain = ... to have access to all transformations (1-form, 2-form, etc.)'
        return self._domain
