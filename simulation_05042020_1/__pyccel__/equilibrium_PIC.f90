...
use mappings_analytical, only: mapping_myts8b_f => f
use mappings_analytical, only: mapping_myts8b_det_df => det_df
implicit none
...
!........................................
function jhx_eq(x, y, z) result(Dummy_1531)

  implicit none
  real(kind=8)  :: Dummy_1531  
  real(kind=8), value  :: x
  real(kind=8), value  :: y
  real(kind=8), value  :: z
  real(kind=8)  :: nh0  
...
!........................................
function jhy_eq(x, y, z) result(Dummy_8900)

  implicit none
  real(kind=8)  :: Dummy_8900  
  real(kind=8), value  :: x
  real(kind=8), value  :: y
  real(kind=8), value  :: z
  real(kind=8)  :: nh0  
...
!........................................
function jhz_eq(x, y, z) result(Dummy_0069)

  implicit none
  real(kind=8)  :: Dummy_0069  
  real(kind=8), value  :: x
  real(kind=8), value  :: y
  real(kind=8), value  :: z
  real(kind=8)  :: nh0  
...
function fh_eq(xi1, xi2, xi3, vx, vy, vz, kind_map, params_map) result( &
  ...
  x = mapping_myts8b_f(xi1, xi2, xi3, kind_map, params_map, 1_8)
  y = mapping_myts8b_f(xi1, xi2, xi3, kind_map, params_map, 2_8)
  z = mapping_myts8b_f(xi1, xi2, xi3, kind_map, params_map, 3_8)


  Dummy_1055 = fh_eq_phys(x, y, z, vx, vy, vz)*mapping_myts8b_det_df(xi1 &
