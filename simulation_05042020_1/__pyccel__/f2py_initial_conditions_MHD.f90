...
function u1_ini (xi1, xi2, xi3, kind, n0_params, params) result( &
  ...
  Dummy_9145 = mod_u1_ini(xi1,xi2,xi3,kind,params)
end function
...
function u2_ini (xi1, xi2, xi3, kind, n0_params, params) result( &
  ...
  Dummy_5333 = mod_u2_ini(xi1,xi2,xi3,kind,params)
end function
...
function u3_ini (xi1, xi2, xi3, kind, n0_params, params) result( &
  ...
  Dummy_1292 = mod_u3_ini(xi1,xi2,xi3,kind,params)
end function
...
function b1_ini (xi1, xi2, xi3, kind, n0_params, params) result( &
  ...
  Dummy_8087 = mod_b1_ini(xi1,xi2,xi3,kind,params)
end function
...
function b2_ini (xi1, xi2, xi3, kind, n0_params, params) result( &
  ...
  Dummy_7496 = mod_b2_ini(xi1,xi2,xi3,kind,params)
end function
...
function b3_ini (xi1, xi2, xi3, kind, n0_params, params) result( &
  ...
  Dummy_4067 = mod_b3_ini(xi1,xi2,xi3,kind,params)
end function
...
function rho_ini (xi1, xi2, xi3, kind, n0_params, params) result( &
  ...
  Dummy_7683 = mod_rho_ini(xi1,xi2,xi3,kind,params)
end function