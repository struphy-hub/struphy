...
class parameters():
    ...
    def __init__(self):
        ...
        self.Nel          = [128, 2, 2]             # mesh generation on logical domain
        ...
        self.Tend         = 40.0     # simulation time
        ...
        self.params_map   = [40., 1., 1.]     # parameters for mapping  
        ...
        self.amps   = np.random.rand(8, self.nmodes)
    ...
    def p_ini_phys(self, x, y, z):
        ...
        for i in range(self.nmodes):
            p_phys += self.amps[0, i]*np.sin(2*np.pi*self.modes[i]*x/self.params_map[0])
    ...
    def ux_ini(self, x, y, z):
        ...
        for i in range(self.nmodes):
            ux += self.amps[1, i]*np.sin(2*np.pi*self.modes[i]*x/self.params_map[0])
    ...
    def uy_ini(self, x, y, z):
        ...
        for i in range(self.nmodes):
            uy += self.amps[2, i]*np.sin(2*np.pi*self.modes[i]*x/self.params_map[0])
    ...
    def uz_ini(self, x, y, z):
        ...
        for i in range(self.nmodes):
            uz += self.amps[3, i]*np.sin(2*np.pi*self.modes[i]*x/self.params_map[0])
    ...
    def by_ini(self, x, y, z):
        ...
        for i in range(self.nmodes):
            by += self.amps[5, i]*np.sin(2*np.pi*self.modes[i]*x/self.params_map[0])
    ...
    def bz_ini(self, x, y, z):
        ...
        for i in range(self.nmodes):
            by += self.amps[6, i]*np.sin(2*np.pi*self.modes[i]*x/self.params_map[0])
    ...
    def rho_ini_phys(self, x, y, z):
        ...
        for i in range(self.nmodes):
            rho_phys += self.amps[7, i]*np.sin(2*np.pi*self.modes[i]*x/self.params_map[0])
