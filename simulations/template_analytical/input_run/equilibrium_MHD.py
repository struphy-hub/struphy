...
def p0_eq(eta1, eta2, eta3, kind, params):
    
    x = mapping.f(eta1, eta2, eta3, kind, params, 1)
    y = mapping.f(eta1, eta2, eta3, kind, params, 2)
    z = mapping.f(eta1, eta2, eta3, kind, params, 3)
    
    return pull.pull_0_form(p_eq(x, y, z), eta1, eta2, eta3, kind, params)

# equilibrium bulk pressure (3-form on logical domain)
@types('double','double','double','int','double[:]')
def p3_eq(eta1, eta2, eta3, kind, params):
    
    x = mapping.f(eta1, eta2, eta3, kind, params, 1)
    y = mapping.f(eta1, eta2, eta3, kind, params, 2)
    z = mapping.f(eta1, eta2, eta3, kind, params, 3)
    
    return pull.pull_3_form(p_eq(x, y, z), eta1, eta2, eta3, kind, params)

# equilibrium bulk density (0-form on logical domain)
@types('double','double','double','int','double[:]')
def rho0_eq(eta1, eta2, eta3, kind, params):
    
    x = mapping.f(eta1, eta2, eta3, kind, params, 1)
    y = mapping.f(eta1, eta2, eta3, kind, params, 2)
    z = mapping.f(eta1, eta2, eta3, kind, params, 3)
    
    return pull.pull_0_form(rho_eq(x, y, z), eta1, eta2, eta3, kind, params)

# equilibrium bulk density (3-form on logical domain)
@types('double','double','double','int','double[:]')
def rho3_eq(eta1, eta2, eta3, kind, params):
    
    x = mapping.f(eta1, eta2, eta3, kind, params, 1)
    y = mapping.f(eta1, eta2, eta3, kind, params, 2)
    z = mapping.f(eta1, eta2, eta3, kind, params, 3)
    
    return pull.pull_3_form(rho_eq(x, y, z), eta1, eta2, eta3, kind, params)

# equilibrium bulk velocity (vector on logical domain, 1-component)
@types('double','double','double','int','double[:]')
def u_eq_1(eta1, eta2, eta3, kind, params):
...
@types('double','double','double','int','double[:]')
def u_eq_2(eta1, eta2, eta3, kind, params):
...
@types('double','double','double','int','double[:]')
def u_eq_3(eta1, eta2, eta3, kind, params):
...
@types('double','double','double','int','double[:]')
def b2_eq_1(eta1, eta2, eta3, kind, params):
...
@types('double','double','double','int','double[:]')
def b2_eq_2(eta1, eta2, eta3, kind, params):
...
@types('double','double','double','int','double[:]')
def b2_eq_3(eta1, eta2, eta3, kind, params):
...
@types('double','double','double','int','double[:]')
def curlb_eq_1(eta1, eta2, eta3, kind, params):
    return 0.

# curl of equilibrium magnetic field (2 - component)
@types('double','double','double','int','double[:]')
def curlb_eq_2(eta1, eta2, eta3, kind, params):
    return 0.

# curl of equilibrium magnetic field (3 - component)
@types('double','double','double','int','double[:]')
def curlb_eq_3(eta1, eta2, eta3, kind, params):
    return 0.